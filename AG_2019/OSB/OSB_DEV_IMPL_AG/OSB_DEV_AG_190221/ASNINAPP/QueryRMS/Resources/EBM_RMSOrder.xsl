   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="DBRMSOrderASNSelect_OrderNum_ItemInputParameters" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/DBRMSOrderASN"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [MON NOV 16 15:38:08 CST 2020].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:DBRMSOrderASNSelect_OrderNum_ItemInputParameters>
         <tns:OrderNum>
            <xsl:value-of select="/ns0:ProcessASNINEBM/ns0:DataArea/ns0:ProcessASNIN/ns0:OrdenCompra/com:ID"/>
         </tns:OrderNum>
         <tns:Item>
            <xsl:value-of select="/ns0:ProcessASNINEBM/ns0:DataArea/ns0:ProcessASNIN/ns0:DetalleASN/ns0:DetalleCaja/ns0:Item/com:ID"/>
         </tns:Item>
      </tns:DBRMSOrderASNSelect_OrderNum_ItemInputParameters>
   </xsl:template>
</xsl:stylesheet>