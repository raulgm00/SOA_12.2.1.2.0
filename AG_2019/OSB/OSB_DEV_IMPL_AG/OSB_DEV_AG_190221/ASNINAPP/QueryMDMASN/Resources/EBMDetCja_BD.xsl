   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="DBMDMDetCjaASNSelect_asn_lpnInputParameters" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/DBMDMDetCjaASN"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [WED NOV 11 15:46:26 CST 2020].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:DBMDMDetCjaASNSelect_asn_lpnInputParameters>
         <tns:asn>
            <xsl:value-of select="/ns0:ProcessASNINEBM/ns0:DataArea/ns0:ProcessASNIN/ns0:codigoASN/com:ID"/>
         </tns:asn>
         <tns:lpn>
            <xsl:value-of select="/ns0:ProcessASNINEBM/ns0:DataArea/ns0:ProcessASNIN/ns0:DetalleASN/ns0:LPN/com:ID"/>
         </tns:lpn>
      </tns:DBMDMDetCjaASNSelect_asn_lpnInputParameters>
   </xsl:template>
</xsl:stylesheet>