   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="GetHierarchyDBSelect_IdDeptoRMSInputParameters" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/GetHierarchyDB"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [THU NOV 05 23:36:08 CST 2020].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <ns0:GetHierarchyDBSelect_IdDeptoRMSInputParameters>
         <ns0:IdDeptoRMS>
