      ...
      <tns:FileRMS>
         ...
         <xsl:for-each select="/ns0:CreateInventoryEBM/ns0:DataArea/ns0:CreateInventory/ns0:InventoryLine">
            <tns:FDETL>
               ...
               <tns:LocalDescription>
                  <xsl:value-of select="translate (substring (concat ( /ns0:CreateInventoryEBM/ns0:DataArea/ns0:CreateInventory/ns0:ShipFromPartyReference/com:LocationId , '******************************************************************************************************************************************************' ), 1 , 150 ), '*', ' ')"/>
               </tns:LocalDescription>
            </tns:FDETL>
         </xsl:for-each>
         <tns:FTAIL>
