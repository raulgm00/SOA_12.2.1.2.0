   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="AcctLoanCalcInqRq" namespace="http://xmlns.banesco.com/appopt/WFAcctLoanAppSvc/AcctLoanCalcInq_V1.0"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            <oracle-xsl-mapper:schema location="../../../../Commons/xsd/EOpt/AccountLoan/AcctLoanCalcInq/AcctLoanCalcInq_V1.0.xsd"/>
            <oracle-xsl-mapper:rootElement name="AcctLoanCalcInqRq" namespace="http://xmlns.banesco.com/eopt/AcctLoanCalcInq_V1.0"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [THU MAY 03 15:53:14 COT 2018].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:AcctLoanCalcInqRq>
         <tns:AcctLoan>
            <tns:SimRef>
