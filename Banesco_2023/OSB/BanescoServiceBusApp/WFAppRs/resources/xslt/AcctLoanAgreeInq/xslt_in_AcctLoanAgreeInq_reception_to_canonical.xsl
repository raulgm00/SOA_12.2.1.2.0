   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="AcctLoanAgreeInqRq" namespace="http://xmlns.banesco.com/appopt/WFAcctLoanAppSvc/AcctLoanAgreeInq_V1.0"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [WED MAY 16 17:37:41 COT 2018].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:AcctLoanAgreeInqRq>
         <tns:AcctKey>
            <eoAcct:AcctId>
               <xsl:value-of select="/ns0:AcctLoanAgreeInqRq/ns0:AcctLoan/ns0:AcctKey/ns0:AcctId"/>
            </eoAcct:AcctId>
         </tns:AcctKey>
      </tns:AcctLoanAgreeInqRq>
   </xsl:template>
