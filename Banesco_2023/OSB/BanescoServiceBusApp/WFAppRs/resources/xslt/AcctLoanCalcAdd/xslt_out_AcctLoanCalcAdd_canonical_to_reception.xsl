<xsl:stylesheet version="1.0"
                ...
                xmlns:tns="http://xmlns.banesco.com/appopt/WFAcctLoanAppSvc/AcctLoanCalcAdd_V1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [MON APR 30 16:49:57 COT 2018].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <tns:AcctLoanCalcAddRs>
      <xsl:if test="/ns0:AcctLoanCalcAddRs/ns0:AcctLoan">
        <tns:AcctLoan>
          <xsl:if test="/ns0:AcctLoanCalcAddRs/ns0:AcctLoan/ns0:SimRef/text()">
            <tns:SimRef>
              <xsl:value-of select="/ns0:AcctLoanCalcAddRs/ns0:AcctLoan/ns0:SimRef"/>
            </tns:SimRef>
          </xsl:if>
        </tns:AcctLoan>
      </xsl:if>
      <tns:Status>
        <appoptcommon:StatusCode>
          <xsl:value-of select="/ns0:AcctLoanCalcAddRs/ns0:Status/eoStatus:StatusCode"/>
        </appoptcommon:StatusCode>
        <xsl:choose>
          <xsl:when test="/ns0:AcctLoanCalcAddRs/ns0:Status/eoStatus:AdditionalStatus/eoStatus:StatusDesc/text()">
            <appoptcommon:StatusDesc>
              <xsl:value-of select="/ns0:AcctLoanCalcAddRs/ns0:Status/eoStatus:AdditionalStatus/eoStatus:StatusDesc"/>
            </appoptcommon:StatusDesc>
          </xsl:when>
          <xsl:otherwise>
            <appoptcommon:StatusDesc>
              <xsl:value-of select="/ns0:AcctLoanCalcAddRs/ns0:Status/eoStatus:StatusDesc"/>
            </appoptcommon:StatusDesc>
          </xsl:otherwise>
        </xsl:choose>
      </tns:Status>
