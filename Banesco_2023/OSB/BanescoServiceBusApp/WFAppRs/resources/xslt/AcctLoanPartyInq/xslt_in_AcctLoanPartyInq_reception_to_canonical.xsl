   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="AcctLoanPartyInqRq" namespace="http://xmlns.banesco.com/appopt/WFAcctLoanAppSvc/AcctLoanPartyInq_V1.0"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            <oracle-xsl-mapper:schema location="../../../../Commons/xsd/EOpt/AccountLoan/AcctLoanPartyInq/AcctLoanPartyInq_V1.0.xsd"/>
            <oracle-xsl-mapper:rootElement name="AcctLoanPartyInqRq" namespace="http://xmlns.banesco.com/eopt/AcctLoanPartyInq_V1.0"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [WED JUN 27 16:40:29 GMT-05:00 2018].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:AcctLoanPartyInqRq>
         <tns:AcctKey>
            <xsl:if test="/ns0:AcctLoanPartyInqRq/ns0:AcctKey/ns0:AcctId/text()">
               <eoAcct:AcctId>
                  <xsl:value-of select="/ns0:AcctLoanPartyInqRq/ns0:AcctKey/ns0:AcctId"/>
               </eoAcct:AcctId>
            </xsl:if>
         </tns:AcctKey>
      </tns:AcctLoanPartyInqRq>
