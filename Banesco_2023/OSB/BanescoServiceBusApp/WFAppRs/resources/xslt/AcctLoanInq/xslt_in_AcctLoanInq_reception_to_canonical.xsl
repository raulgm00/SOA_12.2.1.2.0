   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="AcctLoanInqRq" namespace="http://xmlns.banesco.com/appopt/WFAcctLoanAppSvc/AcctLoanInq_V1.0"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            <oracle-xsl-mapper:schema location="../../../../Commons/xsd/EOpt/AccountLoan/AcctLoanInq/AcctLoanInq_V1.0.xsd"/>
            <oracle-xsl-mapper:rootElement name="AcctLoanInqRq" namespace="http://xmlns.banesco.com/eopt/AcctLoanInq_V1.0"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [THU JUN 07 12:07:38 COT 2018].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:AcctLoanInqRq>
         <tns:PartyKey>
            <xsl:if test="/ns0:AcctLoanInqRq/ns0:PartyKey/ns0:PartyId/text()">
               <eoPar:PartyId>
                  <xsl:value-of select="/ns0:AcctLoanInqRq/ns0:PartyKey/ns0:PartyId"/>
               </eoPar:PartyId>
            </xsl:if>
         </tns:PartyKey>
      </tns:AcctLoanInqRq>
