   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="AcctLoanMortAddRq" namespace="http://xmlns.banesco.com/eopt/AcctLoanMortAdd_V1.0"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [THU SEP 20 17:50:04 COT 2018].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:AcctLoanInfoAddRq>
         <tns:AcctLoan>
          <xsl:copy-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/*"/>
         </tns:AcctLoan>
      </tns:AcctLoanInfoAddRq>
   </xsl:template>
</xsl:stylesheet>
