<xsl:stylesheet version="1.0"
                ...
                xmlns:tns="http://xmlns.banesco.com/eopt/AcctInfoAdd_V1.0"
                ...
                xmlns:ns0="http://xmlns.banesco.com/eopt/AcctAdd_V1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [THU JUL 05 08:26:04 CDT 2018].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <tns:AcctInfoAddRq>
      <tns:Acct>
        <xsl:copy-of select="/ns0:AcctAddRq/ns0:AcctAddRec/ns0:Acct/*"/>
      </tns:Acct>
    </tns:AcctInfoAddRq>
  </xsl:template>
</xsl:stylesheet>