   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="PartyInfoInqRq" namespace="http://xmlns.banesco.com/appopt/Way4PartyAppSvc/PartyInfoInq_V1.0"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [WED MAR 14 15:54:14 COT 2018].-->
   </oracle-xsl-mapper:schema>
