   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="AdminTrnAdvACHInqRq" namespace="http://xmlns.banesco.com/eopt/AdminTrnAdvInq_V1.0"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            <oracle-xsl-mapper:schema location="../../../../Commons/backends/T24/resources/xsd/WSBANENQ318ACH/CONSULTATrama318ACHRequest.xsd"/>
            <oracle-xsl-mapper:rootElement name="BANENQ318ACHAMLRequest" namespace="http://www.temenos.com/T24/ofs/Request"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [THU SEP 06 15:33:58 COT 2018].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:param name="varHeader"/>
   <xsl:template match="/">
    <opaq:opaqueElement xmlns:opaq="http://xmlns.oracle.com/pcbpel/adapter/opaque/">
      <tns:BANENQ318ACHAMLRequest>
         <RequestCommon>
            <UserName>
         ...
         <EnquiryInput>
            <EnquiryCriteriaCollection>
               <EnquiryCriteria>
                  ...
                  <Value>
                     <xsl:value-of select="/ns0:AdminTrnAdvACHInqRq/ns0:ArrangementId"/>
                  </Value>
               </EnquiryCriteria>
            </EnquiryCriteriaCollection>
         </EnquiryInput>
