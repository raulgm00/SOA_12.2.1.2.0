...
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns0="http://xmlns.banesco.com/eopt/AcctLoanStatusMod_V1.0"
                ...
                xmlns:txnins="http://www.temenos.com/T24/ofs/TransactionInput"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="AcctLoanStatusModRq"
                                       namespace="http://xmlns.banesco.com/eopt/AcctLoanStatusMod_V1.0"/>
      </oracle-xsl-mapper:source>
    </oracle-xsl-mapper:mapSources>
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        <oracle-xsl-mapper:schema location="../../../../Commons/backends/T24/resources/xsd/AAArrangementActivityAuth/AprobaciondeprestamoRequest.xsd"/>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [TUE MAY 15 11:03:57 COT 2018].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <opaq:opaqueElement xmlns:opaq="http://xmlns.oracle.com/pcbpel/adapter/opaque/">
      <tns:AAARRANGEMENTACTIVITYBPAWSLOANCREATERequest>
        ...
        <TransactionInput>
          <TransactionId>
            <xsl:value-of select="/ns0:AcctLoanStatusModRq/ns0:AcctKey/eoAcct:AcctId"/>
          </TransactionId>
        </TransactionInput>
      </tns:AAARRANGEMENTACTIVITYBPAWSLOANCREATERequest>
    </opaq:opaqueElement>
