...
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns0="http://xmlns.banesco.com/eopt/PersonAcctInfoInq_V1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="PersonAcctInfoInqRq"
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        <oracle-xsl-mapper:schema location="../../../../Commons/backends/T24/resources/xsd/BPAENQACCOUNTPN_V1.0/EnquiryaccountNaturalesConsultaCuentasNaturalesRequest.xsd"/>
        <oracle-xsl-mapper:rootElement name="BPAENQACCOUNTPNRequest"
                                       namespace="http://www.temenos.com/T24/ofs/Request"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [WED MAY 02 10:36:02 GMT-05:00 2018].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:param name="varHeader"/>
  <xsl:template match="/">
  <opaq:opaqueElement xmlns:opaq="http://xmlns.oracle.com/pcbpel/adapter/opaque/">
    <tns:BPAENQACCOUNTPNRequest>
      <RequestCommon>
        <UserName>
      ...
      <EnquiryInput>
        <EnquiryCriteriaCollection>
          <xsl:if test="/ns0:PersonAcctInfoInqRq/ns0:AcctKey/eoAcct:AcctId/text()">
            <EnquiryCriteria>
              <Field>@ID</Field>
              <Operator>EQ</Operator>
              <Value>
                <xsl:value-of select="/ns0:PersonAcctInfoInqRq/ns0:AcctKey/eoAcct:AcctId"/>
              </Value>
            </EnquiryCriteria>
          </xsl:if>
        </EnquiryCriteriaCollection>
