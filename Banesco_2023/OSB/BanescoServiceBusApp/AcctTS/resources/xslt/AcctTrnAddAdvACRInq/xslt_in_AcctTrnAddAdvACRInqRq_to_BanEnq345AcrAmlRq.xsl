...
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns0="http://xmlns.banesco.com/eopt/AcctTrnAddAdvInq_V1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="AcctTrnAddAdvACRInqRq"
                                       namespace="http://xmlns.banesco.com/eopt/AcctTrnAddAdvInq_V1.0"/>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        <oracle-xsl-mapper:schema location="../../../../Commons/backends/T24/resources/xsd/WSBANENQ345ACRAML/CONSULTATrama345ACRRequest.xsd"/>
        <oracle-xsl-mapper:rootElement name="BANENQ345ACRAMLRequest"
                                       namespace="http://www.temenos.com/T24/ofs/Request"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [THU SEP 27 11:23:55 GMT-05:00 2018].-->
  </oracle-xsl-mapper:schema>
        ...
        <EnquiryInput>
          <EnquiryCriteriaCollection>
            <EnquiryCriteria>
              ...
              <Value>
                <xsl:value-of select="/ns0:AcctTrnAddAdvACRInqRq/ns0:Id"/>
              </Value>
            </EnquiryCriteria>
          </EnquiryCriteriaCollection>
        </EnquiryInput>
