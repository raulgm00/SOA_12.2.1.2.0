  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        <oracle-xsl-mapper:schema location="../../../../Commons/backends/T24/resources/xsd/BpaWsLoanConsultByCust/ConsultadePrestamosporclientesRequest.xsd"/>
        <oracle-xsl-mapper:rootElement name="BPAWSLOANCONSULTBYCUSTRequest"
                                       namespace="http://www.temenos.com/T24/ofs/Request"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [THU JUN 07 15:16:26 COT 2018].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:param name="varHeader"/>
  <xsl:template match="/">
    <opaq:opaqueElement xmlns:opaq="http://xmlns.oracle.com/pcbpel/adapter/opaque/">
      <tns:BPAWSLOANCONSULTBYCUSTRequest>
        <RequestCommon>
            <UserName>
        ...
        <EnquiryInput>
          <EnquiryCriteriaCollection>
            <EnquiryCriteria>
              ...
              <Value>
                <xsl:value-of select="/ns0:AcctLoanInqRq/ns0:PartyKey/eoPar:PartyId"/>
              </Value>
            </EnquiryCriteria>
          </EnquiryCriteriaCollection>
        </EnquiryInput>
