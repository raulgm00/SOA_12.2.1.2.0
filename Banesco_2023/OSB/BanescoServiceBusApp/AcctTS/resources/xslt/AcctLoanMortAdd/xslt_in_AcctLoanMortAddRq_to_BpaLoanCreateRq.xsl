...
<xsl:stylesheet version="1.0" xmlns:ns0="http://xmlns.banesco.com/eopt/AcctLoanMortAdd_V1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [THU SEP 20 15:56:16 COT 2018].-->
  </oracle-xsl-mapper:schema>
    ...
    <opaq:opaqueElement xmlns:opaq="http://xmlns.oracle.com/pcbpel/adapter/opaque/">
      <tns:AAARRANGEMENTACTIVITYBPAWSLOANCREATERequest>
        ...
        <AAARRANGEMENTACTIVITYBPAWSLOANCREATE>
          ...
          <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctOpeningInfo/eoAcct:OpenDt/text()">
            <EFFECTIVEDATE>
              <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctOpeningInfo/eoAcct:OpenDt"/>
            </EFFECTIVEDATE>
          </xsl:if>
          <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctMember">
            <gCUSTOMER>
              <xsl:for-each select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctMember">
                <mCUSTOMER>
                  <CUSTOMER>
          ...
          <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctSubtype/ns4:Cod/text()">
            <PRODUCT>
              <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctSubtype/ns4:Cod"/>
            </PRODUCT>
          </xsl:if>
          <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CurCode/text()">
            <CURRENCY>
              <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CurCode"/>
            </CURRENCY>
          </xsl:if>
          <gPROPERTY>
            <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:ClubBanesco/text()">
              <mPROPERTY>
                  ...
                  <FIELDNAME>
                    ...
                    <FIELDVALUE>
                      <xsl:call-template name="Boolean_Regex">
                        ...
                        <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:ClubBanesco"/>
                      </xsl:with-param>
                      </xsl:call-template>
                    </FIELDVALUE>
                  </FIELDNAME>
            ...
            <mPROPERTY>
              ...
              <sgFIELDNAME>
                <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:CollOfficer/text()">
                  <FIELDNAME>
                    <FIELDNAME>LT.COLL.OFFICER</FIELDNAME>
                    <FIELDVALUE>
                      <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:CollOfficer"/>
                    </FIELDVALUE>
                  </FIELDNAME>
                </xsl:if>
                <xsl:if test="ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctOpeningInfo/eoAcct:SaleOfficer/text()">
                  <FIELDNAME>
                    <FIELDNAME>LT.SALE.OFFICER</FIELDNAME>
                    <FIELDVALUE>
                      <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctOpeningInfo/eoAcct:SaleOfficer"/>
                    </FIELDVALUE>
                  </FIELDNAME>
                </xsl:if>
              </sgFIELDNAME>
            </mPROPERTY>
            <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:FundsDestination/text()">
              <mPROPERTY>
                ...
                <sgFIELDNAME>
                  <FIELDNAME>
                    ...
                    <FIELDVALUE>
                      <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:FundsDestination"/>
                    </FIELDVALUE>
                  </FIELDNAME>
                </sgFIELDNAME>
              </mPROPERTY>
            ...
            <mPROPERTY>
              ...
              <sgFIELDNAME>
                <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctOpeningInfo/eoAcct:InitialAmt/ns4:Amt/text()">
                  <FIELDNAME>
                    <FIELDNAME>AMOUNT</FIELDNAME>
                    <FIELDVALUE>
                      <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctOpeningInfo/eoAcct:InitialAmt/ns4:Amt"/>
                    </FIELDVALUE>
                  </FIELDNAME>
                </xsl:if>
                <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:Term/eoAcct:ProposedTerm/text()">
                  <FIELDNAME>
                    <FIELDNAME>TERM</FIELDNAME>
                    <FIELDVALUE>
                      <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:Term/eoAcct:ProposedTerm"/>
                    </FIELDVALUE>
                  </FIELDNAME>
                </xsl:if>
                <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:ClosedDt/text()">
                  <FIELDNAME>
                    <FIELDNAME>MATURITY.DATE</FIELDNAME>
                    <FIELDVALUE>
                      <xsl:value-of select='xp20:format-dateTime (/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:ClosedDt, "[Y0001][M01][D01]" )'/>
                    </FIELDVALUE>
                  </FIELDNAME>
                </xsl:if>
                <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:WritingType/text()">
                  <FIELDNAME>
                    <FIELDNAME>LT.WRITING.TYPE</FIELDNAME>
                    <FIELDVALUE>
                      <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:WritingType"/>
                    </FIELDVALUE>
                  </FIELDNAME>
                </xsl:if>
              </sgFIELDNAME>
            </mPROPERTY>
            <xsl:for-each select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:IntRateData">
              <mPROPERTY>
                <PROPERTY>
            ...
            <xsl:for-each select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:Charge">
              <mPROPERTY>
                <PROPERTY>
            ...
            <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:TaxData">
              <mPROPERTY>
                <PROPERTY>TAX</PROPERTY>
                <sgFIELDNAME>
                  <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:TaxData/ns3:TaxType/text()">
                    <FIELDNAME>
                      <FIELDNAME>PROPERTY</FIELDNAME>
                      <FIELDVALUE>
                        <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:TaxData/ns3:TaxType"/>
                      </FIELDVALUE>
                    </FIELDNAME>
                  </xsl:if>
                  <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:TaxData/ns3:TaxCode/text()">
                    <FIELDNAME>
                      <FIELDNAME>PROP.TAX.CODE</FIELDNAME>
                      <FIELDVALUE>
                        <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:TaxData/ns3:TaxCode"/>
                      </FIELDVALUE>
                    </FIELDNAME>
                  </xsl:if>
                  <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:TaxData/ns3:TaxCondition/text()">
                    <FIELDNAME>
                      <FIELDNAME>PROP.TAX.COND</FIELDNAME>
                      <FIELDVALUE>
                        <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:TaxData/ns3:TaxCondition"/>
                      </FIELDVALUE>
                    </FIELDNAME>
                  </xsl:if>
                </sgFIELDNAME>
            ...
            <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:CreditRegularPmt">
              <mPROPERTY>
                <PROPERTY>SCHEDULE</PROPERTY>
                <xsl:for-each select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:CreditRegularPmt">
                ...
                <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:BillsCombined/text() or /ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:RecalFrequency/ns4:FreqValue/text()">
                  <sgFIELDNAME>
                    <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:BillsCombined/text()">
                      <FIELDNAME>
                        ...
                        <FIELDVALUE>
                          <xsl:call-template name="Boolean_Regex">
                            <xsl:with-param name="operation">Add</xsl:with-param>
                            <xsl:with-param name="parametro">
                            <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:BillsCombined"/>
                          </xsl:with-param>
                          </xsl:call-template>
                        </FIELDVALUE>
                      </FIELDNAME>
                    </xsl:if>
                    <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:RecalFrequency">
                      <FIELDNAME>
                        <FIELDNAME>RECALC.FREQUENCY</FIELDNAME>
                        <FIELDVALUE>
                          <!--xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:RecalFrequency/ns4:FreqValue"/-->
                          <xsl:call-template name="CreditPmtFreq">
                            <xsl:with-param name="noPaymentMonth">
                            <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:RecalFrequency/ns4:NoPaymentMonth"/>
                          </xsl:with-param>
                            <xsl:with-param name="onDayNumber">
                            <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:RecalFrequency/ns4:OnDayNumber"/>
                          </xsl:with-param>
                          </xsl:call-template>
                        </FIELDVALUE>
                      </FIELDNAME>
            ...
            <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:ActivityCharge">
              <mPROPERTY>
                <PROPERTY>ACTIVITY.CHARGES</PROPERTY>
                <xsl:for-each select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:ActivityCharge">
                  <xsl:variable name="indice">
                    <xsl:value-of select="position()"/>
                  </xsl:variable>
                  <sgFIELDNAME>
                    ...
                    <xsl:for-each select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:ActivityCharge/eoAcct:ActivityChargeDetail">
            ...
            <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:SettleInstruction">
              <mPROPERTY>
                <PROPERTY>SETTLEMENT</PROPERTY>
                <sgFIELDNAME>
                  <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:SettleInstruction/eoAcct:ExeAutoPay/text()">
                    <FIELDNAME>
                      ...
                      <FIELDVALUE>
                        <xsl:call-template name="Boolean_Regex">
                          <xsl:with-param name="operation">Add</xsl:with-param>
                          <xsl:with-param name="parametro">
                          <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:SettleInstruction/eoAcct:ExeAutoPay"/>
                        </xsl:with-param>
                        </xsl:call-template>
                      </FIELDVALUE>
                    </FIELDNAME>
                  </xsl:if>
                  <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:SettleInstruction/eoAcct:FromDay/text()">
                    <FIELDNAME>
                      <FIELDNAME>LT.FROM.DAY</FIELDNAME>
                      <FIELDVALUE>
                        <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:SettleInstruction/eoAcct:FromDay"/>
                      </FIELDVALUE>
                    </FIELDNAME>
                  </xsl:if>
                  <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:SettleInstruction/eoAcct:ToDay/text()">
                    <FIELDNAME>
                      <FIELDNAME>LT.TO.DAY</FIELDNAME>
                      <FIELDVALUE>
                        <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:SettleInstruction/eoAcct:ToDay"/>
                      </FIELDVALUE>
                    </FIELDNAME>
                  </xsl:if>
                </sgFIELDNAME>
                <xsl:for-each select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:SettleInstruction/eoAcct:PayIn">
                  <xsl:variable name="indice">
                    <xsl:value-of select="position()"/>
                  </xsl:variable>
                  <sgFIELDNAME>
                    <xsl:for-each select="eoAcct:PmtType">
                      <xsl:variable name="indicePmtType">
                        <xsl:value-of select="position()"/>
                      </xsl:variable>
                      <FIELDNAME>
                        <FIELDNAME>
                          <xsl:value-of select="concat('PAYMENT.TYPE:', $indice, ':', $indicePmtType)"/>
                        </FIELDNAME>
                        <FIELDVALUE>
                          <xsl:value-of select="eoAcct:PmtType"/>
                        </FIELDVALUE>
                ...
                <xsl:for-each select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:CreditAcctData/eoAcct:SettleInstruction/eoAcct:PayOut">
                  <xsl:variable name="indice">
                    <xsl:value-of select="position()"/>
                  </xsl:variable>
                  <sgFIELDNAME>
          ...
          <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:Variation/ns4:Cod/text()">
            <PRODUCTVARIATION>
              <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:Variation/ns4:Cod"/>
            </PRODUCTVARIATION>
          </xsl:if>
          <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctOpeningInfo/eoAcct:RqReason/text()">
            <REASON>
              <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctOpeningInfo/eoAcct:RqReason"/>
            </REASON>
          </xsl:if>
          <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctOpeningInfo/eoAcct:AgentId/ns7:PartyId/text()">
            <AGENTID>
              <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctOpeningInfo/eoAcct:AgentId/ns7:PartyId"/>
            </AGENTID>
          </xsl:if>
          <xsl:if test="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctOpeningInfo/eoAcct:AgentArrId/text()">
            <AGENTARRID>
              <xsl:value-of select="/ns0:AcctLoanMortAddRq/ns0:AcctLoan/eoAcct:AcctOpeningInfo/eoAcct:AgentArrId"/>
            </AGENTARRID>
          </xsl:if>
        </AAARRANGEMENTACTIVITYBPAWSLOANCREATE>
      </tns:AAARRANGEMENTACTIVITYBPAWSLOANCREATERequest>
