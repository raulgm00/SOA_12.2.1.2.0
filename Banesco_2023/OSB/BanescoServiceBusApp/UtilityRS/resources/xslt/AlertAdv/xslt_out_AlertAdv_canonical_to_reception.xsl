...
<xsl:stylesheet version="1.0"
                ...
                xmlns:tns="http://xmlns.banesco.com/appopt/UtilityAppSvc/AlertAdv_V1.0"
                ...
                xmlns:ns0="http://xmlns.banesco.com/eopt/AlertAdv_V1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="AlertAdvRs"
                                       namespace="http://xmlns.banesco.com/appopt/UtilityAppSvc/AlertAdv_V1.0"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [MON JUN 04 15:42:40 COT 2018].-->
  </oracle-xsl-mapper:schema>
    ...
    <tns:AlertAdvRs>
      <tns:Status>
        <appoptcommon:StatusCode>
          <xsl:value-of select="/ns0:AlertAdvRs/ns0:Status/eoStatus:StatusCode"/>
        </appoptcommon:StatusCode>
        <xsl:choose>
          <xsl:when test="/ns0:AlertAdvRs/ns0:Status/eoStatus:AdditionalStatus/eoStatus:StatusDesc">
            <appoptcommon:StatusDesc>
              <xsl:value-of select="/ns0:AlertAdvRs/ns0:Status/eoStatus:AdditionalStatus/eoStatus:StatusDesc"/>
            </appoptcommon:StatusDesc>
          </xsl:when>
          <xsl:otherwise>
            <appoptcommon:StatusDesc>
              <xsl:value-of select="/ns0:AlertAdvRs/ns0:Status/eoStatus:StatusDesc"/>
            </appoptcommon:StatusDesc>
          </xsl:otherwise>
        </xsl:choose>
      </tns:Status>
