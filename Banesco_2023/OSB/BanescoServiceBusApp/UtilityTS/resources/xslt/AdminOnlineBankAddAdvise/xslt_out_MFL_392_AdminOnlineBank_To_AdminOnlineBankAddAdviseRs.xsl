   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="AdminOnlineBankAddAdviseRs" namespace="http://xmlns.banesco.com/eopt/AdminOnlineBankAddAdvise_V1.0"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [MON MAY 14 17:18:58 COT 2018].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:AdminOnlineBankAddAdviseRs>
         <tns:Status>
            <eoStatus:StatusCode>M0000</eoStatus:StatusCode>
            <eoStatus:StatusDesc>Registro AdminOnlineBank OK</eoStatus:StatusDesc>
         </tns:Status>
      </tns:AdminOnlineBankAddAdviseRs>
   </xsl:template>
</xsl:stylesheet>
