create or replace FUNCTION F_GENERAR_CUESTIONARIO_ELEGIBILIDAD (
    Num_Operacion       IN     INTEGER,
    id_Version_Cuestionario IN INTEGER,
    Num_Cuestionario    IN     INTEGER)
    RETURN INTEGER
AS
    Producto                   INT;
...
/*
    ...
    Select id_tipo_cuestionario
        INTO Tipo_Cuestionario
        FROM tca_tipo_cuestionario
        WHERE descripcion = 'Cuestionario de Elegibilidad'
        AND Ban_Estatus = 1;
    ...
    THEN
        ...
        Select Id_Cuestionario
         ...
         Where Ban_Estatus = 1
           ...
           And id_tipo_cuestionario = Tipo_Cuestionario;
    END IF;
...
*/
    ...
    DBMS_OUTPUT.PUT_LINE('Tipo_Institucion' || Tipo_Institucion);
    DBMS_OUTPUT.PUT_LINE('Sector' || Sector);
    DBMS_OUTPUT.PUT_LINE('Num_Cliente' || Num_Cliente);
    DBMS_OUTPUT.PUT_LINE('Tipo_Garantia' || Tipo_Garantia);
    ...
    -- INSERTAR PREGUNTAS DE ACUERDO AL TIPO DE CUESTIONARIO
        INSERT Into Pregunta (
            ...
            Where fPgVer.id_Version = id_Version_Cuestionario
...
END F_GENERAR_CUESTIONARIO_ELEGIBILIDAD;