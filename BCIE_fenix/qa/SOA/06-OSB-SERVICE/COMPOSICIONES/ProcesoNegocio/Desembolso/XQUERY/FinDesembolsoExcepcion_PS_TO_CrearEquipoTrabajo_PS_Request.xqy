...
declare function local:func($FinDesembolsoExcepcion as element() (:: schema-element(ns1:FinDesembolsoExcepcion) ::)) as element() (:: schema-element(ns2:requestCrearEquipoTrabajoMessage) ::) {
    <ns2:requestCrearEquipoTrabajoMessage>
        <ns2:idOperacion>{fn:data($FinDesembolsoExcepcion/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</ns2:idOperacion>
        <ns2:listadoEquipoTrabajo>
            {
                for $equipoTrabajo in $FinDesembolsoExcepcion/ns1:equipoTrabajo/ns5:equipoTrabajo
                return 
                <ns5:equipoTrabajo>
