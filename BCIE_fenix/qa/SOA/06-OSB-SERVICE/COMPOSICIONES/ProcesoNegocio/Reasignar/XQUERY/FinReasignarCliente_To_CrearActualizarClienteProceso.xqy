...
declare function local:func($FinReasignacionRC as element() (:: schema-element(ns1:FinReasignacionRC) ::)) as element() (:: schema-element(ns2:CrearActualizarClienteProcesoRequest) ::) {
