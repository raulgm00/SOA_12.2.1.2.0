...
declare function local:func($FinFormalizacion as element() (:: schema-element(ns1:FinFormalizacion) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            <cre:id></cre:id>
            <cre:idOperacion>{fn:data($FinFormalizacion/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($FinFormalizacion/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            <cre:idProceso>5</cre:idProceso>
            <cre:nombreProceso>PC05</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinFormalizacion/ns1:Header/ns3:Proceso/ns5:InstanciaProceso)}</cre:instanciaProceso>
            ...
            <cre:usuario>{fn:data($FinFormalizacion/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
