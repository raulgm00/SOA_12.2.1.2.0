...
declare function local:func($InicioContratacionFormalizacion as element() (:: schema-element(ns1:InicioContratacionFormalizacion) ::)) as element() (:: schema-element(ns1:InicioCancelarContratacion) ::) {
    <ns1:InicioCancelarContratacion>
        <ns1:Header>
            {
                if (error()) then 
                    ...
                    <ns2:Cliente>
                        {
                            if ($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:IdCliente)
                            then <ns4:IdCliente>{fn:data($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:IdCliente)}</ns4:IdCliente>
                            else ()
                        }
                        {
                            if ($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:IdFlexCube)
                            then <ns4:IdFlexCube>{fn:data($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:IdFlexCube)}</ns4:IdFlexCube>
                            else ()
                        }
                        {
                            if ($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:RazonSocial)
                            then <ns4:RazonSocial>{fn:data($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:RazonSocial)}</ns4:RazonSocial>
                            else ()
                        }
                        {
                            if ($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:Abreviatura)
                            then <ns4:Abreviatura>{fn:data($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:Abreviatura)}</ns4:Abreviatura>
                            else ()
                        }
                        {
                            if ($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:IdSector)
                            then <ns4:IdSector>{fn:data($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:IdSector)}</ns4:IdSector>
                            else ()
                        }
                        {
                            if ($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:Sector)
                            then <ns4:Sector>{fn:data($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:Sector)}</ns4:Sector>
                            else ()
                        }
                        {
                            if ($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:IdPais)
                            then <ns4:IdPais>{fn:data($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:IdPais)}</ns4:IdPais>
                            else ()
                        }
                        {
                            if ($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:Pais)
                            then <ns4:Pais>{fn:data($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:Pais)}</ns4:Pais>
                            else ()
                        }
                        {
                            if ($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:IdOficina)
                            then <ns4:IdOficina>{fn:data($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:IdOficina)}</ns4:IdOficina>
                            else ()
                        }
                        {
                            if ($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:Oficina)
                            then <ns4:Oficina>{fn:data($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:Oficina)}</ns4:Oficina>
                            else ()
                        }
                        {
                            if ($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:ResponsableCliente)
                            then <ns4:ResponsableCliente>{fn:data($InicioContratacionFormalizacion/ns1:Header/ns2:Cliente/ns4:ResponsableCliente)}</ns4:ResponsableCliente>
                            else ()
                        }
                    </ns2:Cliente>
            }
            {
                if ($InicioContratacionFormalizacion/ns1:Header/ns2:Tarea)
                then 
                    <ns2:Tarea>
            ...
            {
                if ($InicioContratacionFormalizacion/ns1:Header/ns2:Proceso)
                then 
                    <ns2:Proceso>
