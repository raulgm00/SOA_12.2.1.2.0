...
declare function local:func($FinFormalizacion as element() (:: schema-element(ns1:FinFormalizacion) ::)) as element() (:: schema-element(ns2:requestCrearEquipoTrabajoMessage) ::) {
    <ns2:requestCrearEquipoTrabajoMessage>
        <ns2:idOperacion>{fn:data($FinFormalizacion/ns1:Header/ns4:Operacion/ns5:CodigoOperacion)}</ns2:idOperacion>
        <ns2:listadoEquipoTrabajo>
            {
                for $equipoTrabajo in $FinFormalizacion/ns1:equipoTrabajo/ns3:equipoTrabajo
