...
declare function local:func($FinCierre as element() (:: schema-element(ns1:FinCierre) ::)) as element() (:: schema-element(ns2:requestCrearEquipoTrabajoMessage) ::) {
    <ns2:requestCrearEquipoTrabajoMessage>
        <ns2:idOperacion>{fn:data($FinCierre/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</ns2:idOperacion>
        <ns2:listadoEquipoTrabajo>
        {
                for $equipoTrabajo in $FinCierre/ns1:equipoTrabajo/ns5:equipoTrabajo
