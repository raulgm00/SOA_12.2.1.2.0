...
declare namespace ns2="http://xmlns.oracle.com/bpmn/bpmnProcess/EvaluacionProcess";
(:: import schema at "../../../../MDS/Resources/BPM/Schema/PC06/EvaluacionProcess.xsd" ::)
...
declare function local:func($FinPreparacion as element() (:: schema-element(ns1:FinPreparacion) ::)) as element() (:: schema-element(ns2:InicioEvaluacion) ::) {
    <ns2:InicioEvaluacion>
        <ns2:Header>
            <ns3:Operacion>
