...
declare namespace ns2="http://xmlns.oracle.com/bpmn/bpmnProcess/AnalisisProcess";
...
declare function local:func($FinPreparacion as element() (:: schema-element(ns1:FinPreparacion) ::)) as element() (:: schema-element(ns2:InicioAnalisis) ::) {
    <ns2:InicioAnalisis>
        <ns2:Header>
            <ns3:Operacion>
            ...
            {
                if ($FinPreparacion/ns1:Header/ns3:Tarea)
                then 
                    <ns3:Tarea>
                        ...
                        }
                        {
                           ...
                           <ns5:CodigoProceso>3</ns5:CodigoProceso>
                      
   
                            <ns5:NombreProceso>PC03</ns5:NombreProceso>
            ...
            {
                for $ParameterType in $FinPreparacion/ns1:Header/ns6:ParameterType
                return 
                <ns6:ParameterType>
