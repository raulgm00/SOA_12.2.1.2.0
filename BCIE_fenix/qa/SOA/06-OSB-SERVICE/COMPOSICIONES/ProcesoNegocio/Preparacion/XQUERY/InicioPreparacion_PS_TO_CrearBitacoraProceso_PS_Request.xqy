...
declare function local:func($InicioPreparacion as element() (:: schema-element(ns1:InicioPreparacion) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            <cre:id></cre:id>
            <cre:idOperacion>{fn:data($InicioPreparacion/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($InicioPreparacion/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            ...
            <cre:usuario>{fn:data($InicioPreparacion/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
            ...
            <cre:raroc></cre:raroc>
            {
            if(count($InicioPreparacion/ns1:Header/ns6:ParameterType)>0)then
            <cre:string01>{fn:concat($InicioPreparacion/ns1:Header/ns6:ParameterType[1]/ns6:parameterName,'-', $InicioPreparacion/ns1:Header/ns6:ParameterType[1]/ns6:parameterValue[1])}</cre:string01>
            else()}
            {
            if(count($InicioPreparacion/ns1:Header/ns6:ParameterType)>1)then
            <cre:string02>{fn:concat($InicioPreparacion/ns1:Header/ns6:ParameterType[2]/ns6:parameterName,'-', $InicioPreparacion/ns1:Header/ns6:ParameterType[2]/ns6:parameterValue)}</cre:string02>
            else()}
            {
            if(count($InicioPreparacion/ns1:Header/ns6:ParameterType)>2)then
            <cre:string03>{fn:concat($InicioPreparacion/ns1:Header/ns6:ParameterType[3]/ns6:parameterName,'-', $InicioPreparacion/ns1:Header/ns6:ParameterType[3]/ns6:parameterValue)}</cre:string03>
            else()}
        </ns2:BitacoraInput>
    </ns2:requestCrearBitacoraProcesoMessage>
};
