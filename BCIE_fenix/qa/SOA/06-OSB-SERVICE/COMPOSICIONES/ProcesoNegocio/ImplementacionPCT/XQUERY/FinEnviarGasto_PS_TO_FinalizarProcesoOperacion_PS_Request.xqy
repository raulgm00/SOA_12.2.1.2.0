...
declare function local:func($FinEnviarGasto as element() (:: schema-element(ns1:FinEnviarGasto) ::)) as element() (:: schema-element(ns2:requestFinalizarOperacionProcesoMessage) ::) {
    <ns2:requestFinalizarOperacionProcesoMessage>
        <ns2:BitacoraInput>
            <fin:idOperacion>{fn:data($FinEnviarGasto/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</fin:idOperacion>
