...
declare function local:func($FinEvaluacionIBCIE as element() (:: schema-element(ns1:FinEvaluacionIBCIE) ::)) as element() (:: schema-element(ns2:requestFinalizarOperacionProcesoMessage) ::) {
    <ns2:requestFinalizarOperacionProcesoMessage>
        <ns2:BitacoraInput>
            <fin:idOperacion>{fn:data($FinEvaluacionIBCIE/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</fin:idOperacion>
