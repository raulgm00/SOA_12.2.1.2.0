...
declare variable $FinEvaluacionIBCIE as element() (:: schema-element(ns1:FinEvaluacionIBCIE) ::) external;

declare function local:func($FinEvaluacionIBCIE as element() (:: schema-element(ns1:FinEvaluacionIBCIE) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            <cre:id></cre:id>
            <cre:idOperacion>{fn:data($FinEvaluacionIBCIE/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($FinEvaluacionIBCIE/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            <cre:idProceso>6</cre:idProceso>
            <cre:nombreProceso>PA10</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinEvaluacionIBCIE/ns1:Header/ns3:Proceso/ns5:InstanciaProceso)}</cre:instanciaProceso>
            ...
            <cre:usuario>{fn:data($FinEvaluacionIBCIE/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
