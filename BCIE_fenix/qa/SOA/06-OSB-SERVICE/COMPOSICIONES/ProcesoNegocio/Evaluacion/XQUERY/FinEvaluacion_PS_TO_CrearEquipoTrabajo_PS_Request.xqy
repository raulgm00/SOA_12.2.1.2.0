...
declare function local:func($FinEvaluacion as element() (:: schema-element(ns1:FinEvaluacion) ::)) as element() (:: schema-element(ns2:requestCrearEquipoTrabajoMessage) ::) {
    <ns2:requestCrearEquipoTrabajoMessage>
        <ns2:idOperacion>{fn:data($FinEvaluacion/ns1:Header/ns4:Operacion/ns5:CodigoOperacion)}</ns2:idOperacion>
        <ns2:listadoEquipoTrabajo>
            {
                for $equipoTrabajo in $FinEvaluacion/ns1:equipoTrabajo/ns3:equipoTrabajo
                return 
                <ns3:equipoTrabajo>
