...
declare namespace ns2="http://xmlns.oracle.com/pcbpel/adapter/db/ConsultarLineaCreditoByCondicion";
...
$ConsultarCondicionByRolRequest as element() (:: schema-element(ns3:ConsultarCondicionByRolRequest) ::)) as element() (:: schema-element(ns2:ConsultarLineaCreditoByCondicionInput) ::) {
    <ns2:ConsultarLineaCreditoByCondicionInput>
        <ns2:P_CONDICION> </ns2:P_CONDICION>
