        ...
        <des:referencia>{fn:data($desembolso/ns1:Column[@name='REFERENCIA'])}</des:referencia>
            ...
            <des:condicionesFinancieras>
                                ...
                                <des:variable>
                                    ...
                                    <des:spread>
                                        ...
                                        <des:revision>
                                            ...
                                            <des:NumeroCuotas>{fn:data($desembolso/ns1:Column[@name='NUMERO_REVISIONES_SPREAD'])}</des:NumeroCuotas>
                                        </des:revision>
                                    </des:spread>
                                    <des:revision>
                                        ...
                                        <des:NumeroCuotas>{fn:data($desembolso/ns1:Column[@name='NUMERO_REVISIONES_TASA'])}</des:NumeroCuotas>
                                    </des:revision>
                                    <des:limite>
                ...
                <des:principal>
                    ...
                    <des:NumeroCuotas>{fn:data($desembolso/ns1:Column[@name='NUMERO_CUOTAS_PAGO_CAPITAL'])}</des:NumeroCuotas>
                </des:principal>
                <des:interes>
                    ...
                    <des:NumeroCuotas>{fn:data($desembolso/ns1:Column[@name='NUMERO_CUOTAS_PAGO_INTERES'])}</des:NumeroCuotas>
                </des:interes>
                <des:periodoGracia>
                    <des:Frecuencia>
                        <com:Tipo>
