...
declare function local:func($ConfiguracionValidacionAsignacionResponse as element() (:: schema-element(ns1:ConfiguracionValidacionAsignacionResponse) ::),
  ...
  <ns2:VerificarValidacionAsignacionResponse>
        <ns2:SolicitudDesembolso>
          ...
          fn:data($ConfiguracionValidacionAsignacionResponse/ns1:ConfiguracionValidacionAsignacion/con:Header/ns3:ParameterType/ns3:parameterName ='REQUIERE_RAROC')or
          fn:string(fn:data($SolicitudDesembolso/ns2:SolicitudDesembolso/des:ValidacionAsignacion))='true')
          then 
          fn:true()
          else false()
          }</des:ValidacionAsignacion>
