...
declare function local:func($idOperacion as xs:long) as element() (:: schema-element(ns1:EliminarOperacionResponse) ::) {
    <ns1:EliminarOperacionResponse>
        ...
        <ns1:Resultado>
            ...
            <res:message>Operación eliminada satisfactoriamente</res:message>
        </ns1:Resultado>
    </ns1:EliminarOperacionResponse>
};
