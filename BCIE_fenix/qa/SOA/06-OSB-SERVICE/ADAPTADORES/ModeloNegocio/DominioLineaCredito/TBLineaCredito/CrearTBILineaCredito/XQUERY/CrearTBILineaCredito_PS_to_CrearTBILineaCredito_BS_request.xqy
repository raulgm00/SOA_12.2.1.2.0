...
declare namespace ns2="http://xmlns.oracle.com/pcbpel/adapter/db/top/CrearTBILineaCredito";
(:: import schema at "../XSD/TBILineaCredito.xsd" ::)

declare namespace lin = "http://www.bcie.org/LineaCreditoBO";

declare variable $TBILineaCreditoRequest as element() (:: schema-element(ns1:TBILineaCreditoCrearRequest) ::) external;

declare function local:func($TBILineaCreditoRequest as element() (:: schema-element(ns1:TBILineaCreditoCrearRequest) ::)) as element() (:: element(*, ns2:TBLineaCreditoType) ::) {
