...
declare namespace ns2="http://www.bcie.org/ActivarOperacionProcesoMO";
...
declare function local:func($responseMapeoErrorMessage as element() (:: schema-element(ns1:responseMapeoErrorMessage) ::), 
                            ...
                            as element() (:: schema-element(ns2:ActivarOperacionProcesoResponse) ::) {
    <ns2:ActivarOperacionProcesoResponse>
        <ns2:Resultado>
