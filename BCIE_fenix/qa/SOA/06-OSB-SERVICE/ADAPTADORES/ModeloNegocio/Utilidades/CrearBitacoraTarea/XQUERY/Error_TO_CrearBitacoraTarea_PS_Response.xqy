...
declare namespace ns2="http://www.bcie.org/CrearBitacoraTareaMO";
...
declare function local:func($responseMapeoErrorMessage as element() (:: schema-element(ns1:responseMapeoErrorMessage) ::), 
                            ...
                            as element() (:: schema-element(ns2:responseCrearBitacoraTareaMessage) ::) {
    <ns2:responseCrearBitacoraTareaMessage>
        <ns2:Resultado>
