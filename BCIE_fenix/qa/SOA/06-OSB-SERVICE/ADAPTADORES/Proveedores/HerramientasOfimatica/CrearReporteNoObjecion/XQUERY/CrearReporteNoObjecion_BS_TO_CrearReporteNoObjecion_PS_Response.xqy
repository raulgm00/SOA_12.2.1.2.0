...
declare variable $generarReporteNoObjecionesResponse as element() (:: schema-element(rep:Reporte) ::) external;

declare variable $CrearReporteNoObjecionRequest as element() (:: schema-element(ns2:CrearReporteNoObjecionRequest) ::) external;

declare function local:func($generarReporteNoObjecionesResponse as element() (:: schema-element(rep:Reporte) ::),
$CrearReporteNoObjecionRequest as element() (:: schema-element(ns2:CrearReporteNoObjecionRequest) ::)) as element() (:: schema-element(ns2:CrearReporteNoObjecionResponse) ::) {
    <ns2:CrearReporteNoObjecionResponse>
     {
         for $Archivo in $generarReporteNoObjecionesResponse/rep:Archivo
         return 
        <ns2:Documento>
        ...
        <ns2:Resultado>
            <res:result>
              {
              if(fn:data($generarReporteNoObjecionesResponse/rep:Resultado))
                then "OK"
                else "ERROR"
              }
            </res:result>
