...
<flex:crearLoanComplejo>
         <loan>
            ...
            <typ:fechaValor>{fn:data($CrearDesembolsoComplejoV2FLEXCUBERequest/ns1:ContratoDesembolso/des:fechaDisponibilidadFondos)}</typ:fechaValor>
            <typ:fechaVencimiento>{fn:data($CrearDesembolsoComplejoV2FLEXCUBERequest/ns1:ContratoDesembolso/des:fechaVencimiento)}</typ:fechaVencimiento> 
            <typ:destino>{
            ...
            return
               <typ:array>
                  ...
                  <typ:fechaInicioCapital>{fn:data($calendarioCapital/des:Frecuencia/des:FechaInicio)}</typ:fechaInicioCapital>
