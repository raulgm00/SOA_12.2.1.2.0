...
declare function local:func($ValidarRegistroFLEXCUBEResponse as element() (:: schema-element(ns1:ValidarRegistroFLEXCUBEResponse) ::),$referencia as xs:string) as element() (:: schema-element(ns2:CrearDesembolsoComplejoV2FLEXCUBEResponse) ::) {
    <ns2:CrearDesembolsoComplejoV2FLEXCUBEResponse>
