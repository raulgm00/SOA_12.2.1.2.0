...
declare namespace ns2="http://www.bcie.org/IniciarAprobacionLotusMO";
...
declare function local:func($message as xs:string, 
                            $ErrorResponse as element() (:: schema-element(ns1:responseMapeoErrorMessage) ::)) 
                            as element() (:: schema-element(ns2:IniciarAprobacionLotusResponse) ::) {
    <ns2:IniciarAprobacionLotusResponse>
        <ns2:Resultado>
...
local:func($message, $ErrorResponse)
