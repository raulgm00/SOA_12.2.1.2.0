...
declare variable $inputVariable.request as element() (:: schema-element(con:ConfiguracionInteresesCobroRequest) ::) external;
declare variable $outInvokeConsultarRolesPoProcesor.response as element() (:: schema-element(con1:responseConsultarRolesPorProcesoMessage) ::) external;
declare variable $CrearActualizarSolicitudDesembolso_OutputVariable.response as element() (:: schema-element(des:CrearActualizarSolicitudDesembolsoResponse) ::) external;

declare function local:funcConfiguracioninteresescobro_response($outInvokeConsultarProductoByOperacion.response as element() (:: schema-element(pro:ConsultarProductoByIdOperacionResponse) ::), 
                                                                $inputVariable.request as element() (:: schema-element(con:ConfiguracionInteresesCobroRequest) ::), 
                                                                $outInvokeConsultarRolesPoProcesor.response as element() (:: schema-element(con1:responseConsultarRolesPorProcesoMessage) ::), 
                                                                $CrearActualizarSolicitudDesembolso_OutputVariable.response as element() (:: schema-element(des:CrearActualizarSolicitudDesembolsoResponse) ::)) 
                                                                as element() (:: schema-element(con:ConfiguracionInteresesCobroResponse) ::) {
    <con:ConfiguracionInteresesCobroResponse>
        <con:configuracionInteresesCobro>
            <con2:Header>
                {
                   if (fn:true()) then 
                        <ns1:Operacion>
                            ...
                            <ns2:NombreProducto>{fn:data($outInvokeConsultarProductoByOperacion.response/pro:Producto/pro1:descripcion)}</ns2:NombreProducto><ns2:MontoSolicitado></ns2:MontoSolicitado>
                ...
                <ns6:ParameterType>
                    ...
                    <ns6:parameterValue>
                    {if (fn:data($CrearActualizarSolicitudDesembolso_OutputVariable.response/des:Resultado/res:result)= 'OK') 
                    then
                      substring-before(substring-after(fn:data($CrearActualizarSolicitudDesembolso_OutputVariable.response/des:Resultado/res:message),'Id '),' insertado')
                    else ()
                    }
                    </ns6:parameterValue>
                </ns6:ParameterType>
            ...
            <con2:RolesEquipoTrabajo>
                {
                    for $listadoRoles in $outInvokeConsultarRolesPoProcesor.response/con1:ListadoRoles/con3:listadoRoles
                    return 
                    <con2:Rol>
                        {
...
local:funcConfiguracioninteresescobro_response($outInvokeConsultarProductoByOperacion.response, $inputVariable.request, $outInvokeConsultarRolesPoProcesor.response, $CrearActualizarSolicitudDesembolso_OutputVariable.response)
