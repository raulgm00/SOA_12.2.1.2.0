    ...
    <des:CrearActualizarSolicitudDesembolsoRequest>
        <des:SolicitudDesembolso>
           ...
           then
            ...
            if($solicitudDesembolso.response/des:SolicitudDesembolso/des1:ValidacionAsignacion = true() or 
            ...
            $outputVariable.response/con:ConfiguracionValidacionAsignacion/con1:Header/ns1:ParameterType[ns1:parameterName='VALIDADOR_PREA']/ns1:parameterValue = 'true' or
            $outputVariable.response/con:ConfiguracionValidacionAsignacion/con1:Header/ns1:ParameterType[ns1:parameterName='REQUIERE_RAROC']/ns1:parameterValue = 'true')
            then true()
