...
declare namespace v1 = "http://xmlns.bcie.org/ObjetoProceso/Comun/Header/V1";
...
declare namespace v11 = "http://xmlns.bcie.org/ObjetoProceso/Comun/Proceso/V1";
...
declare variable $inputVariable.request as element() (:: schema-element(con1:configuracionSupervisionRequest) ::) external;
...
declare function local:funcXq_consultaroperacionbyid_consultarrolesporproceso($consultarOperacionById_ConsultarOperacionById_OutputVariable.response as element() (:: schema-element(ope:ConsultarOperacionResponse) ::), 
                                                                              ...
                                                                              $inputVariable.request as element() (:: schema-element(con1:configuracionSupervisionRequest) ::)) 
                                                                              as element() (:: schema-element(con1:configuracionSupervisionAmbientalSocialResponse) ::) {
    <con1:configuracionSupervisionAmbientalSocialResponse>
        <con1:configuracionSupervisionAmbientalSocial>
            <con2:Header>
                {
                ...
                <v1:Proceso>
                    <v11:IdFlujo>{fn:data($inputVariable.request/con1:InstanciaProceso)}</v11:IdFlujo>
                </v1:Proceso>
            </con2:Header>
...
local:funcXq_consultaroperacionbyid_consultarrolesporproceso($consultarOperacionById_ConsultarOperacionById_OutputVariable.response, $consultarRolesPorProceso_ConsultarRolesPorProceso_OutputVariable.response,$inputVariable.request)