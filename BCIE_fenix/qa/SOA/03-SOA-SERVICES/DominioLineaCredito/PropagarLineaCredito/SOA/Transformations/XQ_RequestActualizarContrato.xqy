...
declare function local:funcXq_requestactualizarcontrato($outConsultarFechaCargo.response as element() (:: schema-element(com:ConsultarFechaCargoResponse) ::), 
    ...
    <lin:ActualizarCommitmentRequest>
        <lin:LineaCredito>
            ...
            {
             ( 
             xs:decimal(fn:data($consultarLineaCreditoByIdLineaCredito_OutputVariable.response/lin:Operacion/ope:contrato/con1:LineaCredito/lin1:Monto[com1:tipo/cat:DescripcionCorta='MONTO_AMPLIACION']/com1:importe))
             +
             xs:decimal(fn:data($consultarLineaCreditoByIdLineaCredito_OutputVariable.response/lin:Operacion/ope:contrato/con1:LineaCredito/lin1:MontoLinea))
             )
             -
             xs:decimal(fn:data($outConsultarFlexcube.response/lin:TipoContrato/lin1:LineaCredito/lin1:MontoLinea))
            }
            </lin1:MontoLinea>
