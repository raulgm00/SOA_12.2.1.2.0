                ...
                <lin1:Comision>
                    ...
                    <com1:tipoComision>
                            ...
                            <com1:idTipoComision>
                                       ...
                                       <cat:Descripcion>{fn:data($Comision/com1:tipoComision/com1:idTipoComision/cat:Descripcion)}</cat:Descripcion>
                            </com1:idTipoComision>
                    </com1:tipoComision>
                    <com1:moneda>
                           <cat:Id>{fn:data($Comision/com1:moneda/cat:Id)}</cat:Id>
                           <cat:Descripcion>{fn:data($Comision/com1:moneda/cat:Descripcion)}</cat:Descripcion>
                    </com1:moneda>
                    ...
                    <com1:baseCalculo>
                               ...
                               <cat:DescripcionCorta>{fn:data($Comision/com1:baseCalculo/cat:DescripcionCorta)}</cat:DescripcionCorta>
                               <cat:estatus>{fn:data($Comision/com1:baseCalculo/cat:estatus)}</cat:estatus>
                               <cat:codigoExterno>{fn:data($Comision/com1:baseCalculo/cat:codigoExterno)}</cat:codigoExterno>
                        {
