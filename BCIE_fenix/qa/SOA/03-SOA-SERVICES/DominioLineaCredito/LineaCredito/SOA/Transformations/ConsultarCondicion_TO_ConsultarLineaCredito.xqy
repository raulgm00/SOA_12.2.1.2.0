                ...
                <lin1:Comision>
                    ...
                    <com:tipoComision>
                            ...
                            <com:idTipoComision>
                                       ...
                                       <cat:Descripcion>{fn:data($Comision/com:tipoComision/com:idTipoComision/cat:Descripcion)}</cat:Descripcion>
                            </com:idTipoComision>
                    </com:tipoComision>
                    <com:moneda>
                    ...
                    <com:baseCalculo>
                               ...
                               <cat:DescripcionCorta>{fn:data($Comision/com:baseCalculo/cat:DescripcionCorta)}</cat:DescripcionCorta>
                               <cat:estatus>{fn:data($Comision/com:baseCalculo/cat:estatus)}</cat:estatus>
                               <cat:codigoExterno>{fn:data($Comision/com:baseCalculo/cat:codigoExterno)}</cat:codigoExterno>
                    </com:baseCalculo>
