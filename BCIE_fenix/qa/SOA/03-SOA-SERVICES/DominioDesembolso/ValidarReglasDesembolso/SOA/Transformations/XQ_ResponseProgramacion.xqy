...
declare function local:funcXq_responseprogramacion($inputVariable.request as element() (:: schema-element(des:ValidarReglasDesembolsoRequest) ::)) as element() (:: schema-element(des:ValidarReglasDesembolsoResponse) ::) {
    <des:ValidarReglasDesembolsoResponse>
        <des:TareaReglas>
            ...
            }
            {
                ...
                where $ReglasEvaluacion/reg1:Transaccion = 'PROGRAMACION'
                return 
                        ...
                        then 
                            <reg1:Estado>
                                ...
                                }
                                {
                                    ...
                                    if($ReglasEvaluacion/reg1:Estado/cat:DescripcionCorta='NO_APLICA')
                                    then
                                    'CUMPLIDA'
                                    else
                                    fn:data($ReglasEvaluacion/reg1:Estado/cat:DescripcionCorta)
...
local:funcXq_responseprogramacion($inputVariable.request)
