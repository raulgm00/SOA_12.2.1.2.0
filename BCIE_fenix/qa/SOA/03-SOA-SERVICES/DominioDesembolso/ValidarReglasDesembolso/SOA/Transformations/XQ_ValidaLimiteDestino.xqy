...
declare function local:funcXq_validalimitedestino($inputVariable.request as element() (:: schema-element(des:ValidarReglasDesembolsoRequest) ::)) as element() (:: schema-element(des:ValidarReglasDesembolsoResponse) ::) {
...
local:funcXq_validalimitedestino($inputVariable.request)
