...
declare namespace enm="http://xmlns.oracle.com/bpmn/bpmnProcess/EnmiendasProcess";
(:: import schema at "oramds:/apps/Resources/BPM/Schema/PA04/EnmiendasProcess.xsd" ::)
...
declare function local:funcInicioenmiendas_request($OutConsultar.response as element() (:: schema-element(ope:ConsultarOperacionResponse) ::), 
                                                   ...
                                                   as element() (:: schema-element(enm:InicioEnmiendas) ::) {
    <enm:InicioEnmiendas>
        <enm:Header>
            <ns1:Operacion>
            ...
            <ns1:Tarea>
                ...
                <ns3:CodigoProceso>10</ns3:CodigoProceso>
                <ns3:NombreProceso>PA04</ns3:NombreProceso>
            </ns1:Tarea>
            {
...
local:funcInicioenmiendas_request($OutConsultar.response, $outConsultarParametrosEnBitacora.response)
