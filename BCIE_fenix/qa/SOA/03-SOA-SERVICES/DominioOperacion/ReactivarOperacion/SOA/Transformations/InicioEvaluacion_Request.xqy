...
declare namespace eva="http://xmlns.oracle.com/bpmn/bpmnProcess/EvaluacionProcess";
(:: import schema at "oramds:/apps/Resources/BPM/Schema/PC06/EvaluacionProcess.xsd" ::)
...
declare function local:funcInicioevaluacion_request($OutConsultar.response as element() (:: schema-element(ope:ConsultarOperacionResponse) ::), 
                                                    ...
                                                    as element() (:: schema-element(eva:InicioEvaluacion) ::) {
    <eva:InicioEvaluacion>
        <eva:Header>
            <ns1:Operacion>
            ...
            <ns1:Tarea>
                ...
                <ns3:CodigoProceso>6</ns3:CodigoProceso>
                <ns3:NombreProceso>PC06</ns3:NombreProceso>
            </ns1:Tarea>
            {
...
local:funcInicioevaluacion_request($OutConsultar.response, $outConsultarParametrosEnBitacora.response)
