...
declare function local:funcInicioeligibilidad_request($OutConsultar.response as element() (:: schema-element(ope:ConsultarOperacionResponse) ::), 
    ...
    <ele:InicioElegibilidad>
        <ele:Header>
            ...
            <ns1:Tarea>
                ...
                <ns3:NombreProceso>PC01</ns3:NombreProceso>
            </ns1:Tarea>
            {
...
local:funcInicioeligibilidad_request($OutConsultar.response, $outConsultarParametrosEnBitacora.response)
