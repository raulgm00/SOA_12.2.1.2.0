...
public class CondicionesBean extends FenixPanelBean implements Serializable {
    ...
    public CondicionesBean() {
        ...
        String userId = ADFContext.getCurrent().getSecurityContext()
                                  .getUserName().toLowerCase();
        logger.log(ADFLogger.WARNING,
            "userLogin consultarCondicionesByIdOperacionIdRolIdEvento: " +
            userId);

        try {
            logger.log(ADFLogger.WARNING, "getUserLogin: " + getUserLogin());
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    public String getUserLogin() throws Exception {
        ...
        //wfSvcClient = WorkflowService.getTgetWorkflowServiceClient();
        //queryService = wfSvcClient.getTaskQueryService();
        wfContext = querySvc.getWorkflowContext(contextStr);
    ...
    public void getPayloadInformation() throws WorkflowException, IOException {
        ...
        if ((nl != null) && (nl.getLength() > 0) &&
                (nl.item(0).getTextContent().trim().length() > 0)) {
        ...
        if ((nl != null) && (nl.getLength() > 0)) {
            this.setEsRequiereSupervision(Boolean.valueOf(
        ...
        if ((nl != null) && (nl.getLength() > 0)) {
            this.setEsRequiereAnalistaDaeci(Boolean.valueOf(
                    nl.item(0).getTextContent()));
        }
        ...
        if ((nl != null) && (nl.getLength() > 0)) {
            this.setEsRequiereAnalistaOfic(Boolean.valueOf(
                    nl.item(0).getTextContent()));
        }
        ...
        if ((nl != null) && (nl.getLength() > 0)) {
            this.setEsRequiereAnalistaFinam(Boolean.valueOf(
                    nl.item(0).getTextContent()));
        }
        ...
        if ((nl != null) && (nl.getLength() > 0)) {
            this.setEsRequiereEspAmbiental(Boolean.valueOf(
                    nl.item(0).getTextContent()));
        }
        ...
        if ((nl != null) && (nl.getLength() > 0)) {
            this.setEsRequiereEjecutivoFinam(Boolean.valueOf(
                    nl.item(0).getTextContent()));
        }
        ...
        if ((nl != null) && (nl.getLength() > 0)) {
            this.setEsRequiereSegCred(Boolean.valueOf(
                    nl.item(0).getTextContent()));
        }
        ...
        if ((nl != null) && (nl.getLength() > 0)) {
            if (Boolean.valueOf(nl.item(0).getTextContent())) {
                this.setEsRetornoCumplirCondiciones(Boolean.TRUE);
            }
        }
        ...
        logger.warning("esRetornoCumplirCondiciones :" +
            esRetornoCumplirCondiciones);
    ...
    public void obtenerInstanciaProceso() {
        ...
        try {
            if ((BPMUtils.getCurrentTask() != null) &&
                ...
                instancia = BPMUtils.getCurrentTask().getProcessInfo()
                                    .getInstanceId();
            }
        } catch (Exception e) {
    ...
    public void evaluarParametroPStateBpm() {
        ...
        try {
            if (state != null) {
                ...
                setEsEstadoCompletado(state.equalsIgnoreCase("COMPLETED")
    ...
    public void setObservacionValidarCondicion(
        String observacionValidarCondicion) {
    ...
    public void setEsRetornoCumplirCondiciones(
    ...
    public void consultarCondicionesByIdOperacionIdRolIdEvento() {
        logger.log(ADFLogger.WARNING,
            "INTO consultarCondicionesByIdOperacionIdRolIdEvento.");
        ...
        try {
            ...
            operationBinding = bindings.getOperationBinding(
                    "consultarCondicionesByIdOperacionIdRolIdEvento");
            operationBinding.execute();
            logger.log(ADFLogger.WARNING,
                "El metodo consultarCondicionesByIdOperacionIdRolIdEvento se ejecuto correctamente");

            if (null != bindings.getOperationBinding("obtenerCondiciones")) {
                OperationBinding operationBinding1 = bindings.getOperationBinding(
                        "obtenerCondiciones");
                operationBinding1.execute();
                logger.log(ADFLogger.WARNING,
                    "El metodo obtenerCondiciones se ejecuto correctamente.");
            ...
            logger.log(ADFLogger.WARNING, "Numero de rows." +
                condiciones.length);
            ...
            if (condiciones.length > 1) {
                ...
                logger.log(ADFLogger.WARNING,
                    "Numero de rows de condiciones :" + numeroCondicion);
            } else {
                logger.log(ADFLogger.WARNING,
                    "El numero de rows es menor que uno");
            }
        } catch (Exception e) {
            logger.warning("Error en consultarCondicionesByIdOperacionIdRolIdEvento.",
                e);
        }
            ...
            if (condiciones.length > 0) {
                for (Row row : condiciones) {
                    if (null != row.getAttribute("IdCondicion")) {
                        ...
                        logger.log(ADFLogger.WARNING,
                            "Valor de la condicion :::" + idCondicion);

                        operationBinding = bindings.getOperationBinding(
                                "existeValidadorCondicion");
                        operationBinding.getParamsMap()
                                        .put("idCondicion", idCondicion);
                        operationBinding.getParamsMap()
                                        .put("idRolBpm", getIdRol());
                        operationBinding.getParamsMap()
                                        .put("loginUsuario", userId);
                        operationBinding.getParamsMap()
                                        .put("idAgrupador", getIdAgrupador());
                        operationBinding.execute();
                        ...
                        if (condicionValida) {
                            logger.log(ADFLogger.WARNING,
                                "Condicion validada.." + idCondicion);
                        } else {
                            logger.log(ADFLogger.WARNING,
                                "Condicion sin validar" + idCondicion);
                            contador++;
                        }
                    }
                }
                ...
                if (contador > 0) {
                    logger.log(ADFLogger.WARNING,
                        "Faltan condicones por validar" + contador);
                    setCondicionValidada(Boolean.FALSE);
                } else {
                    logger.log(ADFLogger.WARNING,
                        "Las condicones han sido validadas" + contador);
    ...
    public void consultarCondicionesEnModelo() {
        ...
        try {
            ...
            if (null != operationBinding.getResult()) {
                ...
                logger.warning("Numero de rows encontrados en el modelo." +
                    condiciones.length);
            } else {
