...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [WED SEP 07 16:26:08 CDT 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <tns:CrearBitacoraRequest>
      <tns:BitacoraInput>
        ...
        <regBitBO:idProceso>9</regBitBO:idProceso>
        <regBitBO:nombreProceso>Administración de Condiciones</regBitBO:nombreProceso>
