...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [TUE FEB 02 13:25:35 CST 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:EnmiendaPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns2:CodigoTarea>77</ns2:CodigoTarea>
          <ns2:NombreTarea>Revisar aspectos legales de enmiendas</ns2:NombreTarea>
