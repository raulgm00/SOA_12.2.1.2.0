...
public class AdministradorLineaCreditoActionsBean {
    ...
    private static int countLineasNuevas;
    ...
    @PostConstruct
    public void AdminstradorLineaCreditoPost(){
        logger.log(ADFLogger.WARNING, "Valor countLineasNuevas PosConstructor: " + countLineasNuevas);    
    }
...
//        instanciaProceso = "580001";
    ...
    public void aceptarAgregarLineaCreditoActionListener(ActionEvent actionEvent) {
        ...
        try {
            ...
            logger.log(ADFLogger.WARNING, "Error no se puede castear el valor MontoLinea1 1");
            e.getStackTrace();
        }
        ...
        try {
            ...
            logger.log(ADFLogger.WARNING, "Error no se puede castear el valor MontoLinea1 2");
            e.getStackTrace();
        }
...
//        }
    ...
    private String getTBILineaCreditosEstado( 
		...
		/*42472: Se comparte FechaValorContrato para tomarlo en pantalla*/
    public void vcl_AsignaFechaValorContrato(ValueChangeEvent valueChangeEvent) {
        logger.warning("- inicia vcl_AsignaFechaValorContrato -");
        valueChangeEvent.getComponent().processUpdates(FacesContext.getCurrentInstance());
        /*
        logger.warning("- fechaValor: " + JSFUtils.resolveExpression("#{bindings.FechaValorContrato.inputValue}") != null ?
                                            JSFUtils.resolveExpression("#{bindings.FechaValorContrato.inputValue}").toString() : "NA");
        */
        logger.warning("- fechaValor: " + valueChangeEvent.getNewValue() != null ?
                                            valueChangeEvent.getNewValue().toString() : "NA");
        
        Timestamp fechaValorCon = (Timestamp) JSFUtils.resolveExpression("#{bindings.FechaValorContrato.attributeValue}");
                        
        logger.warning("- fechaValor: " + fechaValorCon);

        ADFContext adfCtx = ADFContext.getCurrent();
        Map sessionScope = adfCtx.getSessionScope();
        Object val = sessionScope.put("fechaValorContrato", fechaValorCon);
