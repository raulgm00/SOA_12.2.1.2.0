...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [THU NOV 17 11:01:16 CST 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:EvaluacionPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns5:CodigoTarea>175</ns5:CodigoTarea>
          <ns5:NombreTarea>Validar cuestionarios completos seguimiento SIEMAS</ns5:NombreTarea>
          <ns5:CodigoRol>68</ns5:CodigoRol>
          <ns5:NombreRol>Validador SIEMAS</ns5:NombreRol>
