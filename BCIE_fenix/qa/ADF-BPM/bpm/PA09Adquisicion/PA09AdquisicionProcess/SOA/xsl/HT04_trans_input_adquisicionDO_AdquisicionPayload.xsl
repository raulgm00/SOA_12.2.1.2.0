...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [WED OCT 26 13:31:35 CDT 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:AdquisicionPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns5:CodigoTarea>196</ns5:CodigoTarea>
          <ns5:NombreTarea>Realizar ajustes a solicitud de no objeción</ns5:NombreTarea>
