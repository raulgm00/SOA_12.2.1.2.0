...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java" xmlns:xp20="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.Xpath20" xmlns:xref="http://www.oracle.com/XSL/Transform/java/oracle.tip.xref.xpath.XRefXPathFunctions" xmlns:mhdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.mediator.service.common.functions.MediatorExtnFunction" xmlns:ns0="http://xmlns.bcie.org/ObjetoProceso/FormalizacionEnmiendas/Payload/V1" xmlns:oraext="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.ExtFunc" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue" xmlns:oracle-xsl-mapper="http://www.oracle.com/xsl/mapper/schemas" xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="xsd xsi oracle-xsl-mapper xsl ns0 oraxsl xp20 xref mhdr oraext dvm socket" xmlns:header="http://xmlns.bcie.org/ObjetoProceso/Comun/Header/V1" xmlns:parameter="http://xmlns.bcie.org/ObjetoProceso/Comun/Parameter/V1" xmlns:ns1="http://www.bcie.org/CatalogoBO" xmlns:ns2="http://xmlns.bcie.org/ObjetoProceso/Comun/Operacion/V1" xmlns:ns3="http://xmlns.bcie.org/ObjetoProceso/Comun/Proceso/V1" xmlns:ns5="http://xmlns.bcie.org/ObjetoProceso/Comun/Tarea/V1" xmlns:ns4="http://xmlns.bcie.org/ObjetoProceso/Comun/Cliente/V1">
   ...
   <xsl:template match="/">
      <ns0:FormalizacionEnmiendasPayload>
         <ns0:Header>
            ...
            <header:Tarea>
               <ns5:CodigoTarea>
                  <xsl:value-of select="dvm:lookupValue (&quot;oramds:/apps/Resources/ComponentesComunes/Utilidades/ConfiguracionProcesos/V1/DVM/ConfiguracionTareasProcesos.dvm&quot;, &quot;CodigoTarea&quot;, &quot;HT01SolicitarFormalizacionDeEnmienda&quot;, &quot;IdTarea&quot;, &quot;&quot; )"/>
               </ns5:CodigoTarea>
               <ns5:NombreTarea>
                  <xsl:value-of select="dvm:lookupValue (&quot;oramds:/apps/Resources/ComponentesComunes/Utilidades/ConfiguracionProcesos/V1/DVM/ConfiguracionTareasProcesos.dvm&quot;, &quot;CodigoTarea&quot;, &quot;HT01SolicitarFormalizacionDeEnmienda&quot;, &quot;NombreTarea&quot;, &quot;&quot; )"/>
               </ns5:NombreTarea>
               <ns5:CodigoRol>1</ns5:CodigoRol>
               <ns5:NombreRol>Responsable de Operación</ns5:NombreRol>
               <ns5:CodigoProceso>
                  <xsl:value-of select="dvm:lookupValue (&quot;oramds:/apps/Resources/ComponentesComunes/Utilidades/ConfiguracionProcesos/V1/DVM/ConfiguracionProcesos.dvm&quot;, &quot;ParameterName&quot;, &quot;PA15&quot;, &quot;ParameterValue&quot;, &quot;&quot; )"/>
               </ns5:CodigoProceso>
               <ns5:NombreProceso>
                  <xsl:value-of select="dvm:lookupValue (&quot;oramds:/apps/Resources/ComponentesComunes/Utilidades/ConfiguracionProcesos/V1/DVM/ConfiguracionProcesos.dvm&quot;, &quot;ParameterName&quot;, &quot;PA15&quot;, &quot;Proceso&quot;, &quot;&quot; )"/>
               </ns5:NombreProceso>
            </header:Tarea>
            <header:Proceso>
               <ns3:IdProceso>
         ...
         <xsl:for-each select="/ns0:FormalizacionEnmiendasPayload/ns0:Header/parameter:ParameterType">
            <xsl:if test="parameter:parameterName = &quot;IDORIGENFORMALIZACION&quot;">
