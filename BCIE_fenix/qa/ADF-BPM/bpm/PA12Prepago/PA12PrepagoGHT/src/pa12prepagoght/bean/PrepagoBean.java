...
public class PrepagoBean extends FenixPanelBean  implements Serializable{
    ...
    private Boolean esBtnCalcularBloqueado = Boolean.FALSE;   
    ...
    public void inicializarIngresarSolicitudPrepago() {
        ...
        esBtnCalcularBloqueado = Boolean.FALSE; 
...
//        }
        ...
        //metodo para inicializar 'FormularioObservacionPrepagoVO'
        operationBinding = bindings.getOperationBinding("TcaTipoMonedaDesembolso_ID_OPERACION");
        operationBinding.getParamsMap().put("value",getCodigoOperacion()); 
        operationBinding.execute();
        if(!operationBinding.getErrors().isEmpty()){ 
            JSFUtils.addFacesErrorMessage(operationBinding.getErrors().toString());
        } else if (operationBinding.getResult() != null) {
            logger.log(ADFLogger.WARNING, "TcaTipoMonedaDesembolso_ID_OPERACION is succesfull");
        }
        inicializarRealizarAjustesSolicitudPrepago();
    }
    ...
    protected Map<String,Object> VGtblPenalidad = new HashMap<String,Object>();
    public void calcularDetallePenalidadPrepago(Long idPrepago,Integer idOperacion){
        logger.log(ADFLogger.WARNING, "Dentro de calcularDetallePenalidadPrepago.");
        BindingContainer bindings = ADFUtils.getBindingContainer();
        OperationBinding operationBinding = null;
//        Map<String,Object> VtblPenalidad = new HashMap<String,Object>(); 
        try{
        operationBinding = bindings.getOperationBinding("llenarDetallePenalidadPrepago");
        operationBinding.getParamsMap().put("idPrepago", idPrepago);
        operationBinding.getParamsMap().put("idOperacion", idOperacion);
        operationBinding.execute();
        if(!operationBinding.getErrors().isEmpty()){
        ...
        {
            VGtblPenalidad = (Map<String,Object>)operationBinding.getResult();
            logger.log(ADFLogger.WARNING, "se ha obtenido VtblPenalidad de calcularDetallePenalidad VGtblPenalidad");
        }
        }catch(Exception e){
            logger.log(ADFLogger.ERROR,"Error en el metodo calcularDetallePenalidadPrepago." + e.getClass() +"."+ e.getMessage());
        }
//        return VtblPenalidad;
    }
    ...
    public void realizarCalculosInteresesPenalidadPrepago(){
        logger.log(ADFLogger.WARNING, "Dentro de realizarCalculosInteresesPenalidades. Nuevo2"); 
    
        try{
            Long idPrepago = getIdPrepago();
            logger.log(ADFLogger.WARNING, "idPrepago >> " + idPrepago); 
            Integer idOperacionInteger = Integer.valueOf(idOperacion);
            logger.log(ADFLogger.WARNING, "idOperacionInteger >> " + idOperacionInteger);
             
            this.calcularDetallePenalidadPrepago(idPrepago,idOperacionInteger);
            Map<String,Object> map = this.VGtblPenalidad; 
            
            Timestamp VfechaCalculoDefinitivo = null;
            Timestamp VfechaReferencia = null;
            try{
                VfechaCalculoDefinitivo = (Timestamp) map.get("PFECHACALCULODEFINITIVO");    
                logger.log(ADFLogger.WARNING, "VfechaCalculoDefinitivo:> " + VfechaCalculoDefinitivo);
                
                VfechaReferencia = (Timestamp) map.get("PFECHAREFERENCIA");    
                logger.log(ADFLogger.WARNING, "VfechaReferencia:> " + VfechaReferencia);
            }
            catch(Exception exp)
            {
                logger.log(ADFLogger.WARNING, "Error fechas:> " + exp.getMessage()); 
            } 
            BigDecimal VTasaLibor = map.get("PTASALIBOR") != null ? new BigDecimal(map.get("PTASALIBOR").toString()) : null; 
            BigDecimal Vprime = map.get("PTASAPRIME") != null ? new BigDecimal(map.get("PTASAPRIME").toString()) : null;
            BigDecimal VmontoCargoTramite = map.get("PCARGOTRAMITEVALOR") != null ? new BigDecimal(map.get("PCARGOTRAMITEVALOR").toString()) : null;
            String VcargoTramitePrepago = map.get("PCARGOTRAMITEDESCRIPCION") != null ? map.get("PCARGOTRAMITEDESCRIPCION").toString() : null;
            Integer VidTcaTipoMonedaTramite = map.get("PIDTCATIPOMONEDATRAMITE") != null ? new Integer(map.get("PIDTCATIPOMONEDATRAMITE").toString()) : null;
//            List<Map<String,String>> VtblPenalidad = map.get("TBLPENALIDAD") != null ? (List<Map<String,String>>)map.get("TBLPENALIDAD") : null;

            logger.log(ADFLogger.WARNING, "fechaCalculoDefinitivo> " + VfechaCalculoDefinitivo); 
            logger.log(ADFLogger.WARNING, "tasaLibor> " + VTasaLibor); 
            logger.log(ADFLogger.WARNING, "fechaReferencia> " + VfechaReferencia); 
            logger.log(ADFLogger.WARNING, "prime> " + Vprime); 
            logger.log(ADFLogger.WARNING, "montoCargoTramite> " + VmontoCargoTramite); 
            logger.log(ADFLogger.WARNING, "cargoTramitePrepago> " + VcargoTramitePrepago); 
            logger.log(ADFLogger.WARNING, "idTcaTipoMonedaTramite> " + VidTcaTipoMonedaTramite);
             
            setTasaLibor(VTasaLibor);                        
            setPrime(Vprime);            
            setMontoCargoTramite(VmontoCargoTramite);
            setCargoTramitePrepago(VcargoTramitePrepago);
            setIdTcaTipoMonedaTramite(VidTcaTipoMonedaTramite);
            setFechaCalculoDefinitivo(VfechaCalculoDefinitivo);
            setFechaReferencia(VfechaReferencia);   
            
            logger.log(ADFLogger.WARNING, "fechaCalculoDefinitivo> " + getFechaCalculoDefinitivo()); 
            logger.log(ADFLogger.WARNING, "tasaLibor> " + getTasaLibor()); 
            logger.log(ADFLogger.WARNING, "fechaReferencia> " + getFechaReferencia()); 
            logger.log(ADFLogger.WARNING, "prime> " + getPrime()); 
            logger.log(ADFLogger.WARNING, "montoCargoTramite> " + getMontoCargoTramite()); 
            logger.log(ADFLogger.WARNING, "cargoTramitePrepago> " + getCargoTramitePrepago()); 
            logger.log(ADFLogger.WARNING, "idTcaTipoMonedaTramite> " + getIdTcaTipoMonedaTramite());
...
//            }        
            ...
            JboException ex = new JboException(e);
            ex.addToExceptions(new Exception("Error en realizarCalculosInteresesPenalidades."));
            logger.log(ADFLogger.WARNING, "Error en realizarCalculosInteresesPenalidades.> " + e.getMessage());
            throw ex;
        }
...
//                operationBinding.execute();
            ...
            //metodo para inicializar 'FormularioObservacionPrepagoVO'
            OperationBinding operationBinding = bindings.getOperationBinding("TcaTipoMonedaDesembolso_ID_OPERACION");
            operationBinding.getParamsMap().put("value",getCodigoOperacion()); 
            operationBinding.execute();
            if(!operationBinding.getErrors().isEmpty()){ 
                JSFUtils.addFacesErrorMessage(operationBinding.getErrors().toString());
            ...
            logger.log(ADFLogger.WARNING, "Ejecutara realizarCalculosInteresesPenalidadPrepago");
            this.realizarCalculosInteresesPenalidadPrepago();
            logger.log(ADFLogger.WARNING, "Ejecutara realizarCalculosInteresesPenalidades");
            this.realizarCalculosInteresesPenalidades();
            logger.log(ADFLogger.WARNING, "Finalizo ambos");
    ...
    public void inicializarRealizarAjustesSolicitudPrepago() {
        ...
        esBtnCalcularBloqueado = Boolean.TRUE; 
...
//            isComision = (Boolean)operationBinding.getResult();
    ...
    public void setEsBtnCalcularBloqueado(Boolean esBtnCalcularBloqueado) {
        this.esBtnCalcularBloqueado = esBtnCalcularBloqueado;
    }

    public Boolean getEsBtnCalcularBloqueado() {
        return esBtnCalcularBloqueado;
    }
}
