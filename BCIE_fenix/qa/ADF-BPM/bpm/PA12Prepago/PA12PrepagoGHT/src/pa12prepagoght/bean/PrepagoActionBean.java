...
public class PrepagoActionBean extends FenixActionBean {
    ...
    private Boolean contratosActualizados = Boolean.FALSE;
    ...
    public void tipoResolucionValueChangeListener(ValueChangeEvent vce){
        ...
        contratosActualizados = Boolean.FALSE;
    ...
    public void tipoMonedaValueChangeListener(ValueChangeEvent vce){
        ...
        if (idOperacion != null) {
            ...
            //prepagoBean.consultarContratosDesembolsos(idOperacion, idTcaTipoResolucion, idTcaTipoMoneda, null, fechaRenovacion, fechaPrepago); 
        }else{
