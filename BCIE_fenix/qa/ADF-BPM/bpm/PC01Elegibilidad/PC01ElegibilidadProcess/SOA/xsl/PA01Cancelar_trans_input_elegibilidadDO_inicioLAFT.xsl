...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [THU FEB 25 15:19:53 CST 2016].-->
  </oracle-xsl-mapper:schema>
    ...
    <tns:InicioLAFT>
      <tns:Header>
        ...
        <parameter:ParameterType>
          <parameter:parameterName>CANCELAREFORMULACION</parameter:parameterName>
