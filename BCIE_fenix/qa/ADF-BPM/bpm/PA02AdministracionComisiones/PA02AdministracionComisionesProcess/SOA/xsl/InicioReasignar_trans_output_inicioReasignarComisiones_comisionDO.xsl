  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="InicioReasignarComisiones"
                                       namespace="http://xmlns.oracle.com/bpmn/bpmnProcess/ComisionesProcess"/>
        <oracle-xsl-mapper:param name="inicioReasignarComisiones"/>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [THU AUG 17 14:16:28 CDT 2017].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <tns:ComisionPayload>
      <tns:Header>
        <tns6:Operacion>
          <ns2:CodigoOperacion>
            <xsl:value-of select="/ns0:InicioReasignarComisiones/ns0:Header/tns6:Operacion/ns2:CodigoOperacion"/>
          </ns2:CodigoOperacion>
          <ns2:ResponsableOperacion>
            <xsl:value-of select="/ns0:InicioReasignarComisiones/ns0:Header/tns6:Operacion/ns2:ResponsableOperacion"/>
          </ns2:ResponsableOperacion>
        </tns6:Operacion>
        <tns6:Tarea>
          <ns5:CodigoProceso>
            <xsl:value-of select="/ns0:InicioReasignarComisiones/ns0:Header/tns6:Tarea/ns5:CodigoProceso"/>
          </ns5:CodigoProceso>
        </tns6:Tarea>
        <tns6:Proceso>
          <ns3:IdProceso>
            <xsl:value-of select="/ns0:InicioReasignarComisiones/ns0:Header/tns6:Proceso/ns3:IdProceso"/>
          </ns3:IdProceso>
        </tns6:Proceso>
        <xsl:for-each select="/ns0:InicioReasignarComisiones/ns0:Header/param:ParameterType">
          <param:ParameterType>
            <param:parameterName>
