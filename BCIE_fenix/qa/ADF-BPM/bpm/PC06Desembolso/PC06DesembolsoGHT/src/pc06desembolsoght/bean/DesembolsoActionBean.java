...
/*
  ...
  */    
    ...
    public Boolean validarLimitesTasaMonto(){
        ...
        if(null != montoMaximoDesembolso && null != montoMinimoDesembolso){
                if(null != montoEnDolares){
                    if(montoEnDolares.compareTo(montoMinimoDesembolso)==-1){
                    ...
                    if(montoEnDolares.compareTo(montoMaximoDesembolso)==1){
                ...
                LOGGER.warning("ERROR no se puede realizar la validacion de limites de montos. Algun valor es NULL ya sea el monto minimo o el maximo. Se salta la validacion");
                esErrorMonto=Boolean.FALSE;
            }
                                ...
                                if(null != formaTransferencia){
                                    if(formaTransferencia.compareTo(1)==0){
                                        if(null == row.getAttribute("NumeroCuentaClientePasivo")){
                                            ...
                                            //CAMBIO REALIZADO EL 17/11/2021 POR JFLORES Ya no sera obligatorio llenar este campo, ver ticket #7138 //
                                            //resultado = Boolean.FALSE; //
                                            // esCampoNull = Boolean.TRUE; // 
                                            // 
                                            }
