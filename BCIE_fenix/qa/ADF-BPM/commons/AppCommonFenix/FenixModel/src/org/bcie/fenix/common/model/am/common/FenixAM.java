...
public interface FenixAM extends ApplicationModule {
    ...
    BigDecimal convertirMonedas(Integer claveTipo, String codigoA,
        BigDecimal monto);
    ...
    Boolean agregarCondiciones(Long idOperacion, String responsableOperacion,
        Row[] SeleccionCondiciones);
    ...
    Map solicitarInicioSeguimientoCrediticio(Long idCliente,
        String responsableCliente, String tipoInicio);
    ...
    Boolean inicioValidacionAsignacionRecursos(String idOperacion,
        String loginUsuario, String idSolicitud);
    ...
    Map inicioGestionCobro(Integer idTarea, Integer idCliente,
        String responsableCliente, String inicio, Boolean automatico);
    ...
    Boolean crearRegistroComision(Long idOperacion, String nombreTcc,
        Integer idTcaTcc, Integer idTcaEstadoTcc, Integer idTcaSubEstadoTcc,
        Long idTccCurrentRow);

    BigDecimal convertirMonedasPrepago(Integer claveTipo, String codigoA,
        BigDecimal monto);
    ...
    boolean actualizarComisionAccionesMatrizTCC(String sIdProceso,
        String sTipoTCC, String sAccion);

    Boolean validaComisionEnRegistro(Long idOperacion);

    Boolean actualizarSubEstadoComision(Integer idTcaSubEstadoTcc,
        Long idOperacion);

    Boolean actualizarEstadoComision(Integer idTcaEstadoTcc, Long idOperacion);

    Boolean eliminaComisionCancelarRegistrarComision(
        Integer idTcaSubEstadoTcc, Long idOperacion);
    ...
    Boolean crearTcc(Long idOperacion, String tipoTcc, String nombreTcc,
        Integer idTcaTcc, Integer idTcaEstadoTcc, Integer idTcaSubEstadoTcc,
        Long idTccCurrentRow, String tcaDescCorta, String loginUsuario);

    Boolean crearTccEnmendado(Long idOperacion, Long idEnmienda,
        String instanciaProceso, String tipoTcc, String nombreTcc,
        Integer idTcaTcc, Integer idTcaEstadoTcc, Integer idTcaSubEstadoTcc,
        String accion, String tcaDescCorta, String loginUsuario);

    Boolean enmendarTcc(Long idOperacion, Long idEnmienda,
        String instanciaProceso, oracle.jbo.domain.Number idTcc,
        String tipoTcc, Integer idTcaEstadoTcc, Integer idTcaSubEstadoTcc,
        String accion, String tcaDescCorta, String loginUsuario);
    ...
    Boolean precargaASJURPorIdOperacionAndIdEnmienda(
        oracle.jbo.domain.Number idOperacion,
        oracle.jbo.domain.Number idEnmienda);

    Boolean precargaOGCPorIdOperacionAndIdEnmienda(
        oracle.jbo.domain.Number idOperacion,
        oracle.jbo.domain.Number idEnmienda);
    ...
    Long adjuntarDocumentoCliente(oracle.jbo.domain.Number idCliente,
        oracle.jbo.domain.Number idTareaBpm, Boolean esJustificacion,
        BlobDomain content, String fileName, String mimeType, String codigo,
        Date fecha, Integer idTipo, String resumen,
        oracle.jbo.domain.Number idAccion, String loginCreadoPor,
    ...
    void testAdjuntarDocumento(oracle.jbo.domain.Number idOperacion,
        oracle.jbo.domain.Number idTareaBpm, Boolean esJustificacion,
        String fileName, String mimeType, String codigo, Date fecha,
        Integer idTipo, String resumen, oracle.jbo.domain.Number idAccion,
        String loginCreadoPor, String nombreCreadoPor, String idOnbase,
        oracle.jbo.domain.Number numeroSerieDocumento);

    void testAdjuntarDocumentoCliente(oracle.jbo.domain.Number idCliente,
        oracle.jbo.domain.Number idTareaBpm, Boolean esJustificacion,
        String fileName, String mimeType, String codigo, Date fecha,
        Integer idTipo, String resumen, oracle.jbo.domain.Number idAccion,
        String loginCreadoPor, String nombreCreadoPor, String idOnbase,
    ...
    Map consultarDocumentosCliente(Long idCliente, Integer idTareaBpm,
        Long numeroSerieDocumento, Boolean esNumSerie, String instanciaProceso);

    Boolean enviarCorreoCuestionarioElegibilidad(Long idOperacion,
        String responsable);

    String obtenerNombreCompleto(String login);

    List<UsuarioReunion> getListaUsuariosReunionMiembroComite(
        String rolUsuario, String loginUsuario, String nombreUsuario);
    ...
    void testDatosDesembolso(Long idDesembolso);
