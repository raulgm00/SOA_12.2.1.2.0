...
// ---------------------------------------------------------------------
public class CFandComponente2VOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public CFandComponente2VOImpl() {
    }
    ...
    public Row llenarCFandComponente2(String idContratoDesembolso) {
        //--- llenar nuevo VOs
        Row row = null;
        System.out.println("***obteniendo buscarCFandComponente2*****");
        setNamedWhereClauseParam("ID_CONTRATO_DESEMBOLSO", idContratoDesembolso);
        executeQuery();
        System.out.println("voCFandComponente2.getEstimatedRowCount(): " + getEstimatedRowCount());
        ...
        while (rowiter.hasNext()) {
            CFandComponente2VORowImpl CFandComponente2VO = (CFandComponente2VORowImpl) rowiter.next();
            row = CFandComponente2VO;
        }
        ...
        if (row != null) {
            ...
            try {
                ...
                System.out.println("rowCFandComponente2VO sin registros" + e);
            }

            System.out.println("Se encontro Registro de CFandComponente2VORowImpl. idCalendario: " + idCalendario);
        }
        //---------------------
        return row;
    }
