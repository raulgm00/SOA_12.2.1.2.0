...
public class FenixConstants {
    ...
    public static final String TITULO_AGREGAR_COMISION = "Agregar comisi?n";
    public static final String TITULO_MODIFICAR_COMISION = "Modificar comisi?n:";
    ...
    public static final String PC06_VALIDAR_CUESTIONARIO_ODE_GENERAR_INFORME_IBCIE =
        "171";
    public static final String PC06_VALIDAR_INFORME_IBCIE = "172";
    public static final String PC06_COMPLETAR_CUESTIONARIO_SEGUIMIENTO_SIEMAS_SUPERVISION =
        "173";
    public static final String PC06_COMPLETAR_CUESTIONARIO_SEGUIMIENTO_SIEMAS = "174";
    public static final String PC06_VALIDAR_CUESTIONARIO_COMPLETO_SEGUIMIENTO_SIEMAS =
        "175";
    ...
    public static final String PC05_VALIDAR_DERIVADOR_IMPLICITOS = "233";
    /* TABLA DINAMICA */
    ...
    public static final int PA08_REVISAR_CONCLUSIONES_RECOMENDACIONES_SUPERVISION =
        94;
    ...
    public static final int CGD_VALIDAR_CLASIFICACION_ESTRATEGICA_Y_USO_DE_RECURSOS =
        152;
    ...
    public static final int PROCESO_SUPERVISION_AMBIENTAL_SOCIAL = 39;
    ...
    public static final int TIPO_DOCUMENTO_SOPORTE_JUSTIFICACION_INTERVENCION_UCE =
        1078;
    ...
    /**********************************PA18 SUPERVISION AMBIENTAL SOIAL************************************/
    public static final int PA18_SUPERVISAR_ASPECTOS_AMBIENTALES_SOCIALES = 238;
    public static final int PA18_REVISAR_CONCLUSIONES_RECOMENDACIONES_SUPERVISION = 239;    
    ...
    public static final Integer DOCUMENTO_VALIDAR_MATRIZ = 1245;
    ...
    //Supervisi?n
    public static final Integer DOCUMENTO_INFORME_SUPERVISION_PROYECTO_EJECUCION =
        1103;
    public static final Integer DOCUMENTO_INFORME_SUPERVISION_PROYECTO_OPERACION =
        1104;
    ...
    public static final Integer DOCUMENTO_CONFIRMACION_CIERRE_CUENTAS_BANCARIAS_INVERSIONES =
        1097;
    ...
    public static final Integer TCA_CATEGORIA_ACCION_UNIDAD_SEGUIMIENTO_CREDITICIO =
        1;
    ...
    public static final Integer ID_ROL_INGRESADOR_VALDIADOR_SUPERVISION_AS = 92;
    ...
    public static final String ROL_ACCIONES_SUPERVISION_AS = "FENIX_ESPECIALISTA_AMBIENTAL";
    ...
    public static final Long ID_REGLA_TRANSACCION_SCR_CONTINUAR_PROCESO_DESEMBOLSO =
        2L;
    ...
    public static final Integer PRESTAMO_ESTRUCTURADO = 2;
    public static final Integer LINEA_GLOBAL_DE_CREDITO_A_IFI = 3;
    public static final Integer LINEA_PARA_APOYAR_LA_GESTION_DE_LIQUIDEZ_DE_LOS_BANCOS_CENTRALES_DE_LOS_PAISES_FUNDADORES_DEL_BCIE = 4;
    public static final Integer LINEA_DE_CREDITO_PARA_ENTIDADES_PUBLICAS_DESCENTRALIZADAS = 5;
    public static final Integer AMPLIACION_DE_LINEA_GLOBAL_DE_CREDITO_A_IFI =26;														  
    ...
    public static final int ID_ESTADO_SOLICITUD_DESEMBOLSO_CREADO_POR_IMPLEMENTACION =
        23;
    public static final int ID_ESTADO_CONTRATO_DESEMBOLSO_CREADO_POR_IMPLEMENTACION =
        24;
    public static final Integer ID_ESTADO_CONTRATO_DESEMBOLSO_VALIDADO_POR_IMPLEMENTACION =
        26;
