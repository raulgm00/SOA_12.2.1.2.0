function change(element){
  ...
  var origen = element.innerHTML;
  origen = origen.trim();
  console.log('Origen = '+ origen.trim());
  
  var largo_padre = 0;
  
  if(origen.trim() == 'leer m\u00E1s...'){
  	origen = 'leer menos...';
  ...
  document.getElementById(element.id).innerHTML = origen.trim();
 
  console.log('Texto cambiado = '+origen.trim());
