...
public class MattrizTccActionsBean extends FenixActionBean {
    ...
    /**
     * Define Id del proceso BPM de Supervicio AS
     */
    public static final Integer ID_PROCESO_SUPERVICION_AS_BPM = 39;
            ...
            if(idProcesoBpm != null){
                ...
                switch(idAccion){
                    case 1: //Codigo para el Id Accion Editar
                        ...
                        if (ID_PROCESO_SUPERVICION_AS_BPM.equals(idProcesoBpm)) {
                            esValida = true;
                        }
                    break;
