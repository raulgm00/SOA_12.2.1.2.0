...
public class DetalleOperacionBean implements Serializable {
    ...
    public void solicitarPrepagoActionListener(ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING, "Inside solicitarPrepagoActionListener.");

        logger.log(ADFLogger.WARNING, "idOperacion." + gestorOperacionesBean.getIdOperacion());
        logger.log(ADFLogger.WARNING, "userName." + ADFContext.getCurrent().getSecurityContext().getUserName());
        logger.log(ADFLogger.WARNING, "rol." + gestorOperacionesBean.getRolInicio());
        logger.log(ADFLogger.WARNING, "responsableOperacion." + gestorOperacionesBean.getResponsableOperacionInicio());
                ...
                if (resultEstado == ESTADO_FINALIZADO) {
                    ...
                    if (resultEstado == ESTADO_CANCELADO) {
                        ...
                        if (!result) {
                            ...
                            if (validaProducto()) {
                                setMensajeConfirmacion(mensaje + "¿Confirma iniciar el ‘Proceso de Prepago’ de la operación " +
...
//            }
    ...
    public void solicitarEvaluacion(String p_componente, String p_tipo_proceso) 
    {
        ...
        logger.log(ADFLogger.WARNING, "poseeCuestionarioBase2");
        BindingContainer bindingEvaluaciones = ADFUtils.getBindingContainer();      
        OperationBinding operationBindingEvaluaciones = bindingEvaluaciones.getOperationBinding("poseeCuestionarioBaseEvaluaciones");
        ...
        if(operationBindingEvaluaciones.getResult() != null)
        {
            poseeCuestionarioBase = (String)operationBindingEvaluaciones.getResult();
            logger.log(ADFLogger.WARNING, "resultado operationBindingEvaluaciones.getResult(): " + operationBindingEvaluaciones.getResult());
        ...
        {
            JSFUtils.addFacesInformationMessage("poseeCuestionarioBase retorno null");
        } 
