...
declare function local:func($responseMaperoErrorMessage as element() (:: schema-element(ns1:responseMapeoErrorMessage) ::), 
                            $mensaje as xs:string) 
                            as element() (:: schema-element(ns2:ActualizarEstadoLeccionAprendidaResponse) ::) {
    <ns2:ActualizarEstadoLeccionAprendidaResponse>
        <ns2:Resultado>
