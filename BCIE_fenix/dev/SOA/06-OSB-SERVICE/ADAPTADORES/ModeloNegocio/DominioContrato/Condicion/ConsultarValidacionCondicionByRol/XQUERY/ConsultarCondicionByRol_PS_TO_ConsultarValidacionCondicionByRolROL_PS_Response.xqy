...
declare variable $ConsultarCondicionValidacionByRolRequest as element() (:: schema-element(ns2:ConsultarCondicionValidacionByRolRequest) ::) external;

declare function local:func($ConsultarCondicionValidacionByRolRequest as element() (:: schema-element(ns2:ConsultarCondicionValidacionByRolRequest) ::),
                            $ConsultarValidacionCondicionByRolOutputCollection as element() (:: schema-element(ns1:ConsultarValidacionCondicionByRolOutputCollection) ::), 
...
<ns2:ConsultarCondicionValidacionByRolResponse>
 {
            for $ConsultarCondicionByRolOutput in $ConsultarCondicionByRolResponse/ns2:Condicion[con:categoriaCondicion/con:validadores/cat:Id = $ConsultarCondicionValidacionByRolRequest/ns2:idRol]
            return
        <ns2:Condicion>
...
local:func($ConsultarCondicionValidacionByRolRequest, $ConsultarValidacionCondicionByRolOutputCollection, $ConsultarCondicionByRolResponse)