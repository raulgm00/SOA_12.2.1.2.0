...
declare function local:func($responseMapeoErrorMessage as element() (:: schema-element(ns1:responseMapeoErrorMessage) ::),$message as xs:string) as element() (:: schema-element(ns2:ConsultarCumplimientoCondicionResponse) ::) {
    <ns2:ConsultarCumplimientoCondicionResponse>
        <ns2:Resultado>
            <res:result>{fn:data($responseMapeoErrorMessage/ns1:Result/res:result)}</res:result>
