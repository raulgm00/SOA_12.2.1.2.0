...
declare function local:func($OutputParameters as element() (:: schema-element(ns1:OutputParameters) ::)) as element() (:: schema-element(ns2:ConsultarAdjuntoByIdAdjuntoResponse) ::) {
    ...
    { if (fn:data($OutputParameters/ns1:RECORDSET/ns1:Row/ns1:Column[@name='ID_DOCUMENTO'])) then
        <ns2:Documento>
            ...
            <doc:proceso>{fn:data($OutputParameters/ns1:RECORDSET/ns1:Row/ns1:Column[@name='PROCESO_BPM'])}</doc:proceso>
            <doc:idproceso>{fn:data($OutputParameters/ns1:RECORDSET/ns1:Row/ns1:Column[@name='ID_PROCESO_BPM'])}</doc:idproceso>
            <doc:tarea>{fn:data($OutputParameters/ns1:RECORDSET/ns1:Row/ns1:Column[@name='TAREA'])}</doc:tarea>
            <doc:idtarea>{fn:data($OutputParameters/ns1:RECORDSET/ns1:Row/ns1:Column[@name='ID_TAREA'])}</doc:idtarea>
            <doc:proceso>{fn:data($OutputParameters/ns1:RECORDSET/ns1:Row/ns1:Column[@name='INSTANCIA_PROCESO'])}</doc:proceso>
