    ...
    <ns2:InicioCancelarInstancia>
        <ns2:Header>
            ...
            <ns8:ParameterType>
                ...
                <ns8:parameterValue>{fn:data($InicioCancelarInstanciaRequest/ns1:Header/ns8:ParameterType[ns8:parameterName = 'ID_DESEMBOLSO']/ns8:parameterValue)}</ns8:parameterValue>
            </ns8:ParameterType>
             <ns8:ParameterType>
                <ns8:parameterName>TIPO_DESEMBOLSO</ns8:parameterName>
                <ns8:parameterValue>1</ns8:parameterValue>
            </ns8:ParameterType>
        </ns2:Header>
    </ns2:InicioCancelarInstancia>
};
