...
declare variable $idAgrupador as xs:string external;
    ...
    <ns2:InicioCancelarInstancia>
        <ns2:Header>
            <ns3:Operacion>
                ...
                {
                    if ($InicioCancelarInstanciaRequest/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)
                    then <ns4:ResponsableOperacion>{fn:data($InicioCancelarInstanciaRequest/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</ns4:ResponsableOperacion>
                    else ()
                }
            </ns3:Operacion>
            <ns3:Proceso>
            ...
            <ns8:ParameterType>
                ...
                <ns8:parameterValue>{fn:data($idAgrupador)}</ns8:parameterValue>
            </ns8:ParameterType>
        </ns2:Header>
    </ns2:InicioCancelarInstancia>
};
