    ...
    <ns2:Insert>
        ...
        <ns2:keys>
            <ns2:Key>
             ...
             <ns2:Key>
                <ns2:name>Nombre de Archivo</ns2:name>
                <ns2:value>{fn:data($CargarDocumentoRequest/ns1:Documentos/doc:Documento/doc:filename)}</ns2:value>
            </ns2:Key>
             <ns2:Key>
                <ns2:name>Id Tarea</ns2:name>
                <ns2:value>{fn:data($CargarDocumentoRequest/ns1:Documentos/doc:Documento/doc:idtarea)}</ns2:value>
            </ns2:Key>
             <ns2:Key>
                <ns2:name>Tarea</ns2:name>
                <ns2:value>{fn:data($CargarDocumentoRequest/ns1:Documentos/doc:Documento/doc:tarea)}</ns2:value>
            </ns2:Key>
             <ns2:Key>
                <ns2:name>Id Proceso</ns2:name>
                <ns2:value>{fn:data($CargarDocumentoRequest/ns1:Documentos/doc:Documento/doc:idproceso)}</ns2:value>
            </ns2:Key>
             <ns2:Key>
                <ns2:name>Proceso</ns2:name>
                <ns2:value>{fn:data($CargarDocumentoRequest/ns1:Documentos/doc:Documento/doc:proceso)}</ns2:value>
            </ns2:Key>
            <ns2:Key>
                <ns2:name>Instancia Proceso</ns2:name>
                <ns2:value>{fn:data($CargarDocumentoRequest/ns1:Documentos/doc:Documento/doc:instanciaProceso)}</ns2:value>
            </ns2:Key>
            <ns2:Key>
