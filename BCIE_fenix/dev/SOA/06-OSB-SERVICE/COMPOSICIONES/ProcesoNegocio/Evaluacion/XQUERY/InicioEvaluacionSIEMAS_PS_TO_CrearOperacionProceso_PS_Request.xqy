...
declare function local:func($InicioEvaluacionSIEMAS as element() (:: schema-element(ns1:InicioEvaluacionSIEMAS) ::)) as element() (:: schema-element(ns2:requestCrearOperacionProcesoMessage) ::) {
