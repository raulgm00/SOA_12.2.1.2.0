...
declare function local:func($FinInteresesCobro as element() (:: schema-element(ns1:FinInteresesCobro) ::)) as element() (:: schema-element(ns2:requestCrearEquipoTrabajoMessage) ::) {
    <ns2:requestCrearEquipoTrabajoMessage>
        <ns2:idOperacion>{fn:data($FinInteresesCobro/ns1:Header/ns4:Operacion/ns5:CodigoOperacion)}</ns2:idOperacion>
        <ns2:listadoEquipoTrabajo>
            {
                for $equipoTrabajo in $FinInteresesCobro/ns1:EquipoTrabajo/ns3:equipoTrabajo
                return 
                <ns3:equipoTrabajo>
