...
declare function local:func($InicioEnviarGasto as element() (:: schema-element(ns1:InicioEnviarGasto) ::)) as element() (:: schema-element(ns2:requestValidarOperacionProceso) ::) {
    <ns2:requestValidarOperacionProceso>
        <ns2:ValidarProcesoOperacionInput>
            <val:idOperacion>{fn:data($InicioEnviarGasto/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</val:idOperacion>
