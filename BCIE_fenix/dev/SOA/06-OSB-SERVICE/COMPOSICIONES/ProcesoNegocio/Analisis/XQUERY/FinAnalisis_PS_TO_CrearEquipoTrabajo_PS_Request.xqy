...
declare namespace equ = "http://www.bcie.org/EquipoTrabajoBO";
...
declare function local:func($FinAnalisis as element() (:: schema-element(ns1:FinAnalisis) ::)) as element() (:: schema-element(ns2:requestCrearEquipoTrabajoMessage) ::) {
    <ns2:requestCrearEquipoTrabajoMessage>
        <ns2:idOperacion>{fn:data($FinAnalisis/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</ns2:idOperacion>
        <ns2:listadoEquipoTrabajo>
            {
                for $equipoTrabajo in $FinAnalisis/ns1:equipoTrabajo/ns5:equipoTrabajo
