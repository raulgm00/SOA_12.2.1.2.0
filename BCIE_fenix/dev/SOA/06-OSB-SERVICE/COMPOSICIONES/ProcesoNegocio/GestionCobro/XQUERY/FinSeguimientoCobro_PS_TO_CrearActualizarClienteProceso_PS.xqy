...
declare function local:func($FinSeguimientoCobro as element() (:: schema-element(ns1:FinSeguimientoCobro) ::)) as element() (:: schema-element(ns2:CrearActualizarClienteProcesoRequest) ::) {
