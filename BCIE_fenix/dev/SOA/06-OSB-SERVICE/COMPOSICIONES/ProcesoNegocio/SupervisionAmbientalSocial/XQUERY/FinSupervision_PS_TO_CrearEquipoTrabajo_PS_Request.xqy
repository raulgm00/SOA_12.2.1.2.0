...
declare function local:func($FinSupervision as element() (:: schema-element(ns1:FinSupervision) ::)) as element() (:: schema-element(ns2:requestCrearEquipoTrabajoMessage) ::) {
    <ns2:requestCrearEquipoTrabajoMessage>
        <ns2:idOperacion>{fn:data($FinSupervision/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</ns2:idOperacion>
        <ns2:listadoEquipoTrabajo>
            {
                for $equipoTrabajo in $FinSupervision/ns1:equipoTrabajo/ns5:equipoTrabajo
                return 
                <ns5:equipoTrabajo>
