...
declare variable $FinCierre as element() (:: schema-element(ns1:FinCierre) ::) external;

declare function local:FinCierre($FinCierre as element() (:: schema-element(ns1:FinCierre) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            <cre:idOperacion>{fn:data($FinCierre/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($FinCierre/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            <cre:idProceso>19</cre:idProceso>
            <cre:nombreProceso>PC09</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinCierre/ns1:Header/ns3:Proceso/ns5:InstanciaProceso)}</cre:instanciaProceso>
            ...
            <cre:usuario>{fn:data($FinCierre/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
