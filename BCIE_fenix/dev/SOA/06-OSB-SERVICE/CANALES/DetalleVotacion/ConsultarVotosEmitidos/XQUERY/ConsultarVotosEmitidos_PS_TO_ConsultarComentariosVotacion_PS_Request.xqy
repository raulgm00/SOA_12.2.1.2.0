...
declare function local:func($requestConsultarVotosEmitidosMessage as element() (:: schema-element(ns1:requestConsultarVotosEmitidosMessage) ::)) as element() (:: schema-element(ns2:ConsultarComentariosVotacionRequest) ::) {
    <ns2:ConsultarComentariosVotacionRequest>
