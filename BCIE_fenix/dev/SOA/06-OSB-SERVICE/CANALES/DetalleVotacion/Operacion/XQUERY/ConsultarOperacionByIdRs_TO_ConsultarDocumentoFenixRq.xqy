...
declare function local:func($ConsultarOperacionResponse as element() (:: schema-element(ns1:ConsultarOperacionResponse) ::)) as element() (:: schema-element(ns2:ConsultarDocumentosFenixRequest) ::) {
