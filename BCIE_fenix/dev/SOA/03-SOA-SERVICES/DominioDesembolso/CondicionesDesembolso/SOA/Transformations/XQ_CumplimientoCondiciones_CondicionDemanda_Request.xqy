...
local:funcXq_cumplimientocondiciones_condiciondemanda_request($outInvokeConsultarCondicionByEvento.response, $inputVariable.request, $outInvokeConsultarCondicionByEventoCualquier.response)
