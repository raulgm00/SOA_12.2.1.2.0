            ...
            <con2:Header>
                {if (true()) then 
                        <ns1:Operacion>
                            ...
                            <ns2:idSectorInstitucional>{fn:data($outConsultarProducto.response/pro:Operacion/ope:idSectorInstitucional)}</ns2:idSectorInstitucional>
                            <ns2:idEncargado>{fn:data($outConsultarProducto.response/pro:Operacion/ope:idEncargado)}</ns2:idEncargado>
                            <ns2:idRol>{fn:data($outConsultarProducto.response/pro:Operacion/ope:idRol)}</ns2:idRol>
                            <ns2:descripcionRol>{fn:data($outConsultarProducto.response/pro:Operacion/ope:descripcionRol)}</ns2:descripcionRol>
