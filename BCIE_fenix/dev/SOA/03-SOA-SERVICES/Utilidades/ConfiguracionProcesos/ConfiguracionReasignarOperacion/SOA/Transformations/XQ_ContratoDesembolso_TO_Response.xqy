...
declare function local:funcXq_contratodesembolso_to_response($outSolicitudDesembolso.response as element() (:: schema-element(des:ConsultarSolicitudDesembolsoResponse) ::)) as element() (:: schema-element(con:configuracionReasignarOperacionResponse) ::) {
    <con:configuracionReasignarOperacionResponse>
        <con:configuracionReasignarOperacion>
            <con1:ContratoDesembolso>
            {
              ...
              return
              for $contrato in $solicitud/des1:ContratoDesembolso
              return
               <des1:ContratoDesembolso>{fn:data($contrato/des1:idDesembolso)}</des1:ContratoDesembolso>
            }
            </con1:ContratoDesembolso>
        </con:configuracionReasignarOperacion>
    </con:configuracionReasignarOperacionResponse>
...
local:funcXq_contratodesembolso_to_response($outSolicitudDesembolso.response)
