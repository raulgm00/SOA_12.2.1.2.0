    ...
    <cli:ConsultarClienteResponse>
        {
            ...
            <cli:Cliente>
                ...
                }
                {
                    ...
                    then <cli1:tipoCliente>{fn:data($inputVariable.request/cli:Cliente/cli1:tipoCliente)}</cli1:tipoCliente>
                    else <cli1:tipoCliente>{fn:data($Cliente/cli1:tipoCliente)}</cli1:tipoCliente>
                }
                {
