...
declare function local:funcXqgeneracionarchivosfenixresponse($ListaDocumentosAdjuntos.request as element() (:: schema-element(doc:CargarDocumentoFenixRequest) ::)) as element() (:: schema-element(ges:GenerarArchivosFenixResponse) ::) {
    <ges:GenerarArchivosFenixResponse>
...
local:funcXqgeneracionarchivosfenixresponse($ListaDocumentosAdjuntos.request)
