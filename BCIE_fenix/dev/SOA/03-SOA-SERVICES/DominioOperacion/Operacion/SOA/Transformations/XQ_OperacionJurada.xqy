...
declare function local:funcXq_operacionjurada($InvokeConsultarOperacion_ConsultarOperacionById_OutputVariable.response as element() (:: schema-element(ope:ConsultarOperacionResponse) ::), 
    ...
    <ope:ConsultarOperacionResponse>
        ...
        {if(fn:count($InvokeConsultarOperacion_ConsultarOperacionById_OutputVariable.response[1]) > 0 and fn:count($outConsultarDeclaracionJuradaByIdOperacion.response) > 0)then
          <ope:Resultado>
...
local:funcXq_operacionjurada($InvokeConsultarOperacion_ConsultarOperacionById_OutputVariable.response, $outConsultarDeclaracionJuradaByIdOperacion.response)
