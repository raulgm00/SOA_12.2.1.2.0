...
declare namespace ana="http://xmlns.oracle.com/bpmn/bpmnProcess/AnalisisProcess";
(:: import schema at "oramds:/apps/Resources/BPM/Schema/PC03/AnalisisProcess.xsd" ::)
...
declare function local:funcInicioanalisis_request($OutConsultar.response as element() (:: schema-element(ope:ConsultarOperacionResponse) ::), 
                                                  ...
                                                  as element() (:: schema-element(ana:InicioAnalisis) ::) {
    <ana:InicioAnalisis>
        <ana:Header>
            <ns1:Operacion>
            ...
            <ns1:Tarea>
                ...
                <ns3:NombreProceso>PC03</ns3:NombreProceso>
            </ns1:Tarea>
            {
...
local:funcInicioanalisis_request($OutConsultar.response, $outConsultarParametrosEnBitacora.response)
