...
public class GestorOperacionesBean extends FenixPanelBean implements Serializable {
    ...
    private Boolean mostrarIniciarCumplimientoDeCondicionesPreviaFormalizar;
    ...
    public Boolean getEsMontoTotal() {
        ...
        DCIteratorBinding voCrearOperacion = ADFUtils.getDCBindingContainer().
            ...
            if(voCrearOperacion.getRowAtRangeIndex(0) != null){
                voCrearOperacion.getRowAtRangeIndex(0).setAttribute("MontoTotal",null);    
            }else{
    ...
    public Boolean getEsComponenteDeConsecionalidad() {
        if(esComponenteDeConsecionalidad!=true || esComponenteDeConsecionalidad==false){
        DCIteratorBinding voCrearOperacion = ADFUtils.getDCBindingContainer().
                                            findIteratorBinding("CrearOperacionVOIterator");
            if(voCrearOperacion.getRowAtRangeIndex(0) != null){
                voCrearOperacion.getRowAtRangeIndex(0).setAttribute("ComponenteConcecionalidadReformular",null);
            }else{
                logger.severe("Registro de Operacion no encontrado");
            }
        }
    ...
    public Boolean getEsEstructurador() {
        ...
        DCIteratorBinding voCrearOperacion = ADFUtils.getDCBindingContainer().
                                            findIteratorBinding("CrearOperacionVOIterator");
            if(voCrearOperacion.getRowAtRangeIndex(0) != null){
                voCrearOperacion.getRowAtRangeIndex(0).setAttribute("Estructurador",null);    
            }else{
                logger.severe("Registro de Operacion no encontrado");
            }
        }
    ...
    public Boolean getEsBeneficiario() {
        ...
        DCIteratorBinding voCrearOperacion = ADFUtils.getDCBindingContainer().
                                            findIteratorBinding("CrearOperacionVOIterator");
            if(voCrearOperacion.getRowAtRangeIndex(0) != null){
                voCrearOperacion.getRowAtRangeIndex(0).setAttribute("Beneficiario",null);
            }else{
                logger.severe("Registro de Operacion no encontrado");
            }
        }
    ...
    public Boolean getEsPrograma() {
        ...
        DCIteratorBinding voCrearOperacion = ADFUtils.getDCBindingContainer().
                                            findIteratorBinding("CrearOperacionVOIterator");
            if(voCrearOperacion.getRowAtRangeIndex(0) != null){
                voCrearOperacion.getRowAtRangeIndex(0).setAttribute("Programa",null);
            }else{
                logger.severe("Registro de Operacion no encontrado");
            }
        }
    ...
    public String inicializarConfiguracionByIdProducto(){
        logger.log(ADFLogger.TRACE, "Inside inicializarConfiguracionByIdProducto()");
        ...
        logger.log(ADFLogger.TRACE,"Iniciativa estrategica: " + rowConfigVisibilidad.getIniciativaEstrategica().toString());
        logger.log(ADFLogger.TRACE,"Objetivo estrategico: " + rowConfigVisibilidad.getObjetivoEstrategico().toString());
        ...
        logger.log(ADFLogger.TRACE,"Componente de consecinalidad:" + rowConfigVisibilidad.getComponenteConcesionalidad().toString());
        ...
        logger.log(ADFLogger.TRACE,"Operaciones asociadas:" + rowConfigVisibilidad.getOperacionesAsociadas().toString());
        logger.log(ADFLogger.TRACE,"Responde cuestionario:" + rowConfigVisibilidad.getRespondeCuestionario().toString());
    ...
    public String inicializarConsultarOperacionReformular(){
        ...
        Long idOperacion=Long.valueOf((String)JSFUtils.resolveExpression("#{pageFlowScope.pIdOperacion}"));
        ...
        operationBinding = bindings.getOperationBinding("consultarOperacionReformular");
        ...
        if(operationBinding.getErrors().size() != 0){
            ...
            if(response.getOperacion()!= null){
                ...
                operacion=(org.bcie.operacionbo.Operacion)response.getOperacion().get(0);
                ...
                if("Sector Público" == operacion.getCliente().getSector().getDescripcion() ||
                            true == operacion.getCliente().getSector().getDescripcion().equals("Sector Público")){
    ...
    public String inicializarDetalleOperacion(){
        ...
        ConsultarOperacionByIdOperacionRequestType requestConsultarOperacionById = null;
        ...
        try{
            ...
            operationBinding.getParamsMap().put("idOperacion", this.getIdOperacion().toString());
            operationBinding.execute();
            ...
            operationBinding = bindings.getOperationBinding("setvarIdOperacion1");
            operationBinding.getParamsMap().put("value", this.getIdOperacion());
            operationBinding.execute();
            //Crear row Responsable Operacion
            logger.warning("crearRowResponsable");
            operationBinding = bindings.getOperationBinding("crearRowResponsable");
            operationBinding.execute();
            
            logger.warning("Consulta tipo de monto Aprobado y Formalizado");
            BigDecimal monto = null;
            operationBinding = bindings.getOperationBinding("obtenerMontoPorTipo");
            operationBinding.getParamsMap().put("varIdOperacion", this.getIdOperacion());
            operationBinding.getParamsMap().put("varTipoMonto", Integer.valueOf(3));
            operationBinding.execute();
            ...
            if(monto == null){
                ...
                operationBinding = bindings.getOperationBinding("obtenerMontoPorTipo");
                operationBinding.getParamsMap().put("varIdOperacion", this.getIdOperacion());
                operationBinding.getParamsMap().put("varTipoMonto", Integer.valueOf(5));
                operationBinding.execute();
        ...
        try {
            ...
            logger.log(ADFLogger.WARNING, "Invocando Servicio - Consultar operacion por Id-");
            operacion12BndQSService = this.initOperacionService();
            operacionPort = operacion12BndQSService.getOperacion12BndQSPort();
            
            logger.warning("Se consume para el Id de Operacion: " + this.getIdOperacion().longValue());
            
            requestConsultarOperacionById = new ConsultarOperacionByIdOperacionRequestType();
            requestConsultarOperacionById.setIdOperacion(this.getIdOperacion().longValue());
            
            //Descomentar si se requieren datos del Cliente.
            //requestConsultarOperacionById.setInfoDetalleCliente(Boolean.TRUE);
            
            logger.log(ADFLogger.WARNING,">HNWS"+ writeXMLRequest(requestConsultarOperacionById, requestConsultarOperacionById.getClass()));
            ...
            logger.log(ADFLogger.WARNING,">HNWS"+  writeXMLRequest(consultarOperacionById, consultarOperacionById.getClass()));
            if(result.value().equalsIgnoreCase("OK")){

                List<Operacion> listaOperaciones = consultarOperacionById.getOperacion();
                logger.log(ADFLogger.WARNING, "listaOperaciones.size():" + listaOperaciones.size());
                if(listaOperaciones.size() > 0){
                    Operacion detalleOperacion = listaOperaciones.get(0);
                    String claveProducto = Long.toString(detalleOperacion.getProducto().getIdProducto());
                    ...
                    if(detalleOperacion.getSectorInstitucional() != null)
                        setSectorInstitucional(detalleOperacion.getSectorInstitucional().getDescripcion());
                    if(detalleOperacion.getEncargado() != null)
                        setEncargado(detalleOperacion.getEncargado().getDescripcion());
                    
                    if(detalleOperacion.getEstado() != null){
                        Catalogo estadoCat = detalleOperacion.getEstado();
                        logger.warning("id Estado de operacion : "+estadoCat.getId());
                        logger.warning("descripcion estado de operacion : "+estadoCat.getDescripcion());
                        logger.warning("descripcion corta estado de operacion : "+estadoCat.getDescripcionCorta());
                        setIdEstadoOperacion(estadoCat.getId());
                        logger.warning("idEstadoOperacion:"+getIdEstadoOperacion());
                    }else{
                        logger.severe("estado de operacion es nulo, no se settea valor a idEstadoOperacion");
                    }
                    ...
                    if(producto == 17 || producto == 18 || producto == 19 || producto == 20 || producto == 21){
                    ...
                    logger.warning("MostrarIniciarProcesoFirmaContrato: " + getMostrarIniciarProcesoFirmaContrato());
                    ...
                    logger.warning("MostrarSolicitarFormalizacionParcial: " + getMostrarSolicitarFormalizacionParcial());
                    logger.warning("MostrarIniciarCumplimientoDeCondiciones: " + getMostrarIniciarCumplimientoDeCondiciones());
                    
                    //Validar proceso ImplementacionPCT terminado
                    operationBinding = bindings.getOperationBinding("validarProcesoOperacionTerminado");
                    operationBinding.getParamsMap().put("idProceso", FenixConstants.PROCESO_IMPLEMENTACION_PCT);
                    Integer respuestaProcesoTerminado = (Integer)operationBinding.execute();
                    logger.warning("respuesta validarProcesoOperacionTerminado:"+respuestaProcesoTerminado);
                    if (null != respuestaProcesoTerminado && respuestaProcesoTerminado.equals(new Integer(1))) {
                        setImplementacionPCTFinalizado(Boolean.TRUE);
                    }
                    logger.warning("ImplementacionPCTFinalizado: " + implementacionPCTFinalizado);
                    
                    logger.warning("Sector: " + detalleOperacion.getSectorMercado().getId());
                    setIdSectorMercado(detalleOperacion.getSectorMercado().getId().intValue());
                    ...
                    logger.warning("Estado: " + detalleOperacion.getEstado().getDescripcion());
                    setIdCliente(Long.valueOf(detalleOperacion.getCliente().getIdCliente()).toString());
                    logger.warning("IdCliente: " + Long.valueOf(detalleOperacion.getCliente().getIdCliente()).toString());
                    setPais(detalleOperacion.getCliente().getPais().getDescripcion());
                    logger.warning("Pais: " + detalleOperacion.getCliente().getPais().getDescripcion());
                    ...
                    logger.warning("responsableOperacion: " + detalleOperacion.getResponsable());
                    String loginUsuario = ADFContext.getCurrent().getSecurityContext().getUserName();
                    logger.warning("loginUsuario: " + ADFContext.getCurrent().getSecurityContext().getUserName());
                    ...
                    String[] strAllRoles = ADFContext.getCurrent().getSecurityContext().getUserRoles();
                    
                    logger.warning("Grupos del usuario: "+ ADFContext.getCurrent().getSecurityContext().getUserName());
                    for(String role : strAllRoles) 
                    {
                          logger.warning("Roles : " + role); 
                          if (role.startsWith("FENIX_REPRESENTANTE"))
                          {
                              if(responsableOperacion != null && loginUsuario != null) {
                                  if (responsableOperacion.trim().equalsIgnoreCase(loginUsuario.trim())) {
                        ...
                        if(role.startsWith("FENIX_GERENTE")){
                            ...
                            operBinding = bindingsGerente.getOperationBinding("validarGerenteResponsable");
                    ...
                    logger.warning("EsGerenteResponsable: " + esGerenteResponsable);
                    logger.warning("ResponsableOperacionInicio: " + responsableOperacionInicio);
                    logger.warning("EsEjecutivoPCT: " + esEjecutivoPCT);
                }
            } else {
                logger.log(ADFLogger.WARNING, "No se recuperaron datos del servicio WSDL_OPERACION en su metodo consultarOperacionByIdOperacion");
                isErrorWS = true;
                JSFUtils.addFacesErrorMessage("Error. El servicio ConsultarOperacionById no devuelve informaci\u00F3n de la operaci\u00F3n");
            }
            //Se valida que la operacion este formailzada
            validaOperacionFormalizada();
        }
        catch(Exception e) { 
            logger.log(ADFLogger.ERROR, "Ocurrio un error en la validacion de roles por operacion.", e ); 
            isErrorWS = true;   
            JSFUtils.addFacesErrorMessage("Error al procesar informacion del servicio de ConsultarOperacionById");
        }
        
        if(!isErrorWS){
            try{
                logger.log(ADFLogger.TRACE,"set idOperacion to setpIdOperacionConRegNoCumpDesemExc");
                logger.log(ADFLogger.TRACE,"idOperacion: "+this.getIdOperacion());
                operationBinding = bindings.getOperationBinding("setpIdOperacionConRegNoCumpDesemExc");
                operationBinding.getParamsMap().put("value", Long.parseLong(this.getIdOperacion().toString()));
                operationBinding.execute();
            } catch(Exception e){
                logger.log(ADFLogger.ERROR, e.getClass() + " : ", e);
            }
            ...
            try {
                if (null != getIdOperacion()) {
                    ...
                    logger.log(ADFLogger.WARNING, "Validacion de  los lotes es:" + isLoteImplementacion);
                } else {
                    logger.warning("El id de la operacion es nulo, No se realiza busqueda de lotes.");
                }
            } catch (Exception e) {
                logger.warning("Error en al obtener los lotes para finalizar." + e.getClass() + ".", e);
            }
        ...
        validarEsVisibleCondicionesPreviaValidar();
    ...
    public Boolean getEsUnidadEjecutoraSecPublico() {
        //valida valor = false
        if(esUnidadEjecutoraSecPublico!=true || esUnidadEjecutoraSecPublico==false){
    ...
    public Boolean getEsTipoDeGarantiaSecPublico() {
        //Valida valor = false
        if(esTipoDeGarantiaSecPublico!=true || esTipoDeGarantiaSecPublico==false){
        //Crea instancia del iterador CrearOperacionVOIterator expuesto en  Binding CrearOperacion.jsff
        DCIteratorBinding voCrearOperacion = ADFUtils.getDCBindingContainer().
                                            findIteratorBinding("CrearOperacionVOIterator");
    ...
    public String getTemplate() {
        try{
        Boolean esBpm=Boolean.valueOf((String)JSFUtils.resolveExpression("#{pageFlowScope.esBPM}"));
        if(esBpm){
  ...
  public String inicializarIdOperacion() {
          ...
          Long pIdOperacion = new java.lang.Long(JSFUtils.resolveExpression("#{param.pIdOperacion}")!=null?JSFUtils.resolveExpression("#{param.pIdOperacion}").toString():"0");
          ...
          if(pIdOperacion != null) {
            ...
            ADFContext.getCurrent().getViewScope().put("pIdOperacion", pIdOperacion);
            logger.log(ADFLogger.WARNING, "viewScope.pIdOperacion: " + 
    ...
    public void getPermissions()
    {
        ...
        setNombreUsuario(ADFContext.getCurrent().getSecurityContext().getUserName());
        
        logger.warning("Grupos del usuario: " + getNombreUsuario());
        for(String role : strAllRoles) 
        {
            logger.warning("Roles : " + role); 
            if (role.startsWith("FENIX_REPRESENTANTE") || role.startsWith("FENIX_GERENTE")) 
            {
                if(role.startsWith("FENIX_REPRESENTANTE")){
                ...
                if(!(role.startsWith("FENIX_GERENTE_GERSYP") || role.startsWith("FENIX_GERENTE_GERFIN") ||
                    role.startsWith("FENIX_GERENTE_GERIES") || role.startsWith("FENIX_GERENTE_GERCRED")))
                {
                    setEsGerenteRepresentante(Boolean.TRUE);
                    break;     
                }
                logger.warning("Valor esGerenteRepresentante: " + esGerenteRepresentante);
            }
            ...
            else if(role.startsWith("FENIX_ANALISTA_SUPERVISION_CREDITO"))
            {
                ...
                logger.warning("Valor esAnalistaSupervision: " + esAnalistaSupervision);
            }
            ...
            else if(role.startsWith("FENIX_UNIDAD_ADQUISICIONES"))
            {
                ...
                logger.warning("Valor esOficialAdquisiciones: " + esOficialAdquisiciones);
            }
        ...
        logger.warning("esResponsableOperacionAdquisiciones :"+this.esResponsableOperacionAdquisiciones);
        logger.warning("esGerentePaisAdquisiciones :"+this.esGerentePaisAdquisiciones);
    }
  ...
  private Operacion12BndQSService initOperacionService() {
      ...
      Row row = configuracionVoImpl.getRow(new Key(new Object[]{IWsdlLocation.OPERACION}));
      String wsdl = row == null ? null : (String) row.getAttribute("Valor");
      
      return IWsdlLocation.Service.getInstance(Operacion12BndQSService.class, wsdl);
  }
    ...
    public Boolean getValidarProcesoOperacionTerminado(Integer idProceso) {
        ...
        BindingContainer bindings = getBindings();
        logger.warning("Entra a metodo getValidarProcesoOperacionTerminado paso 1");
        OperationBinding operationBinding = bindings.getOperationBinding("validarProcesoOperacionTerminado");
        operationBinding.getParamsMap().put("idProceso", idProceso);
        logger.warning("Entra a metodo getValidarProcesoOperacionTerminado paso 2");
        ...
        logger.warning("Entra a metodo getValidarProcesoOperacionTerminado paso 3");
    ...
    public void setMostrarIniciarProcesoFirmaContrato(Boolean mostrarIniciarProcesoFirmaContrato) {
    ...
    public void setMostrarSolicitarFormalizacionParcial(Boolean mostrarSolicitarFormalizacionParcial) {
    ...
    public boolean getTieneDesembolso() {
        ...
        operationBinding.getParamsMap().put("idOperacion", Long.toString(getIdOperacion()));
        operationBinding.execute();
        contratosOperacion = ((Boolean) operationBinding.getResult());
        logger.log(ADFLogger.WARNING,"getTieneDesembolso: " + contratosOperacion);
    ...
    public Boolean obtuvoResponsable() {
        ...
        operationBinding.getParamsMap().put("operacion", Long.toString(getIdOperacion()));
        operationBinding.execute();
    ...
    public void visualizarImplementacionPct() {
        ...
        operationBinding = bindings.getOperationBinding("validarProcesoOperacionTerminado");
        operationBinding.getParamsMap().put("idProceso", FenixConstants.PROCESO_FORMALIZACION);
        formalizacionFinalizado = (Integer)operationBinding.execute();
        
        operationBinding = bindings.getOperationBinding("validarProcesoOperacionTerminado");
        operationBinding.getParamsMap().put("idProceso", FenixConstants.PROCESO_APROBACION);
        ...
        if (formalizacionFinalizado != null) {
            if (formalizacionFinalizado.compareTo(1) == 0) {
                ...
                if (getIdProducto().compareTo(FenixConstants.COOPERACION_TECNICA_RECUPERACION_CONTINGENTE) == 0 ||
                    getIdProducto().compareTo(FenixConstants.COOPERACION_TECNICA_NO_REEMBOMSABLE) == 0 ||
                    getIdProducto().compareTo(FenixConstants.COOPERACION_RECURSOS_EXT_FOPROY) == 0 ||
                    getIdProducto().compareTo(FenixConstants.COOPERACION_RECURSOS_EXT_FINAM) == 0 ||
                    getIdProducto().compareTo(FenixConstants.COOPERACION_NO_REEMBOLSABLE_FETS) == 0) {
                    ...
                    logger.warning("El idProducto no corresponde a los solicitados.");
                }
            }    
        }
        ...
        logger.warning("Visualizar implementacion : " + getVisualizarImplementacionPct());
    }
    ...
    public Boolean confirmaFactibilidad() {
        ...
        BindingContainer bindings = getBindings();
        OperationBinding operationBinding = bindings.getOperationBinding("confirmaFactibilidad");
        Boolean result = (Boolean)operationBinding.execute();
    ...
    public void formalizacionTrazabilidad() {
        ...
        BindingContainer bindings = getBindings();
        OperationBinding operationBinding = bindings.getOperationBinding("validarProcesoOperacion");
        ...
        logger.warning("trazabilidadFormalizacion: " + getTrazabilidadFormalizacion());
    }
    
    public void validarFechaFirmaContrato(){
        logger.warning("Dentro de validarFechaFirmaContrato");
        BindingContainer bindings = getBindings();
        OperationBinding operationBinding = bindings.getOperationBinding("validarTcaTipoTerminoFirmaContrato");
        operationBinding.getParamsMap().put("idOperacion", getIdOperacion());
        Boolean respuesta = (Boolean)operationBinding.execute();
        logger.warning("respuesta :"+respuesta);
        setEsValidaFechaFirmaContrato(respuesta);
        logger.warning("esValidaFechaFirmaContrato :"+esValidaFechaFirmaContrato);
    ...
    public void validaOperacionFormalizada() {
        ...
        try{
            ...
            operationBinding = bindings.getOperationBinding("obtenerTcaTerminoFirmaContrato");
            operationBinding.getParamsMap().put("idOperacion", getIdOperacion());
            result = (Boolean) operationBinding.execute();
        ...
        logger.warning("Formalizacion automatica: " + getTccFormalizacionAutomatica());
    }
    ...
    public void setImplementacionPCTFinalizado(boolean implementacionPCTFinalizado) {
        this.implementacionPCTFinalizado = implementacionPCTFinalizado;
    }
    
    public void setMostrarIniciarCumplimientoDeCondiciones(Boolean mostrarIniciarCumplimientoDeCondiciones) {
    ...
    public void setMostrarIniciarCumplimientoDeCondicionesPreviaFormalizar(Boolean mostrarIniciarCumplimientoDeCondicionesPreviaFormalizar) {
        this.mostrarIniciarCumplimientoDeCondicionesPreviaFormalizar =
            mostrarIniciarCumplimientoDeCondicionesPreviaFormalizar;
    }

    public Boolean getMostrarIniciarCumplimientoDeCondicionesPreviaFormalizar() {
        return mostrarIniciarCumplimientoDeCondicionesPreviaFormalizar;
    }
    ...
    public void setVisualizarImplementacionPct(Boolean visualizarImplementacionPct) {
    ...
    public void setTccFormalizacionAutomatica(Boolean tccFormalizacionAutomatica) {
    ...
    public void setTipoProcesoEvaluacionesDescripcion(String tipoProcesoEvaluacionesDescripcion) {
    ...
    public void setMostrarFuncionReasignarResponsable(boolean mostrarFuncionReasignarResponsable) {
    ...
    public void setProcesoAprobacionFinalizado(Boolean procesoAprobacionFinalizado) {
    ...
    public void verificaAprobacion() {
        ...
        logger.warning("Aprobacion finalizado: " + getProcesoAprobacionFinalizado());
    }
    ...
    public void validarEsAprobacionFinalizado() {
        ...
        OperationBinding operationBinding = null;
        try{
            operationBinding = bindings.getOperationBinding("esProcesoFinalizado");
        ...
        if(!getEsAprobacionFinalizado()){
            logger.warning("validacion esProcesoFinalizado en tbi proceso operacion no cumplida");
            logger.warning("validando en vta_trazabilidad_operacion...");
            
            if(procesoAprobacionTerminadoEnTrazabilidad){
                logger.warning("ok Fecha fin de aprobacion encontrada en vta_trazabilidad_operacion");
                setEsAprobacionFinalizado(procesoAprobacionTerminadoEnTrazabilidad);
            }else{
                logger.warning("Fecha fin de aprobacion no encontrada en vta_trazabilidad_operacion");
            }
        }
                   
        logger.warning("estatus validacion esAprobacionFinalizado :"+getEsAprobacionFinalizado());
    ...
    public void validarEsRecuperacionFinalizado() {
        ...
        try{
            ...
            operationBinding = bindings.getOperationBinding("esProcesoClienteFinalizado");
            ...
            operationBinding.getParamsMap().put("idProceso",FenixConstants.PROCESO_UCE);
        ...
        logger.warning("esRecuperacionFinalizado :"+this.getEsRecuperacionFinalizado());
        logger.warning("Fuera validarEsRecuperacionFinalizado");
    }
    
    public void validarEsVisibleCondicionesPreviaValidar() {
        logger.warning("Dentro validarEsVisibleCondicionesPreviaValidar");
        logger.warning("idOperacion :" + this.getIdOperacion());
        ...
        try {
            ...
            logger.log(ADFLogger.WARNING, "getOperationBinding condicionPreviasFormalizarPorValidar con idOperacion: " + idOperacion);
            operationBinding = bindings.getOperationBinding("condicionPreviasFormalizarPorValidar");
            operationBinding.getParamsMap().put("idOperacion", idOperacion);
            logger.log(ADFLogger.WARNING, "Execute condicionPreviasFormalizarPorValidar con idOperacion" + idOperacion);
            result = (Boolean) operationBinding.execute();
            setMostrarIniciarCumplimientoDeCondicionesPreviaFormalizar(result);
        } catch (Exception e) {
            logger.severe("Error en validarEsVisibleCondicionesPreviaValidar :" + e);
        }

        logger.warning("validarEsVisibleCondicionesPreviaValidar :" +
            getMostrarIniciarCumplimientoDeCondicionesPreviaFormalizar());
        logger.warning("Fuera validarEsVisibleCondicionesPreviaValidar");
    }
    ...
    public void setEsGerentePaisAdquisiciones(Boolean esGerentePaisAdquisiciones) {
    ...
    public void setEsResponsableOperacionAdquisiciones(Boolean esResponsableOperacionAdquisiciones) {
    ...
    public void setEsValidaFechaFirmaContrato(Boolean esValidaFechaFirmaContrato) {
