...
public class VerCrearSolicitudDesembolsosBean extends FenixActionBean implements Serializable {
    ...
    public void consultarDatosSolicitud() {
        logger.log(ADFLogger.WARNING, "INTO consultarDatosSolicitud "+this.getIdOperacion());
        ...
        if (this.getIdOperacion() != null) {
            ...
            try {
                final OperationBinding operationBinding = bindings.getOperationBinding("consultarOperacionPorIdOperacion");
        ...
        logger.log(ADFLogger.WARNING, "FIN consultarDatosSolicitud "+this.getIdOperacion());
    }
