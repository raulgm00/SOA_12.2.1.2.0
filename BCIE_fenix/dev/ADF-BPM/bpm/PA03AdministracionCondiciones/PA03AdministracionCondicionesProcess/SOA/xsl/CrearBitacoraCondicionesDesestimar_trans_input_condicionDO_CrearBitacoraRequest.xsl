...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [WED OCT 06 17:03:43 COT 2021].-->
  </oracle-xsl-mapper:schema>
