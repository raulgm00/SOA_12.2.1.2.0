...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [FRI SEP 09 13:00:42 CDT 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:CondicionPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns5:CodigoTarea>72</ns5:CodigoTarea>
          <ns5:NombreTarea>Validar Condiciones Supervisión</ns5:NombreTarea>
          <ns5:CodigoRol>49</ns5:CodigoRol>
          <ns5:NombreRol>Administración de Condiciones</ns5:NombreRol>
          <ns5:CodigoProceso>9</ns5:CodigoProceso>
          <ns5:NombreProceso>Analista Supervisión de Operaciones de Crédito</ns5:NombreProceso>
        </header:Tarea>
        <header:Proceso>
          <ns3:IdProceso>
