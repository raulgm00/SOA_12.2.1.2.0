...
public class SupervisionAmbientalSocialActionBean extends FenixActionBean {

    public static final ADFLogger LOGGER = ADFLogger.createADFLogger(SupervisionAmbientalSocialActionBean.class);
    public static final String BUNDLE = "pa18supervisionambientalsocialght.PA18SupervisionAmbientalSocialGHTBundle";
    ...
    public SupervisionAmbientalSocialActionBean() {
        super();
    }
    public String invocarFinalizarTarea() {
        ...
        SupervisionAmbientalSocialBean supervisionBean =
            (SupervisionAmbientalSocialBean) JSFUtils.resolveExpression("#{pageFlowScope.supervisionAmbientalSocialBean}");
        ...
        switch (codigoTarea) {
        //case FenixConstants.PA18_SUPERVISAR_ASPECTOS_AMBIENTALES_SOCIALES:
        case 238:
            LOGGER.fine("PA18_SUPERVISAR_ASPECTOS_AMBIENTALES_SOCIALES");
            LOGGER.warning("Supervisar aspectos ambientales y sociales de la operación");
            ...
            */
            ...
            break;
        //case FenixConstants.PA18_REVISAR_CONCLUSIONES_RECOMENDACIONES_SUPERVISION:
        case 239:
            LOGGER.fine("PA18_REVISAR_CONCLUSIONES_RECOMENDACIONES_SUPERVISION");
