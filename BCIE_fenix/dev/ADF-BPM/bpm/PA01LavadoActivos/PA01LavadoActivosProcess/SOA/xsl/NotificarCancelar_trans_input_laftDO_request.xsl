...
<xsl:stylesheet version="1.0" xmlns:ns0="http://xmlns.bcie.org/ObjetoProceso/LAFT/Payload/V1"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [TUE MAR 22 17:02:14 CST 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <tns:enviarCorreoElectronicoRequest>
      <tns:CorreoElectronico>
        ...
        <correoBO:id_plantilla>41</correoBO:id_plantilla>
        <correoBO:parametros>
        ...
        <correoBO:parametros>
          ...
          <correoBO:valor>
            <xsl:value-of select="/ns0:LAFTPayload/ns0:Header/header:Tarea/ns2:CodigoProceso"/>
          </correoBO:valor>
        </correoBO:parametros>
      </tns:CorreoElectronico>
    </tns:enviarCorreoElectronicoRequest>
