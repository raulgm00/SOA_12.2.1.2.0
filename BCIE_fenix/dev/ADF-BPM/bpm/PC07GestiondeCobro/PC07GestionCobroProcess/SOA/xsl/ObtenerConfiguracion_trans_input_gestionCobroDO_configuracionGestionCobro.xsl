  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="ConfiguracionGestionCobroRequest"
                                       namespace="http://www.bcie.org/ConfiguracionProcesosMO"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [FRI FEB 03 12:17:34 CST 2017].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <tns:ConfiguracionGestionCobroRequest>
      <tns:idCliente>
      ...
      <xsl:for-each select="/ns0:GestionCobroPayload/ns0:Header/parameter:ParameterType">
        <tns:Parameters>
          <cmnBO:name>
            <xsl:value-of select="/ns0:GestionCobroPayload/ns0:Header/parameter:ParameterType/parameter:parameterName"/>
          </cmnBO:name>
          <cmnBO:value>
            <xsl:value-of select="/ns0:GestionCobroPayload/ns0:Header/parameter:ParameterType/parameter:parameterValue"/>
          </cmnBO:value>
        </tns:Parameters>
      </xsl:for-each>
    </tns:ConfiguracionGestionCobroRequest>
