...
public class DesembolsoBean extends FenixPanelBean implements Serializable {
    ...
    @SuppressWarnings("compatibility:-8431071963563601734")
...
public void precargaReservaFondos(){
    ...
    public void precargarEstadoDesembolso() {
        try{
            logger.warning("Ingreso al metodo precargarEstadoDesembolso");
            ...
            if(this.contrato!=null){
                logger.warning("Contrado diferente de null aplicamos criterio contrato="+this.contrato);
        ...
        logger.warning("Salida al metodo precargarEstadoDesembolso");
    }
}
