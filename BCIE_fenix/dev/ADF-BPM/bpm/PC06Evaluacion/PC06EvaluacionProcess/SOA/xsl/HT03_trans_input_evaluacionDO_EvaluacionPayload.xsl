...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [WED SEP 23 13:51:56 CDT 2015].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:EvaluacionPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns2:CodigoTarea>35</ns2:CodigoTarea>
          <ns2:NombreTarea>Completar Cuestionarios</ns2:NombreTarea>
