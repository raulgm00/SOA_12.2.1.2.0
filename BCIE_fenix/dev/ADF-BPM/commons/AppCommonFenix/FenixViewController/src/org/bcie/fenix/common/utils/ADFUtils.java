...
public class ADFUtils
{
    ...
    public static String getStringFromBundle(String psKey, String psBundleName)
    {
        String txt = null;
        try
        {
            ResourceBundle resourceBundle = BundleFactory.getBundle(psBundleName);
     ...
     * @param parentVO
     * @param childAccessorName
     * @return
     * @see example in http://dailydevfixes.blogspot.mx/2011/07/setting-bind-parameters-on-hierarchy-of.html
     */
