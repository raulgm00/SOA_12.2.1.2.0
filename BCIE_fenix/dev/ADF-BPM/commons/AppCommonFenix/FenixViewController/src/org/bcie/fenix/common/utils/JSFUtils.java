...
public class JSFUtils
{
     ...
     * @param msg error message string
     */
    public static void addUIXFacesErrorMessage(String msg, UIXComponentBase uixComponent)
    {
        FacesContext ctx = getFacesContext();
        FacesMessage fm = new FacesMessage(FacesMessage.SEVERITY_ERROR, msg, "");
        ctx.addMessage(uixComponent.getClientId(ctx), fm);
    }
    ...
    public static void showPopup(String popupId)
    {
        ...
        if (popupId != null)
        {
            ExtendedRenderKitService erkService =
                Service.getService(getFacesContext().getRenderKit(), ExtendedRenderKitService.class);
