...
public class FenixConstants {
    ...
    public static final Integer LINEA_PARA_APOYAR_LA_GESTIÓN_DE_LIQUIDEZ_DE_LOS_BANCOS_CENTRALES_DE_LOS_PAISES_FUNDADORES_DEL_BCIE = 4;
    public static final Integer LINEA_DE_CREDITO_PARA_ENTIDADES_PUBLICAS_DESCENTRALIZADAS = 5;
    public static final Integer AMPLIACIÓN_DE_LINEA_GLOBAL_DE_CREDITO_A_IFI =26;
