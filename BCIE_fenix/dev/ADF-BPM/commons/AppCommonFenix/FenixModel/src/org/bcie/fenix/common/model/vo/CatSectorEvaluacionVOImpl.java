...
import org.bcie.fenix.common.model.vo.common.CatSectorEvaluacionVO;


// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Tue Sep 28 19:46:08 CDT 2021
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class CatSectorEvaluacionVOImpl extends ViewObjectImpl implements CatSectorEvaluacionVO {
    /**
     * This is the default constructor (do not remove).
     */
    private static ADFLogger logger = null;
    public CatSectorEvaluacionVOImpl() {
    ...
    public Map <Integer, String> generarMapaSector(){
        ...
        //Validar que existen datos en la ejecucuón de View Object
                    if (this.getEstimatedRowCount() > 0) {
                        ...
                        //imprimirMapa(map,"Línea de Contingencia para Banco Central");
                    } else {
    ...
    public Map<Integer, String> desempaquetarColeccion(RowSetIterator iter) {
        ...
        while (iter.hasNext()) {
            Row r = iter.next();
            //imprimirRow(r);
            mapa.put(Integer.parseInt( r.getAttribute("CodigoSectorIbcie").toString() ) , r.getAttribute("Descripcion").toString());
        }
        return mapa;
    }
