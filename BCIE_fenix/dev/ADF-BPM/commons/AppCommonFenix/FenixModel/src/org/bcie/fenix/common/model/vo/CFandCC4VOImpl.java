...
// ---------------------------------------------------------------------
public class CFandCC4VOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public CFandCC4VOImpl() {
    }
    ...
    public Row llenarCFandCC4(String idContratoDesembolso) {
        //--- llenar nuevo VOs
        Row row = null;
        System.out.println("***obteniendo buscarCFandCC4 *****");
        setNamedWhereClauseParam("ID_CONTRATO_DESEMBOLSO", idContratoDesembolso);
        executeQuery();
        System.out.println("voCFandCC4.getEstimatedRowCount(): " + getEstimatedRowCount());
        ...
        while (rowiter.hasNext()) {
            CFandCC4VORowImpl rowCFandCC4VO = (CFandCC4VORowImpl) rowiter.next();
            row = rowCFandCC4VO;
        }
        ...
        if (row != null) {
            ...
            try {
                ...
                System.out.println("rowCFandCC4VO sin registros" + e);
            }

            System.out.println("Se encontro Registro de CFandCC4VORowImpl. idCalendario: " + idCalendario);
        }
        //---------------------
        return row;
    }
