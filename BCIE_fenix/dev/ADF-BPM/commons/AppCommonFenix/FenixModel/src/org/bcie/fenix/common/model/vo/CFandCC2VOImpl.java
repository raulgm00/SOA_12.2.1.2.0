...
// ---------------------------------------------------------------------
public class CFandCC2VOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public CFandCC2VOImpl() {
    }
    ...
    public Row llenarCFandCC2(String idContratoDesembolso) {
        //--- llenar nuevo VOs
        Row row = null;
        System.out.println("***obteniendo llenar CFandCC2VO *****");
        setNamedWhereClauseParam("ID_CONTRATO_DESEMBOLSO", idContratoDesembolso);
        executeQuery();
        System.out.println("voCFandCC2.getEstimatedRowCount(): " + getEstimatedRowCount());
        ...
        while (rowiter.hasNext()) {
            CFandCC2VORowImpl rowCFandCC2VO = (CFandCC2VORowImpl) rowiter.next();
            row = rowCFandCC2VO;
        }
        ...
        if (row != null) {
            ...
            try {
                ...
                System.out.println("rowCFandCC2VO sin registros" + e);
            }

            System.out.println("Se encontro Registro de CFandCC2VORowImpl. idCalendario: " + idCalendario);
        }
        //---------------------
        return row;
    }
