    ...
    public void consultarLineaCreditoByIdWS(Long idLineaCredito, String tipoMoneda) {
        ...
        try {
            ...
            if (response.getLineaCredito() != null) {
                ...
                row.setAttribute(DatosLineaCreditoVORowImpl.NUMEROLINEACREDITO, response.getLineaCredito().getNumeroLineaCredito());
                ...
                row.setAttribute(DatosLineaCreditoVORowImpl.FECHAVENCIMIENTO, this.convertXmlGregorianCalendarToTimestamp(response.getLineaCredito().getFechaVencimiento()));
                    ...
                    for (MontoType montos : lista) {
                        ...
                        if (montos.getTipo() != null) {
                            ...
                            if (TIPO_DISPONIBLE.equals(montos.getTipo().getDescripcionCorta())) {
                                ...
                                logger.log(ADFLogger.WARNING, "No se encontraron coincidencias con el tipo de monto " + montos.getTipo().getDescripcionCorta());
                            }
                        } else {
