...
public class SolicitudDesembolsoVOImpl extends ViewObjectImpl implements SolicitudDesembolsoVO {
    ...
    public Boolean requiereValidacionAsignacionSolicitud(Long idSolicitud, Long idOperacion){
        logger.warning("Inicia metodo requiereValidacionAsignacionSolicitud idSolicitud:"+idSolicitud+" - idOperacion:"+idOperacion);
        ...
        logger.warning("Termina metodo requiereValidacionAsignacionSolicitud idOperacion:"+idOperacion);
