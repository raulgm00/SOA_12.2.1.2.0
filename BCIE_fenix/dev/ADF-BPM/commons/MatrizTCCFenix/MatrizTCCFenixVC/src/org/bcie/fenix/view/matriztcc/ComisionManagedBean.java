...
public class ComisionManagedBean implements Serializable{
     ...
     */
    public static final ADFLogger LOGGER = ADFLogger.createADFLogger(ComisionManagedBean.class);
