...
declare function local:funcConsultarcondicionesbyevento_to_consultarcumplimientoscondiciones_request($outInvokeConsultarCondicionByEvento.response as element() (:: schema-element(con:ConsultarCondicionByIdEventoResponse) ::)) as element() (:: schema-element(des:ConsultarCumplimientoCondicionesRequest) ::) {
    <des:ConsultarCumplimientoCondicionesRequest>
      {
      for $condicion in $outInvokeConsultarCondicionByEvento.response/con:Condicion
      return
        <des:Condicion>
...
local:funcConsultarcondicionesbyevento_to_consultarcumplimientoscondiciones_request($outInvokeConsultarCondicionByEvento.response)
