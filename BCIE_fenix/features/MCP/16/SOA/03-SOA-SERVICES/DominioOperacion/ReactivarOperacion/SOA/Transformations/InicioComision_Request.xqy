...
declare function local:funcIniciocomision_request($inputVariable.request as element() (:: schema-element(ope:ReactivarOperacionRequest) ::), 
                                                  ...
                                                  as element() (:: schema-element(com:InicioComisiones) ::) {
    <com:InicioComisiones>
        <com:Header>
            <ns1:Operacion>
            ...
            <ns1:Tarea>
                ...
                <ns3:NombreProceso>PA02</ns3:NombreProceso>
            </ns1:Tarea>
            {
...
local:funcIniciocomision_request($inputVariable.request, $OutConsultar.response, $outConsultarParametrosEnBitacora.response)
