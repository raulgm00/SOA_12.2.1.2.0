...
declare function local:funcEnviarcorreoelectronico_to_consultaratributosusuarioto($inputVariable.EnviarCorreoElectronicoRequest as element() (:: schema-element(cor:EnviarCorreoElectronicoBPELRequest) ::)) as element() (:: schema-element(usu:ConsultarAtributosUsuarioRequest) ::) {
...
local:funcEnviarcorreoelectronico_to_consultaratributosusuarioto($inputVariable.EnviarCorreoElectronicoRequest)
