    ...
    <ns2:ConsultarLineaCreditoByIdOperacionResponse>
      ...
      return
        <ns2:LineasCredito>
            ...
            <lin:DescripcionCortaMoneda>{fn:data($lineaCredito/ns1:DESCRIPCION_CORTA)}</lin:DescripcionCortaMoneda>
            <lin:DescripcionMoneda>{fn:data($lineaCredito/ns1:DESCRIPCION)}</lin:DescripcionMoneda>
