...
declare namespace ns2="http://xmlns.oracle.com/pcbpel/adapter/db/sp/ConsultarValoresdeAtributosCondicion";
...
$ConsultarCondicionByRolRequest as element() (:: schema-element(ns3:ConsultarCondicionByRolRequest) ::)) as element() (:: schema-element(ns2:InputParameters) ::) {
    <ns2:InputParameters>
