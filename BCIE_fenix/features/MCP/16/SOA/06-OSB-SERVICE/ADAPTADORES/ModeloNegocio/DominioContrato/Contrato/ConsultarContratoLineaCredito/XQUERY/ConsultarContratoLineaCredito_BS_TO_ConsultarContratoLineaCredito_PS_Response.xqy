...
declare function local:func($responselineacredito as element() (:: schema-element(ns1:CosultarLineaCreditoOutputCollection) ::), 
    ...
    <ns6:ConsultarLineaCreditoResponse>
        <ns6:clienteContrato>
            <con:idContrato>{fn:data($responseContrato/ns4:ConsultarContratoOutput/ns4:ID)}</con:idContrato>
            <con:idOperacion>{fn:data($responseContrato/ns4:ConsultarContratoOutput/ns4:ID_OPERACION)}</con:idOperacion>
            <con:fechaFirma>{ if ( fn:data($responseContrato/ns4:ConsultarContratoOutput/ns4:REQUIERE_FIRMA_CONTRATO)=0 and string($responseContrato/ns4:ConsultarContratoOutput/ns4:FECHA_FIRMA)='')
            then
           fn:data($ConsultarAprobacionByOperacionOutputCollection/ns21:ConsultarAprobacionByOperacionOutput/ns21:FECHA_APROBACION)
            else
            fn:data($responseContrato/ns4:ConsultarContratoOutput/ns4:FECHA_FIRMA)
           
            }</con:fechaFirma>
            <con:fechaVigencia>{fn:data($responseContrato/ns4:ConsultarContratoOutput/ns4:FECHA_VIGENCIA)}</con:fechaVigencia>
            <con:MontoEscriturado>{ if ( fn:data($responseContrato/ns4:ConsultarContratoOutput/ns4:REQUIERE_FIRMA_CONTRATO)=0 and string($responseContrato/ns4:ConsultarContratoOutput/ns4:MONTO)='')
           then
           fn:data($ConsultarAprobacionByOperacionOutputCollection/ns21:ConsultarAprobacionByOperacionOutput/ns21:MONTO)
           else
            fn:data($responseContrato/ns4:ConsultarContratoOutput/ns4:MONTO)
            ...
            <con:instanciaProceso>{fn:data($responseContrato/ns4:ConsultarContratoOutput/ns4:INSTANCIA_PROCESO)}</con:instanciaProceso>
            {
                ...
                <con:LineaCredito>
                   ...
                   <lin:frecuenciaGracia>
                    {
                        ...
                        and fn:data($ConsultarTcaTerminoOutput/ns5:ID_TCA_ESTADO_TCC)=9
                        return
                   ...
                   if ( string($ConsultarTcaTerminoOutput/ns5:DESCRIPCION_CORTA_TCA)='T106' )then
             ...
             <lin:montoMinimo>{ fn:data($ConsultarTcaTerminoOutput/ns5:MONTO_MINIMO_DESEMBOLSO)}</lin:montoMinimo>
               ...
               <lin:montoMaximo> {fn:data($ConsultarTcaTerminoOutput/ns5:MONTO_MAXIMO_DESEMBOLSO) }</lin:montoMaximo>
                   ...
                   
                    {
						...
						and fn:data($ConsultarTcaTerminoOutput/ns5:ID_TCA_ESTADO_TCC)=7
        ...
        <ns6:Resultado>
            ...
            {if (string($responseContrato/ns4:ConsultarContratoOutput/ns4:ID)='')then
...
local:func($responselineacredito, $reponseComision, $responseCuentas, $responseContrato, $reponseTermino, $ConsultarAprobacionByOperacionOutputCollection)