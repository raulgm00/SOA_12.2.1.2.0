...
declare function local:func($requestCrearBitacoraProcesoClienteMessage as element() (:: schema-element(ns1:requestCrearBitacoraProcesoClienteMessage) ::)) as element() (:: schema-element(ns2:TbiProcesoClienteCollection) ::) {
    <ns2:TbiProcesoClienteCollection>
        <ns2:TbiProcesoCliente>
            ...
            <ns2:nombreUsuario>{fn:data($requestCrearBitacoraProcesoClienteMessage/ns1:BitacoraInput/cre:nombreUsuario)}</ns2:nombreUsuario>
...
local:func($requestCrearBitacoraProcesoClienteMessage)
