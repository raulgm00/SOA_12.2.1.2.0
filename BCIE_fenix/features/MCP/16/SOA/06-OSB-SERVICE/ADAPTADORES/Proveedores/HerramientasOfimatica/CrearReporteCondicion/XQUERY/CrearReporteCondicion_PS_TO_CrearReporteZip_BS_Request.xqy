...
declare variable $reporteCondicionXml as element() external;
...
declare function local:func($reporteCondicionXml as element(), 
    ...
    <ns2:generarReporte>
        ...
        <contenidoXML>{fn-bea:serialize($reporteCondicionXml)}</contenidoXML>
        {
            let $formato := "pdf"
            return 
...
local:func($reporteCondicionXml, $plantilla, $configuracion)
