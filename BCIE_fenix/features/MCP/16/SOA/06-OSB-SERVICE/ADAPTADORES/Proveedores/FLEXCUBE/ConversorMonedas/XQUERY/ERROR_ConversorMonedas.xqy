...
declare variable $responseMapeoErrorMessage as element() (:: schema-element(ns1:ConversorMonedasResponse) ::)  external;
...
declare function local:func($message as xs:normalizedString, 
                            ...
                            as element() (:: schema-element(ns1:ConversorMonedasResponse) ::) {
