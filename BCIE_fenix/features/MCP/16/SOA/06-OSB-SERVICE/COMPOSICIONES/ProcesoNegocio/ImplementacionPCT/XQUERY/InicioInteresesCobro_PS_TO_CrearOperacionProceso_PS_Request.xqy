...
declare function local:func($InicioInteresesCobro as element() (:: schema-element(ns1:InicioInteresesCobro) ::)) as element() (:: schema-element(ns2:requestCrearOperacionProcesoMessage) ::) {
