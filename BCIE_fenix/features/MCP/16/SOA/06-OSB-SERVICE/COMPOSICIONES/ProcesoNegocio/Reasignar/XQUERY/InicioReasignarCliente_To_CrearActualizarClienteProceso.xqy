...
declare function local:func($InicioReasignacionRC as element() (:: schema-element(ns1:InicioReasignacionRC) ::)) as element() (:: schema-element(ns2:CrearActualizarClienteProcesoRequest) ::) {
