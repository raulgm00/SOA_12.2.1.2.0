...
declare function local:func($InicioPreparacion as element() (:: schema-element(ns1:InicioPreparacion) ::)) as element() (:: schema-element(ns2:requestCrearOperacionProcesoMessage) ::) {
