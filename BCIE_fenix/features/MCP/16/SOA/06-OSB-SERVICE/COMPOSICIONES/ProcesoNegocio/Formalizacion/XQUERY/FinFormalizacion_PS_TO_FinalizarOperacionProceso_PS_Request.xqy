...
declare function local:func($FinFormalizacion as element() (:: schema-element(ns1:FinFormalizacion) ::)) as element() (:: schema-element(ns2:requestFinalizarOperacionProcesoMessage) ::) {
    <ns2:requestFinalizarOperacionProcesoMessage>
        <ns2:BitacoraInput>
            <fin:idOperacion>{fn:data($FinFormalizacion/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</fin:idOperacion>
