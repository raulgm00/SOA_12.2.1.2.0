...
declare function local:func($InicioEvaluacionIBCIE as element() (:: schema-element(ns1:InicioEvaluacionIBCIE) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            ...
            <cre:nombreOperacion>{fn:data($InicioEvaluacionIBCIE/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            ...
            <cre:usuario>{fn:data($InicioEvaluacionIBCIE/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
            ...
            {if(fn:count($InicioEvaluacionIBCIE/ns1:Header/ns5:ParameterType) > 0)then
              <cre:string01>{fn:concat($InicioEvaluacionIBCIE/ns1:Header/ns5:ParameterType[1]/ns5:parameterName,'-',$InicioEvaluacionIBCIE/ns1:Header/ns5:ParameterType[1]/ns5:parameterValue)}</cre:string01>
            else()
            }
            {if(fn:count($InicioEvaluacionIBCIE/ns1:Header/ns5:ParameterType) > 1)then
              <cre:string02>{fn:concat($InicioEvaluacionIBCIE/ns1:Header/ns5:ParameterType[2]/ns5:parameterName,'-',$InicioEvaluacionIBCIE/ns1:Header/ns5:ParameterType[2]/ns5:parameterValue)}</cre:string02>
            else()
            }
            {if(fn:count($InicioEvaluacionIBCIE/ns1:Header/ns5:ParameterType) > 2)then
              <cre:string03>{fn:concat($InicioEvaluacionIBCIE/ns1:Header/ns5:ParameterType[3]/ns5:parameterName,'-',$InicioEvaluacionIBCIE/ns1:Header/ns5:ParameterType[3]/ns5:parameterValue)}</cre:string03>
            else()
            }
        </ns2:BitacoraInput>
    </ns2:requestCrearBitacoraProcesoMessage>
