...
declare function local:func($ConsultarClienteResponse as element() (:: schema-element(ns1:ConsultarClienteResponse) ::),
              $idOperacion as xs:long) as element() (:: schema-element(ns1:ActualizarClienteRequest) ::) {
    <ns1:ActualizarClienteRequest>
        <ns1:Cliente>
            ...
            {
                if ($ConsultarClienteResponse/ns1:Cliente/cli:tipoPersona)
                then 
                    <cli:tipoPersona>
                        {
            ...
            <cli:tipoCliente>2</cli:tipoCliente>
            {
                if ($ConsultarClienteResponse/ns1:Cliente/cli:sector)
                then 
                    <cli:sector>
                        {
            ...
            {
                if ($ConsultarClienteResponse/ns1:Cliente/cli:tipoInstitucion)
                then 
                    <cli:tipoInstitucion>
                        {
            ...
            {
                if ($ConsultarClienteResponse/ns1:Cliente/cli:pais)
                then 
                    <cli:pais>
                        {
            ...
            {
                if ($ConsultarClienteResponse/ns1:Cliente/cli:grupoEconomico)
                then 
                    <cli:grupoEconomico>
                        {
            ...
            {
                if ($ConsultarClienteResponse/ns1:Cliente/cli:oficina)
                then 
                    <cli:oficina>
                        {
            ...
            {
                for $Contactos in $ConsultarClienteResponse/ns1:Cliente/cli:Contactos
                return 
                <cli:Contactos>
                    {
