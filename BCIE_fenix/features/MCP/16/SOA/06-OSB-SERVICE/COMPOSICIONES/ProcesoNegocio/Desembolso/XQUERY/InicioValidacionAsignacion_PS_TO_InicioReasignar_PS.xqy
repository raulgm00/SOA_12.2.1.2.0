...
declare variable $request as element() (:: schema-element(ns1:InicioValidacionAsignacion) ::) external;

declare function local:func($request as element() (:: schema-element(ns1:InicioValidacionAsignacion) ::)) as element() (:: schema-element(ns1:InicioReasignarRO) ::) {
