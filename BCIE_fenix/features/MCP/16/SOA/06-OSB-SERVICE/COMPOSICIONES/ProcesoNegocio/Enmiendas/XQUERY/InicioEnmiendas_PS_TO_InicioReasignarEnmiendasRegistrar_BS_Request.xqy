...
declare function local:func($InicioEnmiendas as element() (:: schema-element(ns1:InicioEnmiendas) ::),  $CrearEnmiendaTCCResponse as element() (:: schema-element(ns11:CrearEnmiendaTCCResponse) ::)) as element() (:: schema-element(ns1:InicioReasignarEnmiendasRegistrar) ::) {
    <ns1:InicioReasignarEnmiendasRegistrar>
        <ns1:Header>
            <ns2:Operacion>
