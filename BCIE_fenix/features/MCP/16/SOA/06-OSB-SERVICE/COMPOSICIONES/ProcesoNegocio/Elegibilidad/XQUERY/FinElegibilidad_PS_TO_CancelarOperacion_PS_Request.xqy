...
declare namespace ns2="http://xmlns.oracle.com/bpmn/bpmnProcess/CancelarOperacionProcess";
...
declare function local:func($FinElegibilidad as element() (:: schema-element(ns1:FinElegibilidad) ::)) as element() (:: schema-element(ns2:InicioCancelarOperacion) ::) {
    <ns2:InicioCancelarOperacion>
        <ns2:Header>
            <ns3:Operacion>
            ...
            <ns3:Tarea>
                ...
                {
                    if ($FinElegibilidad/ns1:Header/ns3:Tarea/ns5:CodigoProceso)
                    then <ns5:CodigoProceso>{fn:data($FinElegibilidad/ns1:Header/ns3:Tarea/ns5:CodigoProceso)}</ns5:CodigoProceso>
                    else ()
                }
                {
                    if ($FinElegibilidad/ns1:Header/ns3:Tarea/ns5:NombreProceso)
                    then <ns5:NombreProceso>{fn:data($FinElegibilidad/ns1:Header/ns3:Tarea/ns5:NombreProceso)}</ns5:NombreProceso>
                    else ()
                }
            </ns3:Tarea>
            <ns6:ParameterType>
