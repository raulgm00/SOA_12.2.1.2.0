...
declare function local:func($InicioSeguimientoCobro as element() (:: schema-element(ns1:InicioSeguimientoCobro) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoClienteMessage) ::) {
    <ns2:requestCrearBitacoraProcesoClienteMessage>
        <ns2:BitacoraInput>
            ...
            <cre:razonSocial>{fn:data($InicioSeguimientoCobro/ns1:Header/ns3:Cliente/ns4:RazonSocial)}</cre:razonSocial>
            ...
            <cre:usuario>{fn:data($InicioSeguimientoCobro/ns1:Header/ns3:Cliente/ns4:ResponsableCliente)}</cre:usuario>
            ...
            <cre:scr></cre:scr>
            {if(fn:count($InicioSeguimientoCobro/ns1:Header/ns5:ParameterType) > 0)then
            <cre:string01>{fn:concat($InicioSeguimientoCobro/ns1:Header/ns5:ParameterType[1]/ns5:parameterName,'-',$InicioSeguimientoCobro/ns1:Header/ns5:ParameterType[1]/ns5:parameterValue)}</cre:string01>
            else()
            }
            {if(fn:count($InicioSeguimientoCobro/ns1:Header/ns5:ParameterType) > 1)then
            <cre:string02>{fn:concat($InicioSeguimientoCobro/ns1:Header/ns5:ParameterType[2]/ns5:parameterName,'-',$InicioSeguimientoCobro/ns1:Header/ns5:ParameterType[2]/ns5:parameterValue)}</cre:string02>
            else()
            }
            {if(fn:count($InicioSeguimientoCobro/ns1:Header/ns5:ParameterType) > 2)then
            <cre:string03>{fn:concat($InicioSeguimientoCobro/ns1:Header/ns5:ParameterType[3]/ns5:parameterName,'-',$InicioSeguimientoCobro/ns1:Header/ns5:ParameterType[3]/ns5:parameterValue)}</cre:string03>
            else()
            }
