...
declare function local:func($FinEvaluacion as element() (:: schema-element(ns1:FinEvaluacion) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            <cre:idOperacion>{fn:data($FinEvaluacion/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($FinEvaluacion/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            <cre:idProceso>6</cre:idProceso>
            <cre:nombreProceso>PA10</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinEvaluacion/ns1:Header/ns3:Proceso/ns6:InstanciaProceso)}</cre:instanciaProceso>
            ...
            <cre:usuario>{fn:data($FinEvaluacion/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
