...
declare function local:func($InicioEnviarGasto as element() (:: schema-element(ns1:InicioEnviarGasto) ::)) as element() (:: schema-element(ns2:requestCrearOperacionProcesoMessage) ::) {
