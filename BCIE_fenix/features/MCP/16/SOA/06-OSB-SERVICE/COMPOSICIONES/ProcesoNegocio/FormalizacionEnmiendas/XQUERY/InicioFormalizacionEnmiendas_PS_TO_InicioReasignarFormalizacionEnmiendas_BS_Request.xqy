...
declare function local:func($InicioFormalizacionEnmiendas as element() (:: schema-element(ns1:InicioFormalizacionEnmiendas) ::),  $CrearEnmiendaTCCResponse as element() (:: schema-element(ns11:CrearEnmiendaTCCResponse) ::)) as element() (:: schema-element(ns1:InicioReasignarFormalizacionEnmiendas) ::) {
    <ns1:InicioReasignarFormalizacionEnmiendas>
        <ns1:Header>
            <ns2:Operacion>
