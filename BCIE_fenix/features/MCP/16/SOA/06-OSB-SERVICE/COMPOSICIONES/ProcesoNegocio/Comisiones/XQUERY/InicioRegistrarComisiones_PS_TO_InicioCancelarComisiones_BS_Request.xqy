...
declare function local:func($InicioComisiones as element() (:: schema-element(ns1:InicioRegistrarComisiones) ::)) as element() (:: schema-element(ns1:InicioCancelarComisiones) ::) {
