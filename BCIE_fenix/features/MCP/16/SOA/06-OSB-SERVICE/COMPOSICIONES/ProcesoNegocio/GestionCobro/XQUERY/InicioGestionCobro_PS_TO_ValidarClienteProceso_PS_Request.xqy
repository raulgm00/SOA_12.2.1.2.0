...
declare function local:func($InicioGestionCobro as element() (:: schema-element(ns1:InicioGestionCobro) ::)) as element() (:: schema-element(ns2:ValidarClienteProcesoRequest) ::) {
    <ns2:ValidarClienteProcesoRequest>
        <ns2:ClienteProceso>
            <val:idCliente>{fn:data($InicioGestionCobro/ns1:Header/ns3:Cliente/ns4:IdCliente)}</val:idCliente>
            <val:idProceso>18</val:idProceso>
        </ns2:ClienteProceso>
    </ns2:ValidarClienteProcesoRequest>
};
