...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [SAT DEC 12 13:05:50 CST 2015].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <tns:FinAnalisis>
      <tns:Header>
        ...
        <parameter:ParameterType>
          <parameter:parameterName>RESPONSABLE_AREA_TECNICA</parameter:parameterName>
