...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
    ...
    <oracle-xsl-mapper:schema>
        ...
        <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [THU SEP 24 00:06:15 CDT 2015].-->
    </oracle-xsl-mapper:schema>
    ...
    <xsl:template match="/">
        <ns0:ElegibilidadPayload>
            <ns0:Header>
                ...
                <header:Tarea>
                    <ns2:CodigoTarea>1</ns2:CodigoTarea>
                    <ns2:NombreTarea>Completar Cuestionario de Elegibilidad</ns2:NombreTarea>
