...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [SAT JAN 16 17:51:50 CST 2016].-->
  </oracle-xsl-mapper:schema>
    ...
    <tns:task>
      <tns:systemMessageAttributes>
        <tns:protectedTextAttribute1>
          <xsl:value-of select="string (/ns0:AprobacionPayload/ns0:Header/header:Operacion/ns2:CodigoOperacion )"/>
        </tns:protectedTextAttribute1>
      </tns:systemMessageAttributes>
    </tns:task>
  </xsl:template>
