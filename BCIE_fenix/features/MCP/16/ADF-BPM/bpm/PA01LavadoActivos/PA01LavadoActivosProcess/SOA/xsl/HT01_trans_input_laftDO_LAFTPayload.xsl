...
<xsl:stylesheet version="1.0" xmlns:ns0="http://xmlns.bcie.org/ObjetoProceso/LAFT/Payload/V1"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [FRI SEP 18 10:37:42 CDT 2015].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:LAFTPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns2:CodigoTarea>39</ns2:CodigoTarea>
          <ns2:NombreTarea>Realizar LAFT</ns2:NombreTarea>
        ...
        <header:Proceso>
          ...
          <ns4:IdFlujo>
            <xsl:value-of select="/ns0:LAFTPayload/ns0:Header/header:Proceso/ns4:IdFlujo"/>
          </ns4:IdFlujo>
        </header:Proceso>
