...
// ---------------------------------------------------------------------
public class CFandCC3VOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public CFandCC3VOImpl() {
    }
    ...
    public Row llenarCFandCC3(String idContratoDesembolso) {
            //--- llenar nuevo VOs
            Row row = null;
            System.out.println("***obteniendo llenar CFandCC3VO *****");
            setNamedWhereClauseParam("ID_CONTRATO_DESEMBOLSO", idContratoDesembolso);
            executeQuery();
            System.out.println("voCFandCC3.getEstimatedRowCount(): "+getEstimatedRowCount());
            ...
            while (rowiter.hasNext()) {
                CFandCC3VORowImpl rowCFandCC3VO =
                (CFandCC3VORowImpl) rowiter.next();
                row = rowCFandCC3VO;
           }
           rowiter.closeRowSetIterator();
            if (row != null) {
                ...
                try {
                    ...
                    System.out.println("rowCFandCC3VO sin registros"+e);
                }

                System.out.println("Se encontro Registro de CFandCC3VORowImpl. idCalendario: " + idCalendario);
            }
           //---------------------
        return row;
        }
