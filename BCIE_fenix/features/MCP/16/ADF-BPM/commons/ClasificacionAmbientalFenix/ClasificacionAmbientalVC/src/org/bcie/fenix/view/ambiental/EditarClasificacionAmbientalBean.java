...
public class EditarClasificacionAmbientalBean {
    ...
    public void crearComponentes() {
        ...
        logger.warning("\n= Recuperar ClasificacionAmbientalEditableVOIterator de bindings =");
        ...
        while (rsi.hasNext()) {
            ...
            if(row.getAttribute("IdClasificacion") != null){//Si recupera valores
                logger.warning("\n=== IdClasificacion: " + row.getAttribute("IdClasificacion").toString());
                ...
                if (editable) {
                    if(componente.getIdSector().matches("0")){
                        logger.warning("\n=== La operacion no tiene CA. Crear formulario incial ===" + indice);
                    ...
                    crearComponenteNoEditable(componente, indice);
                ...
                logger.warning("\n=== Sin Clasificacion Ambiental ==== "); 
                if (editable) {
                    logger.warning("\n===  crearComponenteInicial: " + indice);
                    crearComponente(indice);

                } else {
                    logger.warning("\n=== crearComponenteNoEditable vacio: ");
    ...
    public void crearComponenteEditableInicial(ComponenteAmbiental componente, int index) {
        ...
        richPanelGroupLayout.getChildren().add(crearCategoriaEditable(index, componente.getIdCategoria(),
                                                                      componente.getIdAporte()));
        richPanelGroupLayout.getChildren().add(crearSubCategoriaEditable(index, componente.getIdSubCategoria(),
                                                                         componente.getIdCategoria()));
     ...
     * @Fecha  : 20/05/2019
     */
    public void crearComponenteNoEditable(ComponenteAmbiental componente, int index) {
        //Add PanelGroupLayout
        RichPanelGroupLayout richPanelGroupLayout = new RichPanelGroupLayout();
        richPanelGroupLayout.setLayout(LAYOUT_V);
        richPanelGroupLayout.setId(ID_PANEL + index);
    ...
    public UIComponent crearSectorNoEditable(int index, String valor) {
        ...
        String lblValor = getValueFromResourceBundle(BUNDLE, "SECTOR");
    ...
    public UIComponent crearAporteNoEditable(int index, String valor) {
        ...
        String lblValor = getValueFromResourceBundle(BUNDLE, "APORTE");
        richOutputLabel.setValue(lblValor);
        richOutputLabel.setInlineStyle(OutputLabel_INLINESTYLE);
        //OutputText
        RichOutputText richOutputText = new RichOutputText();
    ...
    public UIComponent crearCategoriaNoEditable(int index, String valor) {
        ...
        String lblValor = getValueFromResourceBundle(BUNDLE, "CATEGORIA");
        richOutputLabel.setValue(lblValor);
        richOutputLabel.setInlineStyle(OutputLabel_INLINESTYLE);
        //OutputText
        RichOutputText richOutputText = new RichOutputText();
    ...
    public UIComponent crearSubcategoriaNoEditable(int index, String valor) {
        ...
        String lblValor = getValueFromResourceBundle(BUNDLE, "SUBCATEGORIA");
        richOutputLabel.setValue(lblValor);
        richOutputLabel.setInlineStyle(OutputLabel_INLINESTYLE);
        //OutputText
        RichOutputText richOutputText = new RichOutputText();
    ...
    public ActualizarOperacionRequestType obtenerValores() {
        ...
        for (ComponenteAmbiental componente : componentesCAEd) {
            ...
            logger.warning("\n===  obtenerValores |idSector:" + idSector);
            ...
            logger.warning("\n===  obtenerValores |idAporte:" + idAporte);
            ...
            logger.warning("\n===  obtenerValores |idCategoria:" + idCategoria);
            ...
            logger.warning("\n===  obtenerValores |idSubcategoria:" + idSubcategoria);
    ...
    public void mapearValoresClasificacionAmbiental() {
        logger.warning("\n=============== mapearValoresClasificacionAmbiental (): mapear los valores de los componentes a ActualizarClasificacionAmbientalVO de CA ================");
        validarComponentes();
        if (mensajeErroresCAEd.length() > 0) {
            // mostar errores
            mostrarPopup(true, ID_POPUP_MSG_ERROR);
            ...
            if (vo != null) {
                ...
                logger.warning("\n=============== Componente Ambiental Editable  size:" + componentesCAEd.size());
                // validarComponentes();
                // imprimirComponentes();
                for (ComponenteAmbiental componente : componentesCAEd) {
    ...
    public void aceptarActualizarClasificacionAmbiental(ActionEvent actionEvent) {
        //Mapear valores
        logger.warning("\n== Inicia metodo aceptarActualizarClasificacionAmbiental ==");
        ...
        if (!opbActualizar.getErrors().isEmpty()) {
            ...
            if (response.getResultado() != null) {
                ...
                mostrarPopup(false, ID_POPUP_MSG_ACTUALIZAR);
                JSFUtils.addFacesErrorMessage("Error al actualizar la informacion de Clasificacion Ambiental");
            }
        } else {
            mostrarPopup(false, ID_POPUP_MSG_ACTUALIZAR);
