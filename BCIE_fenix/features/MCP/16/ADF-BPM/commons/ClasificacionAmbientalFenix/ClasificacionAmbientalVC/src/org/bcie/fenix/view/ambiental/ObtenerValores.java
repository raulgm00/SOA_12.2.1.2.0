...
public class ObtenerValores implements Serializable {
    ...
    public void valoresParametros() {
        ...
        logger.warning("\n==== Se recupera idOperacion:" + idOperacion + " valor de banOperacion:" + banOperacion);
        ...
        logger.warning("\n==== Se recupera idProducto:" + idProducto + " valor de banProducto:" + banProducto);
        ...
        logger.warning("\n==== Se recupera estadoBPM:" + estadoBPM + " valor de banEstadoBPM:" + banEstadoBPM);
        //Obtener Tarea
        tarea =
        ...
        logger.warning("\n==== Se recupera rolEjecutivo:" + rolEjecutivo + " valor de banRol:" + banRol);

        if (banEstadoBPM) {
            setEditable(idProducto, tarea);
        } else {
            logger.warning("\n==== Se establece valor  esEditable:" + false);
    ...
    public void setEditable(String idProducto,String tarea) {
        ...
        esEditable = bandera;
        logger.warning("\n==== Se establece valor  esEditable:" + esEditable);
    ...
    public void consultarPorIdOperacion() {
        logger.warning("\n==== Se ejecuta consultarPorIdOperacion para CA Editable   ====");
        ...
        tcaCategoriaAmbiental =
            ADFUtils.getDCBindingContainer().findIteratorBinding("ClasificacionAmbientalEditableVOIterator");
