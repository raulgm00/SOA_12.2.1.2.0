...
declare variable $outConsultaRegistrarComision.response as element() (:: schema-element(cre:ConsultarBitacoraProcesoOperacionResponse) ::) external;

declare function local:funcXq_instanciasregistrarcomision_to_response($outConsultaRegistrarComision.response as element() (:: schema-element(cre:ConsultarBitacoraProcesoOperacionResponse) ::)) as element() (:: schema-element(con:configuracionReasignarOperacionResponse) ::) {
    <con:configuracionReasignarOperacionResponse>
        <con:configuracionReasignarOperacion>
            <con1:RegistrarComision>
             {
             for $instancia in $outConsultaRegistrarComision.response/cre:Bitacora
              return
...
local:funcXq_instanciasregistrarcomision_to_response($outConsultaRegistrarComision.response)
