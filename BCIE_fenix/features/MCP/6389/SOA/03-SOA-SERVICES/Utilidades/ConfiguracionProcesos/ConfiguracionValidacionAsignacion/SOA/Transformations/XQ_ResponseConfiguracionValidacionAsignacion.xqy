    ...
    <con:ConfiguracionValidacionAsignacionResponse>
        <con:ConfiguracionValidacionAsignacion>
            <con2:Header>
                ...
                {
                if(count($outConsultarSolicitudDesembolso.response/des:SolicitudDesmebolso/des1:ContratoDesembolso[des1:condicionesFinancieras/des1:fondo/des1:Validador/cat:Id/text() = '21'])>0
                 or 
               ...
               {
               if(count($outConsultarSolicitudDesembolso.response/des:SolicitudDesmebolso/des1:ContratoDesembolso[des1:condicionesFinancieras/des1:fondo/des1:Validador/cat:Id/text() = '24'])>0)then
               <ns6:ParameterType>
              ...
              {
               if(count($outConsultarSolicitudDesembolso.response/des:SolicitudDesmebolso/des1:ContratoDesembolso[des1:condicionesFinancieras/des1:fondo/des1:Validador/cat:Id/text() = '4'])>0)then
               <ns6:ParameterType>
              ...
              {
               if(count($outConsultarSolicitudDesembolso.response/des:SolicitudDesmebolso/des1:ContratoDesembolso[des1:condicionesFinancieras/des1:fondo/des1:Validador/cat:Id/text() = '64'])>0)then
               <ns6:ParameterType>
...
local:funcXq_responseconfiguracionvalidacionasignacion($inputVariable.request, $outConsultarRolesPorProceso.response, $outConsultarSolicitudDesembolso.response, $outConsultarOperacionById.response)
