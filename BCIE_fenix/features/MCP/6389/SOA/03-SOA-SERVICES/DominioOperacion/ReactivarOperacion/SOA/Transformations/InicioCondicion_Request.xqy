...
declare namespace con1="http://xmlns.oracle.com/bpmn/bpmnProcess/CondicionesProcess";
(:: import schema at "oramds:/apps/Resources/BPM/Schema/PA03/CondicionesProcess.xsd" ::)
...
declare namespace con2 = "http://www.bcie.org/ConsultarParametrosEnBitacoraProcesoBO";
...
declare function local:funcIniciocondicion_request($OutConsultar.response as element() (:: schema-element(ope:ConsultarOperacionResponse) ::), 
                                                   ...
                                                   as element() (:: schema-element(con1:InicioCondiciones) ::) {
    <con1:InicioCondiciones>
        <con1:Header>
            <ns1:Operacion>
            ...
            <ns1:Tarea>
                ...
                <ns3:NombreProceso>PA03</ns3:NombreProceso>
            </ns1:Tarea>
            {
            if (fn:string-length($outConsultarParametrosEnBitacora.response/con:Parametros/con2:parameter1)> 0)
            then(
            <ns4:ParameterType>
                <ns4:parameterName>{fn:substring-before(fn:data($outConsultarParametrosEnBitacora.response/con:Parametros/con2:parameter1),'-')}</ns4:parameterName>
                <ns4:parameterValue>{fn:substring-after(fn:data($outConsultarParametrosEnBitacora.response/con:Parametros/con2:parameter1),'-')}</ns4:parameterValue>
            </ns4:ParameterType>)
            else()}
            {
            if (fn:string-length($outConsultarParametrosEnBitacora.response/con:Parametros/con2:parameter2)> 0)
            then(
            <ns4:ParameterType>
                <ns4:parameterName>{fn:substring-before(fn:data($outConsultarParametrosEnBitacora.response/con:Parametros/con2:parameter2),'-')}</ns4:parameterName>
                <ns4:parameterValue>{fn:substring-after(fn:data($outConsultarParametrosEnBitacora.response/con:Parametros/con2:parameter2),'-')}</ns4:parameterValue>
            </ns4:ParameterType>)
            else()}
            {
            if (fn:string-length($outConsultarParametrosEnBitacora.response/con:Parametros/con2:parameter3)> 0)
            then(
            <ns4:ParameterType>
                <ns4:parameterName>{fn:substring-before(fn:data($outConsultarParametrosEnBitacora.response/con:Parametros/con2:parameter3),'-')}</ns4:parameterName>
                <ns4:parameterValue>{fn:substring-after(fn:data($outConsultarParametrosEnBitacora.response/con:Parametros/con2:parameter3),'-')}</ns4:parameterValue>
            </ns4:ParameterType>)
            else()}
...
local:funcIniciocondicion_request($OutConsultar.response, $outConsultarParametrosEnBitacora.response)
