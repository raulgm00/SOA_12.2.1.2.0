...
declare namespace lav="http://xmlns.oracle.com/bpmn/bpmnProcess/LavadoActivosProcess";
(:: import schema at "oramds:/apps/Resources/BPM/Schema/PA01/LavadoActivosProcess.xsd" ::)
...
declare variable $inputVariable.request as element() (:: schema-element(ope:ReactivarOperacionRequest) ::) external;
...
declare function local:funcIniciolaft_request($inputVariable.request as element() (:: schema-element(ope:ReactivarOperacionRequest) ::), 
                                              $OutConsultar.response as element() (:: schema-element(ope:ConsultarOperacionResponse) ::), 
                                              ...
                                              as element() (:: schema-element(lav:InicioLAFT) ::) {
    <lav:InicioLAFT>
        <lav:Header>
            <ns1:Operacion>
                <ns2:CodigoOperacion>{fn:data($inputVariable.request/ope:idOperacion)}</ns2:CodigoOperacion>
            ...
            <ns1:Tarea>
                ...
                <ns3:NombreProceso>PA01</ns3:NombreProceso>
            </ns1:Tarea>
            {
...
local:funcIniciolaft_request($inputVariable.request, $OutConsultar.response, $outConsultarParametrosEnBitacora.response)
