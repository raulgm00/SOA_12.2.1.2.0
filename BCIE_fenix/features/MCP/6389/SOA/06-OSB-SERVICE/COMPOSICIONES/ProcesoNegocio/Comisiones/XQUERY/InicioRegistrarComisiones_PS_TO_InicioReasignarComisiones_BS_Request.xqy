...
declare variable $InicioComisiones as element() (:: schema-element(ns1:InicioRegistrarComisiones) ::) external;

declare function local:func($InicioComisiones as element() (:: schema-element(ns1:InicioRegistrarComisiones) ::)) as element() (:: schema-element(ns1:InicioReasignarComisiones) ::) {
    <ns1:InicioReasignarComisiones>
        <ns1:Header>
            <ns2:Operacion>
