...
declare function local:func($FinEnmiendas as element() (:: schema-element(ns1:FinEnmiendas) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            <cre:id></cre:id>
            <cre:idOperacion>{fn:data($FinEnmiendas/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($FinEnmiendas/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            <cre:idProceso>10</cre:idProceso>
            <cre:nombreProceso>PA04</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinEnmiendas/ns1:Header/ns3:Proceso/ns5:InstanciaProceso)}</cre:instanciaProceso>
            ...
            <cre:usuario>{fn:data($FinEnmiendas/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
