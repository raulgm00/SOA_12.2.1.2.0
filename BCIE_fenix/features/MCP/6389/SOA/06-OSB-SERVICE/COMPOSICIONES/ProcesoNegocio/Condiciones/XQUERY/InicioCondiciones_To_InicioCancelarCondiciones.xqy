...
declare function local:func($InicioCondiciones as element() (:: schema-element(ns1:InicioCondiciones) ::)) as element() (:: schema-element(ns1:InicioCancelarCondiciones) ::) {
    <ns1:InicioCancelarCondiciones>
        <ns1:Header>
            {
                if (error()) then 
