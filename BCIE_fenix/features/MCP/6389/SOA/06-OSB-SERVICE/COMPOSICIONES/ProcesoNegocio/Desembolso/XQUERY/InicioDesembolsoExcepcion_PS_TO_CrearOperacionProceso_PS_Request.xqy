...
declare function local:func($InicioDesembolsoExcepcion as element() (:: schema-element(ns1:InicioDesembolsoExcepcion) ::)) as element() (:: schema-element(ns2:requestCrearOperacionProcesoMessage) ::) {
