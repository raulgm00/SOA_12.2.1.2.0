...
declare function local:func($FinDesembolsoExcepcion as element() (:: schema-element(ns1:FinDesembolsoExcepcion) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            <cre:id></cre:id>
            <cre:idOperacion>{fn:data($FinDesembolsoExcepcion/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($FinDesembolsoExcepcion/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            <cre:idProceso>17</cre:idProceso>
            <cre:nombreProceso>PC06</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinDesembolsoExcepcion/ns1:Header/ns3:Proceso/ns5:InstanciaProceso)}</cre:instanciaProceso>
            ...
            <cre:usuario>{fn:data($FinDesembolsoExcepcion/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
