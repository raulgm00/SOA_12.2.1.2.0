...
declare variable $request as element() (:: schema-element(ns1:InicioDesembolso) ::) external;

declare function local:func($request as element() (:: schema-element(ns1:InicioDesembolso) ::)) as element() (:: schema-element(ns1:InicioReasignarRO) ::) {
