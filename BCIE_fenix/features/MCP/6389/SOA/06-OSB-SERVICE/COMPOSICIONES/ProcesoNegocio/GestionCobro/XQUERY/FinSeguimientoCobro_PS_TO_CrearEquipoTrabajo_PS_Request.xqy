...
declare function local:func($FinSeguimientoCobro as element() (:: schema-element(ns1:FinSeguimientoCobro) ::)) as element() (:: schema-element(ns2:CrearEquipoTrabajoClienteRequest) ::) {
    <ns2:CrearEquipoTrabajoClienteRequest>
        <ns2:idCliente>{fn:data($FinSeguimientoCobro/ns1:Header/ns4:Cliente/ns5:IdCliente)}</ns2:idCliente>
        <ns2:listadoEquipoTrabajo>
            {
                for $equipoTrabajo in $FinSeguimientoCobro/ns1:EquipoTrabajo/ns3:equipoTrabajo
                return 
                <ns3:equipoTrabajo>
