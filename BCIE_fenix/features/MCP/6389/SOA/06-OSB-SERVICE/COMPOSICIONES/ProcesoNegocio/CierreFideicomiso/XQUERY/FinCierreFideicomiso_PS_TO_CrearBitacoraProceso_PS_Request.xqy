...
declare function local:func($FinCierreFideicomiso as element() (:: schema-element(ns1:FinCierreFideicomiso) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            <cre:idOperacion>{fn:data($FinCierreFideicomiso/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($FinCierreFideicomiso/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            <cre:idProceso>28</cre:idProceso>
            <cre:nombreProceso>PA14</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinCierreFideicomiso/ns1:Header/ns3:Proceso/ns5:InstanciaProceso)}</cre:instanciaProceso>
            ...
            <cre:usuario>{fn:data($FinCierreFideicomiso/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
