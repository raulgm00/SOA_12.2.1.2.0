...
declare function local:func($InicioValidacionAsignacion as element() (:: schema-element(ns1:InicioValidacionAsignacion) ::)) as element() (:: schema-element(ns2:requestCrearOperacionProcesoMessage) ::) {
