...
declare variable $CrearActualizarLoteImplementacionResponse as element() (:: schema-element(ns2:CrearActualizarLoteImplementacionResponse) ::) external;

declare function local:func($InicioImplementacionPCT as element() (:: schema-element(ns1:InicioImplementacionPCT) ::),
                            $CrearActualizarLoteImplementacionResponse as element() (:: schema-element(ns2:CrearActualizarLoteImplementacionResponse) ::)) as element() (:: schema-element(ns1:InicioImplementacionPCT) ::) {
        ...
        <ns1:Header>
            ...
            }
            {
             ...
             <ns8:ParameterType>
                ...
                <ns8:parameterValue>{fn:data($CrearActualizarLoteImplementacionResponse/ns2:LoteImplementacion/imp:idLote)}</ns8:parameterValue>
            </ns8:ParameterType>
            {
            for $param in $InicioImplementacionPCT/ns1:Header/ns8:ParameterType
            return
            <ns8:ParameterType>
                <ns8:parameterName>{fn:data($param/ns8:parameterName)}</ns8:parameterName>
                <ns8:parameterValue>{fn:data($param/ns8:parameterValue)}</ns8:parameterValue>
            </ns8:ParameterType>
            }
        </ns1:Header>
    </ns1:InicioImplementacionPCT>
...
local:func($InicioImplementacionPCT, $CrearActualizarLoteImplementacionResponse)
