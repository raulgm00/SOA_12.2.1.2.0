...
declare namespace ns1="http://xmlns.oracle.com/bpmn/bpmnProcess/ProcesosPrincipales";
(:: import schema at "../../../MDS/Resources/BPM/Wsdl/ProcesosPrincipales.wsdl" ::)
    ...
    <ns1:ResultadoProceso>
        <ns1:resultado>
            ...
            <res:error>
                ...
                <err:errorType>{fn:data($tipo)}</err:errorType>
            </res:error>
        </ns1:resultado>
    </ns1:ResultadoProceso>
};

local:func($descripcion, $codigo, $mensaje, $tipo)
