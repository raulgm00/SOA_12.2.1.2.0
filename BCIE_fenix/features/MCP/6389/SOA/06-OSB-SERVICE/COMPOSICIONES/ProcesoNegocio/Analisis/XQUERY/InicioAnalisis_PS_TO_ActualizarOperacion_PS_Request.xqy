...
declare function local:func($InicioAnalisis as element() (:: schema-element(ns1:InicioAnalisis) ::)) as element() (:: schema-element(ns2:ActualizarOperacionRequest) ::) {
    <ns2:ActualizarOperacionRequest>
        <ns2:Operacion>
            <ope:idOperacion>{fn:data($InicioAnalisis/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</ope:idOperacion>
            <ope:etapa>3</ope:etapa>        
        </ns2:Operacion>
    </ns2:ActualizarOperacionRequest>
};
