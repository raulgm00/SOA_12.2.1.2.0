...
declare function local:func($InicioAprobacion as element() (:: schema-element(ns1:InicioAprobacion) ::)) as element() (:: schema-element(ns2:ActualizarOperacionRequest) ::) {
    <ns2:ActualizarOperacionRequest>
        <ns2:Operacion>
            <ope:idOperacion>{fn:data($InicioAprobacion/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</ope:idOperacion>
            <ope:etapa>4</ope:etapa>            
        </ns2:Operacion>
    </ns2:ActualizarOperacionRequest>
};
