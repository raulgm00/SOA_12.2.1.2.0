...
declare variable $LAFTRequest as element() (:: schema-element(ns1:FinLAFT) ::) external;

declare function local:func($LAFTRequest as element() (:: schema-element(ns1:FinLAFT) ::)) as element() (:: schema-element(ns2:requestFinalizarOperacionProcesoMessage) ::) {
    <ns2:requestFinalizarOperacionProcesoMessage>
        <ns2:BitacoraInput>
            <fin:idOperacion>{fn:data($LAFTRequest/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</fin:idOperacion>
            <fin:idProceso>7</fin:idProceso>
        </ns2:BitacoraInput>
    </ns2:requestFinalizarOperacionProcesoMessage>
};

local:func($LAFTRequest)
