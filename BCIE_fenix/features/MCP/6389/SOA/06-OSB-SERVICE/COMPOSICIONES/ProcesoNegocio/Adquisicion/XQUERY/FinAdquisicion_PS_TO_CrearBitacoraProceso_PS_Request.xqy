...
declare function local:func($FinAdquisicion as element() (:: schema-element(ns1:FinAdquisicion) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            <cre:idOperacion>{fn:data($FinAdquisicion/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($FinAdquisicion/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            <cre:idProceso>24</cre:idProceso>
            <cre:nombreProceso>PA09</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinAdquisicion/ns1:Header/ns3:Proceso/ns5:InstanciaProceso)}</cre:instanciaProceso>
            ...
            <cre:usuario>{fn:data($FinAdquisicion/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
