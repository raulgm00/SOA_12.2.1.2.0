...
declare variable $FinCierreFideicomisoRequest as element() (:: schema-element(ns1:FinCierreFideicomiso) ::) external;

declare function local:func($FinCierreFideicomisoRequest as element() (:: schema-element(ns1:FinCierreFideicomiso) ::)) as element() (:: schema-element(ns2:ActualizarOperacionRequest) ::) {
    <ns2:ActualizarOperacionRequest>
        <ns2:Operacion>
            <ope:idOperacion>{fn:data($FinCierreFideicomisoRequest/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</ope:idOperacion>
            <ope:estado>
                <cat:Id>27</cat:Id>
...
local:func($FinCierreFideicomisoRequest)
