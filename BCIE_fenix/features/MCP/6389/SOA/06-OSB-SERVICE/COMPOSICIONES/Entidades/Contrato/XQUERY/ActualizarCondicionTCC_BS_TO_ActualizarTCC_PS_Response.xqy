...
declare variable $ActualizarCondicionTCCResponse as element() (:: schema-element(ns1:ActualizarTCCResponse) ::) external;

declare function local:func($ActualizarCondicionTCCResponse as element() (:: schema-element(ns1:ActualizarTCCResponse) ::)) as element() (:: schema-element(ns1:ActualizarTCCResponse) ::) {
    <ns1:ActualizarTCCResponse>
        {
            for $Condicion in $ActualizarCondicionTCCResponse/ns1:Condicion
            return 
            <ns1:Condicion>
        ...
        {
            for $Resultado in $ActualizarCondicionTCCResponse/ns1:Resultado
            return 
            <ns1:Resultado>
...
local:func($ActualizarCondicionTCCResponse)
