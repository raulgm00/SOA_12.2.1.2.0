...
declare variable $ActualizarTCCResponse as element() (:: schema-element(ns1:ActualizarTCCResponse) ::) external;

declare function local:func($ActualizarTCCResponse as element() (:: schema-element(ns1:ActualizarTCCResponse) ::)) as element() (:: schema-element(ns1:ActualizarTCCResponse) ::) {
    <ns1:ActualizarTCCResponse>
        {
            for $Comision in $ActualizarTCCResponse/ns1:Comision
            return 
            <ns1:Comision>
        ...
        {
            for $Resultado in $ActualizarTCCResponse/ns1:Resultado
            return 
            <ns1:Resultado>
...
local:func($ActualizarTCCResponse)
