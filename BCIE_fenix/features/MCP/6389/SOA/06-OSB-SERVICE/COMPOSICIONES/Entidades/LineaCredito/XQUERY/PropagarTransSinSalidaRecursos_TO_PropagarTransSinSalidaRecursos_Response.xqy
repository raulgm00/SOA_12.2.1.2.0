...
declare function local:func($PropagarTransSinSalidaRecursosRequest as element() (:: schema-element(ns1:PropagarTransSinSalidaRecursosRequest) ::)) as element() (:: schema-element(ns1:PropagarTransSinSalidaRecursosResponse) ::) {
    <ns1:PropagarTransSinSalidaRecursosResponse>
        <ns1:ContratoDesembolso>
            <des:idDesembolso>{fn:data($PropagarTransSinSalidaRecursosRequest/ns1:idDesembolso)}</des:idDesembolso>
            ...
            <des:Transferencia>
                <des:idTransferencia>17</des:idTransferencia>
