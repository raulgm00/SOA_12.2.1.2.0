...
declare variable $PropagarContratoDesembolsoRequest as element() (:: schema-element(ns1:PropagarContratoDesembolsoRequest) ::) external;

declare function local:func($PropagarContratoDesembolsoRequest as element() (:: schema-element(ns1:PropagarContratoDesembolsoRequest) ::)) as element() (:: schema-element(ns1:PropagarContratoDesembolsoResponse) ::) {
    <ns1:PropagarContratoDesembolsoResponse>
        <ns1:ContratoDesembolso>
            <des:idDesembolso>{fn:data($PropagarContratoDesembolsoRequest/ns1:idDesembolso)}</des:idDesembolso>
...
local:func($PropagarContratoDesembolsoRequest)
