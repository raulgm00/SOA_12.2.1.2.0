...
declare function local:func($crearLoanComplejoResponse as element() (:: element(m:crearLoanComplejoResponse) ::),$referencia as xs:string) as element() (:: schema-element(ns1:CrearDesembolsoComplejoFLEXCUBEResponse) ::) {
    <ns1:CrearDesembolsoComplejoFLEXCUBEResponse>
