...
declare function local:func($ReporteMessage as element() (:: schema-element(rep:Reporte) ::)) as element()(:: schema-element(ns1:GeneraReporteAvisoCobroResponse) ::) {
 <ns1:GeneraReporteAvisoCobroResponse>
    <ns1:Resultado>
        <res:result>
        {
