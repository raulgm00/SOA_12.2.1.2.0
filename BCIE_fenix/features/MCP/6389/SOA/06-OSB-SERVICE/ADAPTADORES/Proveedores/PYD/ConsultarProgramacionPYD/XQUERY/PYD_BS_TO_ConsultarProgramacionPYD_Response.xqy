...
declare namespace m="http://org/bcie/ws/middle/PYD/PYD.wsdl";
...
declare variable $consultarProgramacionResponse as element(m:consultarProgramacionResponse) external;

declare function local:func($ConsultarProgramacionPYDRequest as element()(:: schema-element(ns1:ConsultarProgramacionPYDRequest) ::),$consultarProgramacionResponse as element(m:consultarProgramacionResponse)) as element() (:: schema-element(ns1:ConsultarProgramacionPYDResponse) ::) {
...
<ns1:LineaCredito>
            ...
            <lin:Monto>
                ...
                <com:importe>{fn:data($consultarProgramacionResponse/montoProgramado_out)}</com:importe>
                <com:moneda>
            ...
            <lin:Monto>
                ...
                <com:importe>{fn:data($consultarProgramacionResponse/montoEjecutado_out)}</com:importe>
                <com:moneda>
                    <cat:Id></cat:Id>
        ...
        <ns1:Resultado>
           {
                if (fn:data($consultarProgramacionResponse/tipoResultado_out)= 0) then
        ...
        }
         {
            ...
            <res:message>Consulta realizada correctamente</res:message>
             else  <res:message>{fn:data($consultarProgramacionResponse/mensajeError_out)}</res:message>
        }
        </ns1:Resultado>
    </ns1:ConsultarProgramacionPYDResponse>
};
