...
declare function local:func($ObtenerInformeCondicionesRequest as element() (:: schema-element(ns1:ObtenerInformeCondicionesRequest) ::)) as element() (:: schema-element(ns1:ConsultarCondicionByIdOperacionRequest) ::) {
    <ns1:ConsultarCondicionByIdOperacionRequest>
