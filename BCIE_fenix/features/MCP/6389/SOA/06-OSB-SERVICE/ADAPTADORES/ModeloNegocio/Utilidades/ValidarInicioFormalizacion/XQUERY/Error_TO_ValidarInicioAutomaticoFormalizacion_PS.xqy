...
declare function local:func($responseMapeoErrorMessage as element() (:: schema-element(ns2:responseMapeoErrorMessage) ::),
      $mensaje as xs:string) as element()(:: schema-element(ns1:ValidarInicioFormalizacionResponse) ::) {
    <ns1:ValidarInicioFormalizacionResponse>
    <ns1:Resultado>
        ...
        </ns1:Resultado></ns1:ValidarInicioFormalizacionResponse>
};
