...
declare function local:func($requestConsultarOperacionMessage as element() (:: schema-element(ns1:requestConsultarOperacionMessage) ::)) as element() (:: schema-element(ns2:ActualizarUsuarioReunionRequest) ::) {
    <ns2:ActualizarUsuarioReunionRequest>
        <ns2:idSolicitudAprobacion> </ns2:idSolicitudAprobacion>
        <ns2:idUsuarioReunion>{fn:data($requestConsultarOperacionMessage/ns1:operacion/con:idUsuarioReunion)}</ns2:idUsuarioReunion>
    </ns2:ActualizarUsuarioReunionRequest>
};
