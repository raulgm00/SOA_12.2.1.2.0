...
/**
 * <p>Java class for consolidado complex type.
 * 
 ...
 *         &lt;element name="resumenPago" type="{http://www.bcie.org/herramientaOfismatica}fechaPago" maxOccurs="unbounded"/>
 *         &lt;element name="comentario1" type="{http://www.bcie.org/herramientaOfismatica}comentario1" maxOccurs="unbounded"/>
 *         &lt;element name="lstBancos" type="{http://www.bcie.org/herramientaOfismatica}datosBanco" maxOccurs="unbounded"/>
 *         &lt;element name="comentario2" type="{http://www.bcie.org/herramientaOfismatica}comentario2" maxOccurs="unbounded"/>
 *         &lt;element name="detalleCalculo" type="{http://www.bcie.org/herramientaOfismatica}lstFechaPago" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Consolidado {
    ...
    @XmlElement(required = true)
    protected List<LstFechaPago> detalleCalculo;
     ...
     * 
     */
    public List<LstFechaPago> getDetalleCalculo() {
        if (detalleCalculo == null) {
            detalleCalculo = new ArrayList<LstFechaPago>();
        }
