...
public class FenixPanelBean implements Serializable
{
    ...
    /**
     * Método que controla la activación del panel de Documentos
    ...
    /**
     * Método que controla la activación del panel de Comentarios
     * @param disclosureEvent
     */
    ...
    /**
     * Método que controla la activación del panel de Detalle de la Operación
     * @param disclosureEvent
     */
    ...
    /**
     * Método que controla la activación del panel de Detalle de la Operación del Gestor de operaciones
     * @param disclosureEvent
     */
    ...
    /**
     * Método que controla la activación del panel de Datos de la tarea
     * @param disclosureEvent
     */
    ...
    /**
     * Método que controla la activación del panel de Matriz TCC
     * @param disclosureEvent
     */
    ...
    /**
     * Método que controla la activación del panel de Adquisiciones de la Operación del Gestor de operaciones
     * @param disclosureEvent
     */
