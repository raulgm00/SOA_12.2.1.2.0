...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [FRI SEP 09 19:03:47 CDT 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:CondicionPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns5:CodigoTarea>74</ns5:CodigoTarea>
          <ns5:NombreTarea>Validar Condiciones PCT</ns5:NombreTarea>
