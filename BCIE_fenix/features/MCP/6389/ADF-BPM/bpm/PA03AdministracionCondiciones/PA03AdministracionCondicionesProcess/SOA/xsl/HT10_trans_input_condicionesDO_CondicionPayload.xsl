...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [MON SEP 12 11:25:21 CDT 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:CondicionPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns5:CodigoTarea>189</ns5:CodigoTarea>
          <ns5:NombreTarea>Validar Condiciones OFIC</ns5:NombreTarea>
          <ns5:CodigoRol>13</ns5:CodigoRol>
          <ns5:NombreRol>Analista de la OFIC</ns5:NombreRol>
