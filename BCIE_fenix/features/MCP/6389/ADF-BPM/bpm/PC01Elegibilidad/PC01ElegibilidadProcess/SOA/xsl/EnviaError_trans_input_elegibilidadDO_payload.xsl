...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [TUE JAN 19 11:56:36 CST 2016].-->
  </oracle-xsl-mapper:schema>
    ...
    <tns:ElegibilidadErrorPayloadType>
      <tns:Header>
        ...
        <header:Tarea>
          ...
          <ns2:CodigoProceso><xsl:value-of select="/ns0:ElegibilidadPayload/ns0:Header/header:Tarea/ns2:CodigoProceso"/>1</ns2:CodigoProceso>
          <ns2:NombreProceso>
