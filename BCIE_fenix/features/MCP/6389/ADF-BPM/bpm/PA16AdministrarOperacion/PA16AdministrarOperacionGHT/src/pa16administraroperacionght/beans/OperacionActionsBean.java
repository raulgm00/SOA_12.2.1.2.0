...
public class OperacionActionsBean extends FenixActionBean {
    ...
    private Integer getCodigoTarea() {
        OperacionBean managedBean = (OperacionBean) JSFUtils.resolveExpression(
                "#{pageFlowScope.operacionBean}");

        if ((null != managedBean.getCodigoTarea()) &&
                (managedBean.getCodigoTarea().trim().length() > 0)) {
    ...
    private Long getIdOperacion() {
        ...
        if ((null != managedBean.getIdOperacion()) &&
                (managedBean.getIdOperacion().trim().length() > 0)) {
    ...
    public void productoValueChangeListener(ValueChangeEvent valueChangeEvent) {
        ...
        if (valueChangeEvent.getNewValue() != null) {
            ...
            OperacionBean operacionBean = (OperacionBean) JSFUtils.resolveExpression(
                    "#{pageFlowScope.operacionBean}");
    ...
    public void sectorMercadoValueChangeListener(
        ...
        actualizarPayloadElement("IdSectorMercado",
            valueChangeEvent.getNewValue());
    }

    public void ejercicioPOAValueChangeListener(
        ValueChangeEvent valueChangeEvent) {
        ...
        actualizarPayloadElement("IdEjercicioPOA",
            valueChangeEvent.getNewValue());
    }

    public void tipoGarantiaValueChangeListener(
        ValueChangeEvent valueChangeEvent) {
        ...
        actualizarPayloadElement("IdTipoGarantia",
            valueChangeEvent.getNewValue());
    }
    ...
    public void seleccionarClienteActionListener(ActionEvent actionEvent) {
        ...
        try {
            ...
            operacionBean = (OperacionBean) JSFUtils.resolveExpression(
                    "#{pageFlowScope.operacionBean}");
    ...
    private void agregarMontoTotalOperacion() {
        ...
        montoOperacionIteratorDC = ADFUtils.getDCBindingContainer()
                                           .findIteratorBinding("montoOperacionIterator1");
        ...
        LOGGER.warning("operacionBean.getEsMontoTotal: " +
            operacionBean.getEsMontoTotal());
        ...
        if (!tieneMontoTotal && operacionBean.getEsMontoTotal()) {
            LOGGER.warning("montoOperacionIteratorDC.getEstimatedRowCount(): " +
                montoOperacionIteratorDC.getEstimatedRowCount());
            LOGGER.warning("Agregando nuevo monto operacion vacio");

            BindingContainer bindings = ADFUtils.getBindingContainer();
            OperationBinding operBinding = bindings.getOperationBinding(
                    "CreateInsertMontoOperacion");
            operBinding.execute();
            LOGGER.warning("montoOperacionIteratorDC.getEstimatedRowCount(): " +
                montoOperacionIteratorDC.getEstimatedRowCount());
            ...
            LOGGER.warning("Descripcion Fila Seleccionada: " +
                montoOperacionIteratorDC.getRowAtRangeIndex(index)
                                        .getAttribute("Descripcion"));
            montoOperacionIteratorDC.getRowAtRangeIndex(index)
                                    .setAttribute("Descripcion", "TOTAL");
            montoOperacionIteratorDC.getRowAtRangeIndex(index)
                                    .setAttribute("monto", 0);
            montoOperacionIteratorDC.getRowAtRangeIndex(index)
                                    .setAttribute("IdTcaTipoMonto", 1);
            montoOperacionIteratorDC.getRowAtRangeIndex(index)
                                    .setAttribute("idOperacion",
                getIdOperacion());
            montoOperacionIteratorDC.getRowAtRangeIndex(index)
                                    .setAttribute("id", -1);
    ...
    private Boolean actualizarDatosOperacionDB() {
        ...
        String nombreOperacion = (null != ADFUtils.getBoundAttributeValue(
        ...
        Integer idProducto = (null != ADFUtils.getBoundAttributeValue(
                "idProducto"))
            ? (Integer) ADFUtils.getBoundAttributeValue("idProducto") : null;
        String descripcion = (null != ADFUtils.getBoundAttributeValue(
                "descripcion"))
            ? (String) ADFUtils.getBoundAttributeValue("descripcion") : null;
        Integer idMoneda = (null != ADFUtils.getBoundAttributeValue(
                "IdTipoMoneda"))
        ...
        Integer IdCatPais = (null != ADFUtils.getBoundAttributeValue(
                "idCatPais"))
            ? (Integer) ADFUtils.getBoundAttributeValue("idCatPais") : null;
        ...
        Integer idSectorMercado = (null != ADFUtils.getBoundAttributeValue(
                "IdSectorMercado"))
            ? (Integer) ADFUtils.getBoundAttributeValue("IdSectorMercado") : null;
        Boolean progamadoPOA = (null != ADFUtils.getBoundAttributeValue(
                "programadoPOA"))
            ? (Boolean) ADFUtils.getBoundAttributeValue("programadoPOA") : null;
        Integer idEjercicioPOA = (null != ADFUtils.getBoundAttributeValue(
                "IdEjercicioPOA"))
            ? (Integer) ADFUtils.getBoundAttributeValue("IdEjercicioPOA") : null;
        String unidadEjecutora = (null != ADFUtils.getBoundAttributeValue(
                "unidadEjecutora"))
            ? (String) ADFUtils.getBoundAttributeValue("unidadEjecutora") : null;
        Integer idTipoGarantia = (null != ADFUtils.getBoundAttributeValue(
                "IdTipoGarantia"))
            ? (Integer) ADFUtils.getBoundAttributeValue("IdTipoGarantia") : null;
        Boolean componenteConcesionalidad = (null != ADFUtils.getBoundAttributeValue(
                "componenteConcesionalidad"))
            ? (Boolean) ADFUtils.getBoundAttributeValue(
                "componenteConcesionalidad") : null;
        ...
        LOGGER.warning("Cantidad de Montos DC: " +
            montoOperacionIteratorDC.getEstimatedRowCount());
        ...
        for (int i = 0; i < iterator.getRowCount(); i++) {
            ...
            BigDecimal monto = (rawMonto != null) ? new BigDecimal(rawMonto)
                                                  : null;
        ...
        detalleOperacionEditableIteratorDC = ADFUtils.getDCBindingContainer()
                                                     .findIteratorBinding("DetalleOperacionEditableVOIterator");

        detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                          .setAttribute("Nombre",
            nombreOperacion);
        LOGGER.warning("detalleOperacionEditableIteratorDC Nombre: " +
            detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                              .getAttribute("Nombre"));
        detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
        ...
        detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                          .setAttribute("Descripcion",
            descripcion);
        detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                          .setAttribute("IdMoneda", idMoneda);
        LOGGER.warning("detalleOperacionEditableIteratorDC IdMoneda: " +
            detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                              .getAttribute("IdMoneda"));
        detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                          .setAttribute("IdCatPais", IdCatPais);
        LOGGER.warning("detalleOperacionEditableIteratorDC IdCatPais: " +
            detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                              .getAttribute("IdCatPais"));
        detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                          .setAttribute("Montototal", montoTotal);
        detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                          .setAttribute("Montosolicitado",
            montoSolicitado);
        detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                          .setAttribute("SectorMercado",
            idSectorMercado);
        detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                          .setAttribute("ProgramadoPoa",
            progamadoPOA ? 1 : 0);
        detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                          .setAttribute("EjercicioPoa",
            idEjercicioPOA);
        detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                          .setAttribute("UnidadEjecutora",
            unidadEjecutora);
        detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                          .setAttribute("TipoGarantia",
            idTipoGarantia);
        detalleOperacionEditableIteratorDC.getRowAtRangeIndex(0)
                                          .setAttribute("ComponenteConcecionalidad",
            componenteConcesionalidad ? 1 : 0);
        ...
        if (operationBinding.getErrors().size() != 0) {
            ...
            if (response.getResultado() != null) {
                ...
                estado = response.getResultado().getResult().toString()
                                 .equals("OK");
    ...
    private OperationBinding executeOperBinding(Map params, String operBindName) {
        ...
        if (null != oper) {
            ...
            try {
                ...
                LOGGER.severe("Error al ejecutar Operator Bindings: " +
                    operBindName, e);
            }

            if (!oper.getErrors().isEmpty()) {
                LOGGER.severe("Operator Bindings devuelve errores: " +
                    operBindName);
            } else {
    ...
    public String invokeFinalizarTarea() {
        ...
        default:
            LOGGER.log(ADFLogger.ERROR,
                "invokeFinalizarTarea(): Codigo de tarea no valido - " +
                codigoTarea);
    ...
    public String invokeMasInformacion() {
        ...
        case FenixConstants.PA16_APROBAR_CAMBIOS_OPERACION:
            LOGGER.warning("PA16_APROBAR_CAMBIOS_OPERACION");
            isValidMasInformacion = validateComentario(getIdOperacion(),
        ...
        if (!isValidMasInformacion) {
            JSFUtils.addFacesErrorMessage(ADFUtils.getStringFromBundle(
                    "MSG_ERROR_AGREGAR_COMENTARIO", BUNDLE));
        } else {
            masInformacionPopup();
        }
    ...
    public String invokeRechazar() {
        ...
        case FenixConstants.PA16_APROBAR_CAMBIOS_OPERACION:
            LOGGER.warning("PA16_APROBAR_CAMBIOS_OPERACION");
            isValidRechazar = validateComentario(getIdOperacion(),
                    getCodigoTarea().toString(), getInstanciaTarea());
    ...
    public String aceptarFinalizarTarea() {
        ...
        if (esValidoFinalizar) {
            ...
            LOGGER.log(ADFLogger.ERROR,
                "aceptarFinalizarTarea(): " + esValidoFinalizar);
