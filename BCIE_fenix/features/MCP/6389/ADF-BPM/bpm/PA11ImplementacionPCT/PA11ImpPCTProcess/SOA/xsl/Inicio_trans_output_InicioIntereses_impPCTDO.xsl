  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="InicioInteresesCobro"
                                       namespace="http://xmlns.oracle.com/bpmn/bpmnProcess/ImplPCTProcess"/>
        <oracle-xsl-mapper:param name="inicioInteresesCobro"/>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [FRI NOV 25 15:38:11 CST 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <tns:ImplementacionPCT>
      <tns:Header>
        <tns6:Operacion>
          <ns2:CodigoOperacion>
            <xsl:value-of select="/ns0:InicioInteresesCobro/ns0:Header/tns6:Operacion/ns2:CodigoOperacion"/>
          </ns2:CodigoOperacion>
          <ns2:NombreOperacion>
            <xsl:value-of select="/ns0:InicioInteresesCobro/ns0:Header/tns6:Operacion/ns2:NombreOperacion"/>
          </ns2:NombreOperacion>
          <ns2:ResponsableOperacion>
            <xsl:value-of select="/ns0:InicioInteresesCobro/ns0:Header/tns6:Operacion/ns2:ResponsableOperacion"/>
          </ns2:ResponsableOperacion>
          <ns2:CodigoCliente>
            <xsl:value-of select="/ns0:InicioInteresesCobro/ns0:Header/tns6:Operacion/ns2:CodigoCliente"/>
          </ns2:CodigoCliente>
          <ns2:NombreCliente>
            <xsl:value-of select="/ns0:InicioInteresesCobro/ns0:Header/tns6:Operacion/ns2:NombreCliente"/>
          </ns2:NombreCliente>
          <ns2:CodigoProducto>
            <xsl:value-of select="/ns0:InicioInteresesCobro/ns0:Header/tns6:Operacion/ns2:CodigoProducto"/>
          </ns2:CodigoProducto>
          <ns2:NombreProducto>
            <xsl:value-of select="/ns0:InicioInteresesCobro/ns0:Header/tns6:Operacion/ns2:NombreProducto"/>
          </ns2:NombreProducto>
          <ns2:MontoSolicitado>
            <xsl:value-of select="/ns0:InicioInteresesCobro/ns0:Header/tns6:Operacion/ns2:MontoSolicitado"/>
          </ns2:MontoSolicitado>
          <ns2:Pais>
            <xsl:value-of select="/ns0:InicioInteresesCobro/ns0:Header/tns6:Operacion/ns2:Pais"/>
          </ns2:Pais>
        </tns6:Operacion>
        <tns6:Tarea>
          <ns5:CodigoTarea/>
        ...
        <xsl:for-each select="/ns0:InicioInteresesCobro/ns0:Header/param:ParameterType">
          <param:ParameterType>
            <param:parameterName>
