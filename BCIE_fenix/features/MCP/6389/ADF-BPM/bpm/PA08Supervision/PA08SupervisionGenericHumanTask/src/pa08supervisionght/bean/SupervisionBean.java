...
public class SupervisionBean extends FenixPanelBean  implements Serializable{
    
    @SuppressWarnings("compatibility:-4230839098475491971")
    private static final long serialVersionUID = 1L;
    
    public static final ADFLogger LOGGER = ADFLogger.createADFLogger(SupervisionBean.class);
