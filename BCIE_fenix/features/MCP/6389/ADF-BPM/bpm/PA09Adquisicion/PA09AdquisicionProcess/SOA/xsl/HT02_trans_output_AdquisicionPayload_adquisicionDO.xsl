...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [WED OCT 26 18:28:17 CDT 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:AdquisicionPayload>
      ...
      <ns0:ConfigGateways>
        ...
        <xsl:choose>
          <xsl:when test='oraext:compare-ignore-case ($execData/ns1:task/ns1:systemAttributes/ns1:outcome, "MASINFORMACION" ) = 0'>
            <ns0:requiereMasInfoAdquisicion>true</ns0:requiereMasInfoAdquisicion>
          </xsl:when>
          <xsl:otherwise>
            <ns0:requiereMasInfoAdquisicion>false</ns0:requiereMasInfoAdquisicion>
          </xsl:otherwise>
        </xsl:choose>
      ...
      <ns0:EquipoEjecucion>
        <ns0:abogado>
          <xsl:value-of select="$adquisicionDO/ns0:AdquisicionPayload/ns0:EquipoEjecucion/ns0:abogado"/>
        </ns0:abogado>
        <ns0:oficialAdquisicion>
          <xsl:value-of select="$execData/ns1:task/ns1:systemAttributes/ns1:updatedBy/ns1:id"/>
        </ns0:oficialAdquisicion>
        <ns0:analistaSupervision>
          <xsl:value-of select="$adquisicionDO/ns0:AdquisicionPayload/ns0:EquipoEjecucion/ns0:analistaSupervision"/>
        </ns0:analistaSupervision>
      </ns0:EquipoEjecucion>
