...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
    ...
    <oracle-xsl-mapper:schema>
        ...
        <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [WED OCT 26 18:29:28 CDT 2016].-->
    </oracle-xsl-mapper:schema>
    ...
    <xsl:template match="/">
        <ns0:AdquisicionPayload>
            <ns0:Header>
                ...
                <header:Tarea>
                    <ns5:CodigoTarea>195</ns5:CodigoTarea>
                    <ns5:NombreTarea>Revisar aspectos técnicos</ns5:NombreTarea>
                    <ns5:CodigoRol>49</ns5:CodigoRol>
                    <ns5:NombreRol>Analista Supervisión de Operaciones de Crédito</ns5:NombreRol>
                    <ns5:CodigoProceso>24</ns5:CodigoProceso>
                    <ns5:NombreProceso>Adquisición</ns5:NombreProceso>
                </header:Tarea>
                <header:Proceso>
                    <ns3:IdProceso>
