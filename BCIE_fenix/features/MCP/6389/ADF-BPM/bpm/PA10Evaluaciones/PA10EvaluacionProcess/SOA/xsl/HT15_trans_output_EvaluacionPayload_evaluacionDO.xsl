...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [THU NOV 17 11:00:25 CST 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:EvaluacionPayload>
      ...
      <ns0:EquipoEjecucionPayload>
        ...
        <ns0:AnalistaSupervision>
          <xsl:value-of select="$evaluacionDO/ns0:EvaluacionPayload/ns0:EquipoEjecucionPayload/ns0:AnalistaSupervision"/>
        </ns0:AnalistaSupervision>
        <ns0:ValidadorIBCIE>
