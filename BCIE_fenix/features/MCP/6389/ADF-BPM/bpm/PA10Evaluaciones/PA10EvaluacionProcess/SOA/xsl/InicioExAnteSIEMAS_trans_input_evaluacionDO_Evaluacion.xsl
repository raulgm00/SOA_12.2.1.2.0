...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [FRI NOV 18 21:01:08 CST 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:EvaluacionPayload>
      ...
      <ns0:Configuration>
        ...
        <ns0:requiereIBCIE>false</ns0:requiereIBCIE>
        <ns0:resultado>false</ns0:resultado>
        <ns0:tipoEvaluacion>
          <xsl:value-of select="'SIEMAS'"/>
        </ns0:tipoEvaluacion>
