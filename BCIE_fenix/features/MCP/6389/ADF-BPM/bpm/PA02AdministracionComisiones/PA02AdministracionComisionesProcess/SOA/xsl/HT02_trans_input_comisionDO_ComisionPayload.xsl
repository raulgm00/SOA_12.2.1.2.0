...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [FRI MAY 19 13:28:09 CDT 2017].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:ComisionPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns5:CodigoTarea>68</ns5:CodigoTarea>
          <ns5:NombreTarea>Validar Cambios Comisión</ns5:NombreTarea>
