...
public class ClasificacionAmbiental {
    ...
    /**
     * Cambio de estilo para tamaño de etiquetas
     * Seccion: Clasificacion Ambiental y Social Estrategica 140px a 300px
     * @author : Kruger
     * @Feature: 5003 
     * @version: v2.0
     * @Fecha  : 20/10/21
    ...
    private static final String CONTENT_STYLE_V2 = "width: 300px;white-space: -moz-pre-wrap;white-space: pre;white-space: pre-wrap;word-wrap: break-word;";
    ...
    public void valoresIniciales() {
        ...
        /**
         * Se Modificara la creacion de los catlogos 
         * Catalogo: Categoria
    ...
    public void vclSectorAmbiental(ValueChangeEvent valueChangeEvent) {
        logger.warning("\n=== Dentro de: vclSectorAmbiental: " + valueChangeEvent.getComponent().getId());
        ...
        if (!valor.matches("-NA-")) {
            ...
            String identificador = ID_SECTOR + index;
            idSector = getValorIDCmbComponenteAmbiental(obtenerComponente(ID_PANELCMP), identificador);
            logger.warning("\n===  vclSectorAmbiental | Valor: " + valor + " | idSoc: " + idSoc + " | idSector: " +
                           idSector);
            //Pasar valor
            logger.warning("\n=== Pasar valor idSector a Row de ClasificacionAmbientalVOIterator");
            //setValorClasificacionAmbientalVOIterator(1, idSector, index - 1);
        } else {
            logger.warning("\n=== Dentro de vclSectorAmbiental - valor nulo ===");
        }
    ...
    public void vclAporteAmbiental(ValueChangeEvent valueChangeEvent) {
        ...
        if (!valor.matches("-NA-")) {
            ...
            logger.warning("\n===  vclAporteAmbiental | Valor: " + valor + " | idSoc: " + idSoc + " | idAporte: " +
                           idAporte);
            //Pasar valor
            logger.warning("\n=== Pasar valor idAporte a Row de ClasificacionAmbientalVOIterator");
           // setValorClasificacionAmbientalVOIterator(2, idAporte, index - 1);
    ...
    public void vclCategoriaAmbiental(ValueChangeEvent valueChangeEvent) {
        ...
        RichSelectOneChoice soc = (RichSelectOneChoice) valueChangeEvent.getComponent();
        String idSoc = soc.getId();
        logger.warning("idSoc = " + idSoc);
        // Actualiza valor seleccionado en combo
        valueChangeEvent.getComponent().processUpdates(FacesContext.getCurrentInstance()); 
        //Valor del componente en numero
        String valor = valueChangeEvent.getNewValue() != null ? valueChangeEvent.getNewValue().toString() : "-NA-";
        ...
        if (!valor.matches("-NA-")) {
            ...
            logger.warning("\n===  vclCategoriaAmbiental | Valor: " + valor + " | idSoc: " + idSoc + " | idCategoria: " + idCategoria);
            //Pasar valor
            logger.warning("\n=== Pasar valor idCategoria a Row de ClasificacionAmbientalVOIterator");
           // setValorClasificacionAmbientalVOIterator(3, idCategoria, index - 1);
            // Filtrar Categoria
    ...
    public void vclSubcategoriaAmbiental(ValueChangeEvent valueChangeEvent) {
        logger.warning("\n=== Dentro de vclSubcategoriaAmbiental: " + valueChangeEvent.getComponent().getId());
        ...
        if (!valor.matches("-NA-")) {
            //ObtenerID
            int index = obtenerIndice(idSoc);
            idSubcategoria = Integer.parseInt(getValorTxtCategoria(obtenerComponente(ID_PANELGRAL), index));
            logger.warning("\n===  vclSubcategoriaAmbiental | Valor: " + valor + " | idSoc: " + idSoc +
                           " | idSubcategoria: " + idSubcategoria);
            //Pasar valor
            logger.warning("\n=== Pasar valor idSubcategoria a Row de ClasificacionAmbientalVOIterator");
            //setValorClasificacionAmbientalVOIterator(4, idSubcategoria, index - 1);
        } else {
            logger.warning("\n=== Dentro de: vclCategoriaAmbiental - valor nulo ===");
        }
    ...
    public void crearComponente(int index) {
        ...
        /**
         * Se Modificara la creacion de los catlogos por valores por default NA, para ser mostrados en el detalle de la OP
         * Catalogo: Categoria
         * @author : Kruger
         * @Feature: 5003 
         * @version: v2.0
    ...
    public UIComponent crearSector(int index) {
        ...
        //Llenado de combo SectorAmbiental
    ...
    public UIComponent crearAporte(int index) {
        ...
        richSelectOneChoice.setContentStyle(CONTENT_STYLE_V1);
        /**
         * Se elimina la dependencia en cascada
         * Catalogo: Categoria
         * Catalogo: SubCategoria
         * @author : Kruger
         * @Feature: 5003 
         ...
         * @Step   : 3
         **/
        //Bloqueamos el valuechangelistener para que no borre los valores
        //richSelectOneChoice.addValueChangeListener(resolveValueChangeListener("#{viewScope.clasificacionAmbiental.vclAporteAmbiental}"));
        //Add items
        UISelectItems selectItems = new UISelectItems();
        selectItems.setId(ID_SI_APORTE + index);
        //Llenado de combo Aporte Ambieental
    ...
    public UIComponent crearCategoria(int index) {
        ...
        richSelectOneChoice.setAutoSubmit(true);
        /**
         * Se Modificara la obligatoriedad false(apagada) / true (prendida) 
         * Catalogo: Categoria
         * Catalogo: SubCategoria
         * @author : Kruger
         * @Feature: 5003 
         ...
         * @Step   : 3.1
         **/
        richSelectOneChoice.setShowRequired(false);
        ...
        richSelectOneChoice.addValueChangeListener(resolveValueChangeListener("#{viewScope.clasificacionAmbiental.vclCategoriaAmbiental}"));
        //Add items
        UISelectItems selectItems = new UISelectItems();
        selectItems.setId(ID_SI_CATEGORIA + index);
        //Filtrado de catalogo Categoria id =1
        filtrarCategoriaAmbiental(1);
        //Llenado de combo SectorAMbiental
        selectItems.setValue( cmbCategoriaAmbiental() );
        richSelectOneChoice.getChildren().add(selectItems);
        /**
         * Asignacion de valor NA, para que en la vista del Detalle de la OP aparesca el valor por default
         * Catalogo: Categoria
         * ID = 6 - NA (validar valor de catalogo) / en su defecto 0 = vacio (query de VO)
         * @author : Kruger
         * @Feature: 5003 
         * @version: v2.0
         * @Fecha  : 20/10/21
        ...
        //Ocultar componente selectOneChoise
        richSelectOneChoice.setVisible(false);
        //Add PanelGroupLayout
        RichPanelGroupLayout richPanelGroupLayout = new RichPanelGroupLayout();
        richPanelGroupLayout.setLayout(LAYOUT_H);
    ...
    public UIComponent crearSubCategoria(int index) {
        ...
        * Se Modificara la obligatoriedad false(apagada) / true (prendida) 
        ...
        //Filtrado de Subcategoria por id de Categoria
        filtrarSubCategoriaAmbiental(6);
        selectItems.setValue(cmbSubCategoriaAmbiental());
        richSelectOneChoice.getChildren().add(selectItems);
        /**
         * Asignacion de valor NA, para que en la vista del Detalle de la OP aparesca el valor por default
         * Catalogo: SubCategoria
         * ID = 33 - NA (validar valor de catalogo - tomar la primera ocurrencia) / en su defecto 0 = vacio (query de VO)
         * @author : Kruger
         * @Feature: 5003 
         * @version: v2.0
         * @Fecha  : 20/10/21
    ...
    public UIComponent botonEliminar(int index) {
        ...
        richButton.setText(getValueFromResourceBundle(BUNDLE, "ELIMINAR_COMPONENTE"));
        richButton.setVisible(true);
        richButton.setImmediate(true);
        richButton.addActionListener(getActionListener("#{viewScope.clasificacionAmbiental.eliminarComponenteCA}"));
        return richButton;
    }
    ...
    private void filtrarCategoriaAmbiental(int idAporte) {
        ...
        logger.warning("=============== filtrarCategoriaAmbiental | idAporte:" + idAporte);
        ...
        logger.warning("=============== Saliendo de filtrarCategoriaAmbiental");
    }
    ...
    private void filtrarSubCategoriaAmbiental(int idCategoria) {
        ...
        logger.warning("=============== filtrarSubCategoriaAmbiental | idCategoria:" + idCategoria);
        BindingContainer bindings = ADFUtils.getBindingContainer();
        ...
        // Ejecutamos query en iterador (puesto que cambió el parámetro del Where))
        tcaSubCategoriaAmbiental = ADFUtils.getDCBindingContainer().findIteratorBinding("TcaSubcategoriaAmbientalVOIterator");
