...
public interface FenixPrepagoAM extends ApplicationModule {
    ...
    Map<String, Object> generarAviso(List<Documento> documentos);

    Map<String, Object> consultarGenerarAviso(Long idPrepago);

    Map<String, Object> obtenerMoraCliente(Long idOperacion);
}
