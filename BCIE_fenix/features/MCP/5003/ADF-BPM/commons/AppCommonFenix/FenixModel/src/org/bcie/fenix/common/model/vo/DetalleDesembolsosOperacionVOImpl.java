...
public class DetalleDesembolsosOperacionVOImpl extends ViewObjectImpl implements DetalleDesembolsosOperacionVO {
        ...
        try{
            if(operacion.getMontoOperacion() != null){
                ...
                for (MontoOperacion montoOperacion : operacion.getMontoOperacion().getMontoOperacion()) {
                    ...
                    if(montoOperacion.getIdTcaTipoMonto() == FenixModelConstants.TIPO_MONTO_DISPONIBLE_DESEMBOLSO && montoOperacion.getIdTcaTipoMonto() != null){
                        rowOperacion.setAttribute(DetalleDesembolsosOperacionVORowImpl.MONTODESEMBOLSAR, montoOperacion.getMonto());       
    ...
    public void recargarRegistroDetalleOperacion(Map datosDetalleOperacionMap){
        ...
        if(null == datosDetalleOperacionMap || (datosDetalleOperacionMap.size()<=0) || datosDetalleOperacionMap.isEmpty()){
