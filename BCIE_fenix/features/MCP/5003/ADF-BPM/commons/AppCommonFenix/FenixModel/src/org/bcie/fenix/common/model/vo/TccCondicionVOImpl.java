...
public class TccCondicionVOImpl extends ViewObjectImpl implements TccCondicionVO {
    ...
    public Long crearCondicionEnmendada(Number idTcc, Integer idTcaEstadoTcc, Integer idTcaSubEstadoTcc) {
        ...
        // Creamos una nueva Condición Enmendada en base al idTcc enviado (debe ser un clon de él)
        ...
        // Regresamos el id de la Condición Enmendada
...
//                }
                ...
                if(null != iter){
                    ...
                    while(iter.hasNext()){
                        ...
                        if(null != categoriaRow.getId()){
                            logger.warning("IdCategoría: " + categoriaRow.getId());
    ...
    public void eliminarCondicionActual() {
        ...
        try {
            ...
            logger.log(ADFLogger.ERROR, "Error al eliminar la Condición actual: " + ex.getMessage());
