    ...
    public String aceptarFinalizarTarea() {
        ...
        switch (codigoTarea) {
            ...
            case FenixConstants.PA12_INGRESAR_SOLICITUD_PREPAGO_145:
                logger.fine("PA12_INGRESAR_SOLICITUD_PREPAGO");
                logger.warning("Ingresar solicitud de prepago");
                Long idPrepago = this.insertarPrepago();
...
//            }*/ 
    ...
    private Boolean validaFinalizaCamposRequeridos() {
        ...
        idTcaTipoMoneda = ADFUtils.findControlBinding("IdTcaTipoMoneda");
        ...
        idTcaTipoMonedaInt = (Integer) idTcaTipoMoneda.getInputValue();
        ...
        logger.warning("idTcaTipoMoneda: "+ idTcaTipoMoneda.getInputValue());
