...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [THU JUN 09 16:45:30 CDT 2016].-->
  </oracle-xsl-mapper:schema>
    ...
    <tns:task>
      <tns:systemMessageAttributes>
        <tns:protectedTextAttribute1>
          <xsl:value-of select="string (/ns0:SegCrediticioPayload/ns0:Header/header:Cliente/ns4:IdCliente )"/>
        </tns:protectedTextAttribute1>
      </tns:systemMessageAttributes>
    </tns:task>
  </xsl:template>
