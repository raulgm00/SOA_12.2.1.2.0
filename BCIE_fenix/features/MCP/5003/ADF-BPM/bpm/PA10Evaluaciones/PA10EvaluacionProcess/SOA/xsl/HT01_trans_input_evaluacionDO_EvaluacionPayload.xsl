...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [WED NOV 16 10:12:21 CST 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:EvaluacionPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns5:CodigoTarea>33</ns5:CodigoTarea>
          <ns5:NombreTarea>Generar Cuestionarios</ns5:NombreTarea>
          <ns5:CodigoRol>1</ns5:CodigoRol>
          <ns5:NombreRol>Responsable de Operación</ns5:NombreRol>
          <ns5:CodigoProceso>6</ns5:CodigoProceso>
      ...
      <ns0:Configuration>
        <ns0:requiereSIEMAS>true</ns0:requiereSIEMAS>
        <ns0:requiereIBCIE>true</ns0:requiereIBCIE>
        <ns0:tipoEvaluacion>
