...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [TUE MAY 11 18:17:46 CST 2021].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns1:LeccionesAprendidasPayload>
      ...
      <ns1:EquipoEjecucionPayload>
        <ns1:UsuarioInicio>
          <xsl:value-of select="$leccionesAprendidasDO/ns1:LeccionesAprendidasPayload/ns1:EquipoPayload/ns1:UsuarioInicio"/>
        </ns1:UsuarioInicio>
        <ns1:EmisorOpinion>
          <xsl:value-of select="/ns0:task/ns0:systemAttributes/ns0:updatedBy/ns0:id"/>
        </ns1:EmisorOpinion>
        <ns1:RevisorResultados>
          <xsl:value-of select="$leccionesAprendidasDO/ns1:LeccionesAprendidasPayload/ns1:EquipoEjecucionPayload/ns1:RevisorResultados"/>
        </ns1:RevisorResultados>
        <ns1:GerenteCredito>
