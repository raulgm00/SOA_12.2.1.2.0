  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:param name="excepcionDO"/>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [WED MAR 09 19:28:24 CST 2016].-->
  </oracle-xsl-mapper:schema>
    ...
    <tns:FinAnalisis>
      <tns:Header>
        ...
        <parameter:ParameterType>
          ...
          <parameter:parameterValue>PA05</parameter:parameterValue>
        </parameter:ParameterType>
        <parameter:ParameterType>
          <parameter:parameterName>TIPO_SOLICITUD</parameter:parameterName>
          <parameter:parameterValue>0</parameter:parameterValue>
        </parameter:ParameterType>
      </tns:Header>
      <tns:equipoTrabajo>
        <eqTr:equipoTrabajo>
