...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [THU SEP 17 13:42:38 CDT 2015].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:AnalisisPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns2:CodigoTarea>23</ns2:CodigoTarea>
          <ns2:NombreTarea>Evaluar Acción a Seguir</ns2:NombreTarea>
      ...
      <xsl:if test="/ns0:AnalisisPayload/ns0:ValorSCR">
        <ns0:ValorSCR>
          <xsl:value-of select="/ns0:AnalisisPayload/ns0:ValorSCR"/>
        </ns0:ValorSCR>
      </xsl:if>
      <xsl:if test="/ns0:AnalisisPayload/ns0:CodigoSCR">
        <ns0:CodigoSCR>
