...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [WED OCT 26 18:30:06 CDT 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:AdquisicionPayload>
      ...
      <ns0:EquipoEjecucion>
        ...
        <ns0:oficialAdquisicion>
          <xsl:value-of select="$adquisicionDO/ns0:AdquisicionPayload/ns0:EquipoEjecucion/ns0:oficialAdquisicion"/>
        </ns0:oficialAdquisicion>
        <ns0:analistaSupervision>
