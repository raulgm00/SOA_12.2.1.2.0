function clicLista(){
console.log('Entra en clicLista');
if(esChrome() || esOperaNav()){
console.log('Entra en if de validacion de navegador');

console.log('Id input component : ' + document.getElementById('pageTemplateID:t1:1:iclov1::lovIconId'));
var test = document.getElementById('pageTemplateID:t1:1:iclov1::lovIconId');
console.log('test : \n');
console.log(test);
...
function configurarSolucionInputLista(elemento) {
    ...
    if (mostrarDebajoCajaFecha) {
        posicionTop = posicionAbsoluta.top + 15;
    }
    else {
