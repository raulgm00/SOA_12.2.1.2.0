...
<xsl:stylesheet version="1.0" xmlns:ns0="http://xmlns.bcie.org/ObjetoProceso/LAFT/Payload/V1"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [TUE AUG 22 17:38:56 CDT 2017].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <tns:CrearBitacoraRequest>
      <tns:BitacoraInput>
        ...
        <regBitBO:idProceso>7</regBitBO:idProceso>
        <regBitBO:nombreProceso>PA01</regBitBO:nombreProceso>
        <regBitBO:instanciaProceso>
          <xsl:value-of select="/ns0:LAFTPayload/ns0:Header/header:Proceso/ns3:InstanciaProceso"/>
        </regBitBO:instanciaProceso>
        <regBitBO:esProceso>true</regBitBO:esProceso>
        <regBitBO:usuario>
          <xsl:value-of select="/ns0:LAFTPayload/ns0:Header/header:Operacion/ns2:ResponsableOperacion"/>
        </regBitBO:usuario>
