...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [FRI SEP 18 10:19:15 CDT 2015].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:EvaluacionPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns2:CodigoTarea>33</ns2:CodigoTarea>
          <ns2:NombreTarea>Generar Cuestionarios</ns2:NombreTarea>
          <ns2:CodigoRol>1</ns2:CodigoRol>
          <ns2:NombreRol>Responsable de Operación</ns2:NombreRol>
          <ns2:CodigoProceso>6</ns2:CodigoProceso>
          <ns2:NombreProceso>Evaluación</ns2:NombreProceso>
        </header:Tarea>
      ...
      <ns0:Configuration><ns0:requiereSIEMAS>true</ns0:requiereSIEMAS>/&gt;<ns0:requiereIBCIE>true</ns0:requiereIBCIE>/&gt;<ns0:requiereModificarSIEMAS/><ns0:requiereModificarIBCIE/><ns0:retorno/><ns0:resultado/><ns0:tipoEvaluacion/></ns0:Configuration>
      <ns0:EquipoPayload>
        <ns0:AnalistaAED>
