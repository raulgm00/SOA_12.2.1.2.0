...
declare function local:func($InicioCancelarOperacion as element() (:: schema-element(ns1:InicioCancelarOperacion) ::)) as element() (:: schema-element(ns2:requestValidarOperacionProceso) ::) {
    <ns2:requestValidarOperacionProceso>
        <ns2:ValidarProcesoOperacionInput>
            ...
            <val:idProceso>11</val:idProceso>
        </ns2:ValidarProcesoOperacionInput>
    </ns2:requestValidarOperacionProceso>
};
