...
declare namespace apr="http://xmlns.oracle.com/bpmn/bpmnProcess/AprobacionProcess";
(:: import schema at "oramds:/apps/Resources/BPM/Schema/PC04/AprobacionProcess.xsd" ::)
...
declare function local:funcInicioaprobacion_request($OutConsultar.response as element() (:: schema-element(ope:ConsultarOperacionResponse) ::), 
                                                    ...
                                                    as element() (:: schema-element(apr:InicioAprobacion) ::) {
    <apr:InicioAprobacion>
        <apr:Header>
            <ns1:Operacion>
            ...
            <ns1:Tarea>
                ...
                <ns3:NombreProceso>PC04</ns3:NombreProceso>
            </ns1:Tarea>
            {
...
local:funcInicioaprobacion_request($OutConsultar.response, $outConsultarParametrosEnBitacora.response)
