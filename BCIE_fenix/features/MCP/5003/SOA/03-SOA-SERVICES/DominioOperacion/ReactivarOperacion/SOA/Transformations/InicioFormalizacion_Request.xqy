...
declare namespace for="http://xmlns.oracle.com/bpmn/bpmnProcess/FormalizacionProcess";
(:: import schema at "oramds:/apps/Resources/BPM/Schema/PC05/FormalizacionProcess.xsd" ::)
...
declare function local:funcInicioformalizacion_request($OutConsultar.response as element() (:: schema-element(ope:ConsultarOperacionResponse) ::), 
                                                       ...
                                                       as element() (:: schema-element(for:InicioFormalizacion) ::) {
    <for:InicioFormalizacion>
        <for:Header>
            <ns1:Operacion>
            ...
            <ns1:Tarea>
                ...
                <ns3:CodigoProceso>5</ns3:CodigoProceso>
                <ns3:NombreProceso>PC05</ns3:NombreProceso>
            </ns1:Tarea>
            {
...
local:funcInicioformalizacion_request($OutConsultar.response, $outConsultarParametrosEnBitacora.response)
