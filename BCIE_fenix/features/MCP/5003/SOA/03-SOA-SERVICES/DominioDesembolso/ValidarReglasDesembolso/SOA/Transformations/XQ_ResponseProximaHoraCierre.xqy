...
declare function local:funcXq_responseproximahoracierre($inputVariable.request as element() (:: schema-element(des:ValidarReglasDesembolsoRequest) ::)) as element() (:: schema-element(des:ValidarReglasDesembolsoResponse) ::) {
    <des:ValidarReglasDesembolsoResponse>
        <des:TareaReglas>
            ...
            <reg:Estatus></reg:Estatus>
            {
                ...
                where $ReglasEvaluacion/reg1:Transaccion = 'PROXIMA_HORA_CIERRE_MONEDA'
                return 
...
local:funcXq_responseproximahoracierre($inputVariable.request)
