...
declare function local:func($FinAprobacion as element() (:: schema-element(ns1:FinAprobacion) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            <cre:idOperacion>{fn:data($FinAprobacion/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($FinAprobacion/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            <cre:idProceso>4</cre:idProceso>
            <cre:nombreProceso>PC04</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinAprobacion/ns1:Header/ns3:Proceso/ns6:InstanciaProceso)}</cre:instanciaProceso>
            ...
            <cre:usuario>{fn:data($FinAprobacion/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
