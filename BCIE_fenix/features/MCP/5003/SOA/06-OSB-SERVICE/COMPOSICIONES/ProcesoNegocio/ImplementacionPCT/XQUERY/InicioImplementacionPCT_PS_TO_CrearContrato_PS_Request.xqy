...
declare function local:func($InicioImplementacionPCT as element() (:: schema-element(ns1:InicioImplementacionPCT) ::)) as element() (:: schema-element(ns2:CrearContratoRequest) ::) {
    <ns2:CrearContratoRequest>
        <ns2:Contrato>
            <con:idOperacion>{fn:data($InicioImplementacionPCT/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</con:idOperacion>
        </ns2:Contrato>
    </ns2:CrearContratoRequest>
};
