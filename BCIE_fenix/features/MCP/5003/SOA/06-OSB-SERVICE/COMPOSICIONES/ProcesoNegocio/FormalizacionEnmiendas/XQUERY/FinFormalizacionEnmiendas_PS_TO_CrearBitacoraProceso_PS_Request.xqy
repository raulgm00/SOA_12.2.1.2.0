...
declare variable $FinFormalizacionEnmiendas as element() (:: schema-element(ns1:FinFormalizacionEnmiendas) ::) external;
declare variable $estadoFormalizacion as xs:normalizedString external;

declare function local:func($FinFormalizacionEnmiendas as element() (:: schema-element(ns1:FinFormalizacionEnmiendas) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            <cre:id></cre:id>
            <cre:idOperacion>{fn:data($FinFormalizacionEnmiendas/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($FinFormalizacionEnmiendas/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            <cre:idProceso>36</cre:idProceso>
            <cre:nombreProceso>Formalización de Enmiendas</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinFormalizacionEnmiendas/ns1:Header/ns3:Proceso/ns5:InstanciaProceso)}</cre:instanciaProceso>
            <cre:idProcesoSiguiente></cre:idProcesoSiguiente>
            <cre:esProceso>{fn:true()}</cre:esProceso>
            <cre:idTarea></cre:idTarea>
            <cre:nombreTarea>Fin Formalización Enmiendas</cre:nombreTarea>
            <cre:instanciaTarea></cre:instanciaTarea>
            <cre:usuario>{fn:data($FinFormalizacionEnmiendas/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
            ...
            <cre:string01>{$estadoFormalizacion}</cre:string01>
...
local:func($FinFormalizacionEnmiendas)