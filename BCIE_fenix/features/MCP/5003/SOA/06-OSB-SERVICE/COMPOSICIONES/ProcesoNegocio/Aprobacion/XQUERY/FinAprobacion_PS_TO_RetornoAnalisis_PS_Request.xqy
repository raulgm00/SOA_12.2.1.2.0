...
declare function local:func($FinAprobacion as element() (:: schema-element(ns1:FinAprobacion) ::)) as element() (:: schema-element(ns2:InicioAnalisis) ::) {
    <ns2:InicioAnalisis>
        <ns2:Header>
            <ns3:Operacion>
            ...
            <ns6:ParameterType>
                <ns6:parameterName>RETORNOAPROBACION</ns6:parameterName>
