...
declare function local:func($FinCondiciones as element() (:: schema-element(ns1:FinCondiciones) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            <cre:idOperacion>{fn:data($FinCondiciones/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($FinCondiciones/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            <cre:idProceso>9</cre:idProceso>
            <cre:nombreProceso>PA03</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinCondiciones/ns1:Header/ns3:Proceso/ns5:InstanciaProceso)}</cre:instanciaProceso>
            ...
            <cre:usuario>{fn:data($FinCondiciones/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
