...
declare namespace ns3="http://xmlns.oracle.com/pcbpel/adapter/db/ConsultarDesembolsosConfiguracionById";
...
declare function local:func($responseMapeoErrorMessage as element() (:: schema-element(ns1:responseMapeoErrorMessage) ::),$message as xs:string) as element() (:: schema-element(ns2:ConsultarDesembolsosConfiguracionByIdResponse) ::) {
