...
declare function local:func($responseMapeoErrorMessage as element() (:: schema-element(ns1:responseMapeoErrorMessage) ::),$message as xs:string) as element() (:: schema-element(ns2:ConsultarCargoComisionResponse) ::) {
    <ns2:ConsultarCargoComisionResponse>
        <ns2:Resultado>
