      ...
      return
        <ns1:clienteContrato>
            ...
            <con:LineaCredito>
                ...
                {
                    if ($linea/lin:DescripcionCortaMoneda)
                    then <lin:DescripcionCortaMoneda>{fn:data($linea/lin:DescripcionCortaMoneda)}</lin:DescripcionCortaMoneda>
                    else ()
                }
                {
                    if ($linea/lin:DescripcionMoneda)
                    then <lin:DescripcionMoneda>{fn:data($linea/lin:DescripcionMoneda)}</lin:DescripcionMoneda>
                    else ()
                }
