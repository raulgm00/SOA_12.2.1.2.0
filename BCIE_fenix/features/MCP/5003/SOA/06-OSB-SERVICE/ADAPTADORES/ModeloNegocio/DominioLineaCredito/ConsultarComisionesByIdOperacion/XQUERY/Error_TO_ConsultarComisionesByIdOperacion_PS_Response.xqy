...
declare function local:func($message as xs:string,$responseMapeoErrorMessage as element() (:: schema-element(ns2:responseMapeoErrorMessage) ::)) as element() (:: schema-element(ns1:ConsultarComisionesByIdOperacionResponse) ::) {
