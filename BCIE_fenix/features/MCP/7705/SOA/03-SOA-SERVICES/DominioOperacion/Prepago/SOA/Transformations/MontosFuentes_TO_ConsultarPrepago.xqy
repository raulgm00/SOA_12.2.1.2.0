...
declare function local:funcMontosfuentes_to_consultarprepago($MontosFuentes.ExtraerReportePrepagoResponse as element() (:: schema-element(pre:ExtraerReportePrepagoResponse) ::), 
           ...
           return
            <pre1:Cargo>
                ...
                <pre1:Monto>
                    ...
                    <com:importe>{if (fn:data($cargo[$monto/com:tipo/cat:Descripcion = 'OTROS_CARGOS']/pre1:Rol/cat:Id)= 21) then 0 else $monto/com:importe}</com:importe>
                    <com:moneda>
                        <cat:DescripcionCorta>{fn:data($monto/com:moneda/cat:DescripcionCorta)}</cat:DescripcionCorta>
                    </com:moneda>
                </pre1:Monto>
                ...
                <pre1:Monto>
                    ...
                    <com:importe>{
                    fn:sum
                    (for $monto in $MontosFuentes.ExtraerReportePrepagoResponse/pre:Reporte/pre1:Penalidad/pre1:Monto/com:importe
                     return $monto)
                    }
                    </com:importe>
                    <com:moneda>
...
local:funcMontosfuentes_to_consultarprepago($MontosFuentes.ExtraerReportePrepagoResponse, $outInvokeConsultarPrepago.ConsultarPrepagoResponse)
