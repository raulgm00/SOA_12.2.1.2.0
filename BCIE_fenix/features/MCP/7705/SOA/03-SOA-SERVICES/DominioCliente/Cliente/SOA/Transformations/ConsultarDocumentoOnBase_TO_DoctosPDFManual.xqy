    ...
    <doc:ConsultaDocumentosResponse>
        <doc:Documentos>
                <doc1:etapa>
                        <doc1:tipoDocumento>
                          {
                          for $documentoPDF in $outInvokeConsultarDocumentosOnBase.response/doc:Documentos/doc1:etapa/doc1:tipoDocumento/doc1:documento[doc1:mime_type = 'application/pdf'][doc1:idFlujoNegocio = fn:data($inputVariable.request/cli:idFlujo)]
                            return 
