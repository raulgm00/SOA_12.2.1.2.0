...
declare function local:funcXq_responsemora($inputVariable.request as element() (:: schema-element(des:ValidarReglasDesembolsoRequest) ::)) as element() (:: schema-element(des:ValidarReglasDesembolsoResponse) ::) {
    <des:ValidarReglasDesembolsoResponse>
        <des:TareaReglas>
            ...
            <reg:Estatus></reg:Estatus>
            {
                ...
                where $ReglasEvaluacion/reg1:Transaccion = 'MORA'
                return 
...
local:funcXq_responsemora($inputVariable.request)
