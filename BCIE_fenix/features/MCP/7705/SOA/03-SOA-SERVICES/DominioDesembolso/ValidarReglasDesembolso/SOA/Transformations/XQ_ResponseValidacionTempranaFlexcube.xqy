...
declare function local:funcXq_responsevalidaciontempranaflexcube($inputVariable.request as element() (:: schema-element(des:ValidarReglasDesembolsoRequest) ::)) as element() (:: schema-element(des:ValidarReglasDesembolsoResponse) ::) {
    <des:ValidarReglasDesembolsoResponse>
        <des:TareaReglas>
            ...
            <reg:Estatus></reg:Estatus>
            {
                ...
                where $ReglasEvaluacion/reg1:Transaccion = 'VALIDACION_TEMPRANA_FLEXCUBE'
                return 
...
local:funcXq_responsevalidaciontempranaflexcube($inputVariable.request)
