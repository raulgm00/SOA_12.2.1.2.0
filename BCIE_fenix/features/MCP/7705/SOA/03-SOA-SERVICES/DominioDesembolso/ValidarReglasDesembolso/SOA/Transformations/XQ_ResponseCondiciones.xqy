...
declare function local:funcXq_responsecondiciones($inputVariable.request as element() (:: schema-element(des:ValidarReglasDesembolsoRequest) ::)) as element() (:: schema-element(des:ValidarReglasDesembolsoResponse) ::) {
    <des:ValidarReglasDesembolsoResponse>
        <des:TareaReglas>
            ...
            <reg:Estatus></reg:Estatus>
            {
                ...
                where $ReglasEvaluacion/reg1:Transaccion = 'CONDICIONES'
                return 
...
local:funcXq_responsecondiciones($inputVariable.request)
