...
declare function local:funcXq_responselimiteglobal($inputVariable.request as element() (:: schema-element(des:ValidarReglasDesembolsoRequest) ::)) as element() (:: schema-element(des:ValidarReglasDesembolsoResponse) ::) {
    <des:ValidarReglasDesembolsoResponse>
        <des:TareaReglas>
            ...
            <reg:Estatus></reg:Estatus>
            {
                ...
                where $ReglasEvaluacion/reg1:Transaccion = 'LIMITE_GLOBAL'
                return 
...
local:funcXq_responselimiteglobal($inputVariable.request)
