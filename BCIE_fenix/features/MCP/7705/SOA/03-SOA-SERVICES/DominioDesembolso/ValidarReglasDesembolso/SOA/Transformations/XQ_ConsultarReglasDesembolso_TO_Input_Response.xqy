...
declare function local:funcXq_consultarreglasdesembolso_to_input_response($inputVariable.request as element() (:: schema-element(des:ValidarReglasDesembolsoRequest) ::), 
    ...
    <des:ValidarReglasDesembolsoRequest>
        ...
        <des:TareaReglas>
            ...
            }
            {
                ...
                let $reglasDesembolso := $outConsultarReglasDesembolso.response/des:ReglasEvaluacion[reg1:Id = $ReglasEvaluacion/reg1:Id]
                return 
                <reg:ReglasEvaluacion>
                    ...
                    }
                    {
                        ...
                        then <reg1:FechaExcepcion>{fn:data($reglasDesembolso/reg1:FechaExcepcion)}</reg1:FechaExcepcion>
                        else ()
                    }
                    <reg1:Estado>
...
local:funcXq_consultarreglasdesembolso_to_input_response($inputVariable.request, $outConsultarReglasDesembolso.response)
