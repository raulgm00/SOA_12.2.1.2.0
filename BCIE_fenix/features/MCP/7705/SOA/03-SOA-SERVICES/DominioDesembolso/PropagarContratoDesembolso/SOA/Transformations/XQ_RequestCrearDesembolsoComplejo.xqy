...
declare function local:funcXq_requestcreardesembolsocomplejo($outConsultarInformacionDesembolso.response as element() (:: schema-element(des:ConsultarInformacionReglasByIdResponse) ::), 
                                                             ...
                                                             as element() (:: schema-element(des:CrearDesembolsoComplejoFLEXCUBERequest) ::) {
    <des:CrearDesembolsoComplejoFLEXCUBERequest>
        <des:Cliente>
...
local:funcXq_requestcreardesembolsocomplejo($outConsultarInformacionDesembolso.response, $outConsultarLineaCreditoById.ConsultarLineaCreditoByIdResponse, $outConsultarDesembolsoById.response)
