...
declare function local:funcConsultaratributosusuariocc_to_enviarcorreoelectronico($outInvoke_ConsultarAtributosUsuarioCC.response as element() (:: schema-element(usu:ConsultarAtributosUsuarioResponse) ::)) as element() (:: schema-element(cor:EnviarCorreoElectronicoBPELRequest) ::) {
...
local:funcConsultaratributosusuariocc_to_enviarcorreoelectronico($outInvoke_ConsultarAtributosUsuarioCC.response)
