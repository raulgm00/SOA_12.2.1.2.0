...
declare function local:funcRequestenviarcorreobytareasusp1($inputVariable.request as element() (:: schema-element(not:requestNotificarCancelarOperacion) ::), 
    ...
    <cor:EnviarCorreoElectronicoBPELRequest>
        <cor:correoElectronico>
            <cor1:to>
           {
            ...
            <cor1:id_plantilla>39</cor1:id_plantilla>
...
local:funcRequestenviarcorreobytareasusp1($inputVariable.request, $outConsultarTareasActivas.response)
