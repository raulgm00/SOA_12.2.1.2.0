         ...
         <lin:clienteContrato>
          ...
          return
            <con:LineaCredito>
                ...
                {
                    if ($linea/lin1:DescripcionCortaMoneda)
                    then <lin1:DescripcionCortaMoneda>{fn:data($linea/lin1:DescripcionCortaMoneda)}</lin1:DescripcionCortaMoneda>
                    else ()
                }
                {
                    if ($linea/lin1:DescripcionMoneda)
                    then <lin1:DescripcionMoneda>{fn:data($linea/lin1:DescripcionMoneda)}</lin1:DescripcionMoneda>
                    else ()
                }
