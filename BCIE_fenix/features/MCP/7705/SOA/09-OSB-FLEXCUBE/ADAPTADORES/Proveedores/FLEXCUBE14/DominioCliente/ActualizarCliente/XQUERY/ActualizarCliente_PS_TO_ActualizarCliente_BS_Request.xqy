...
declare variable $ClienteRequest as element() (:: schema-element(ns1:ActualizarClienteRequest) ::) external;

declare function local:func($ClienteRequest as element() (:: schema-element(ns1:ActualizarClienteRequest) ::)) as element() (:: schema-element(ns2:InputParameters) ::) {
    <ns2:InputParameters>
<ns2:PRECCLIENTE>
            {
