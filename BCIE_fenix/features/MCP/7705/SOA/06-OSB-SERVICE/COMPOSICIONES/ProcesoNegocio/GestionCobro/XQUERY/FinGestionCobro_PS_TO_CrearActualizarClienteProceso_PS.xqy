...
declare function local:func($FinGestionCobro as element() (:: schema-element(ns1:FinGestionCobro) ::)) as element() (:: schema-element(ns2:CrearActualizarClienteProcesoRequest) ::) {
