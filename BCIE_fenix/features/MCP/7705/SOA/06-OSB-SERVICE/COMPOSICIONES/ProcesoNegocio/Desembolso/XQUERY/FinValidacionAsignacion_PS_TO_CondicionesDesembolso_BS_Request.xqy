...
declare function local:func($FinValidacionAsignacion as element() (:: schema-element(ns1:FinValidacionAsignacion) ::)) as element() (:: schema-element(ns2:CondicionesDesembolsoRequest) ::) {
    <ns2:CondicionesDesembolsoRequest>
