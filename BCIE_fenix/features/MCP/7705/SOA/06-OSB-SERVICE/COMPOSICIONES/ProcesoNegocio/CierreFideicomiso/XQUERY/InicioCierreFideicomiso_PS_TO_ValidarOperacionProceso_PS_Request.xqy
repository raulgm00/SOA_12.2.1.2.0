...
declare variable $InicioCancelarOperacion as element() (:: schema-element(ns1:InicioCierreFideicomiso) ::) external;

declare function local:func($InicioCancelarOperacion as element() (:: schema-element(ns1:InicioCierreFideicomiso) ::)) as element() (:: schema-element(ns2:requestValidarOperacionProceso) ::) {
    <ns2:requestValidarOperacionProceso>
        <ns2:ValidarProcesoOperacionInput>
            <val:idOperacion>{fn:data($InicioCancelarOperacion/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</val:idOperacion>
            <val:idProceso>28</val:idProceso>
        </ns2:ValidarProcesoOperacionInput>
    </ns2:requestValidarOperacionProceso>
};
