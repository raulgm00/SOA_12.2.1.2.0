...
declare variable $InicioImplenetacionPCT as element() (:: schema-element(ns1:InicioImplementacionPCT) ::) external;

declare function local:func($InicioImplenetacionPCT as element() (:: schema-element(ns1:InicioImplementacionPCT) ::)) as element() (:: schema-element(ns2:CrearActualizarLoteImplementacionRequest) ::) {
    <ns2:CrearActualizarLoteImplementacionRequest>
        <ns2:LoteImplementacion>
            <imp:enProceso>{fn:true()}</imp:enProceso>
            <imp:loteImpementacion>
                <imp:idLote>{fn:data($InicioImplenetacionPCT/ns1:Header/ns3:ParameterType[ns3:parameterName = 'ID_LOTE']/ns3:parameterValue)}</imp:idLote>
            </imp:loteImpementacion>
        </ns2:LoteImplementacion>
    </ns2:CrearActualizarLoteImplementacionRequest>
};

local:func($InicioImplenetacionPCT)
