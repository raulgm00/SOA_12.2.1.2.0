...
declare function local:func($inInicioAprobacion as element() (:: schema-element(ns1:InicioAprobacion) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            ...
            <cre:nombreOperacion>{fn:data($inInicioAprobacion/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            ...
            <cre:usuario>{fn:data($inInicioAprobacion/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
            ...
            <cre:raroc></cre:raroc>
            {
            if(count($inInicioAprobacion/ns1:Header/ns5:ParameterType)>0)then
            <cre:string01>{fn:concat($inInicioAprobacion/ns1:Header/ns5:ParameterType[1]/ns5:parameterName,'-', $inInicioAprobacion/ns1:Header/ns5:ParameterType[1]/ns5:parameterValue[1])}</cre:string01>
            else()}
            {
            if(count($inInicioAprobacion/ns1:Header/ns5:ParameterType)>1)then
            <cre:string02>{fn:concat($inInicioAprobacion/ns1:Header/ns5:ParameterType[2]/ns5:parameterName,'-', $inInicioAprobacion/ns1:Header/ns5:ParameterType[2]/ns5:parameterValue)}</cre:string02>
            else()}
            {
            if(count($inInicioAprobacion/ns1:Header/ns5:ParameterType)>2)then
            <cre:string03>{fn:concat($inInicioAprobacion/ns1:Header/ns5:ParameterType[3]/ns5:parameterName,'-', $inInicioAprobacion/ns1:Header/ns5:ParameterType[3]/ns5:parameterValue)}</cre:string03>
            else()}
        </ns2:BitacoraInput>
    </ns2:requestCrearBitacoraProcesoMessage>
};
