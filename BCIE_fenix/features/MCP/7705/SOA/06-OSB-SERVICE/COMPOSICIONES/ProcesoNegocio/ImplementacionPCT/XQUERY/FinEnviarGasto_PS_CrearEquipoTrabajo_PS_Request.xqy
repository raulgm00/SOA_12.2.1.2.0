...
declare function local:func($FinEnviarGasto as element() (:: schema-element(ns1:FinEnviarGasto) ::)) as element() (:: schema-element(ns2:requestCrearEquipoTrabajoMessage) ::) {
    <ns2:requestCrearEquipoTrabajoMessage>
        <ns2:idOperacion>{fn:data($FinEnviarGasto/ns1:Header/ns4:Operacion/ns5:CodigoOperacion)}</ns2:idOperacion>
        <ns2:listadoEquipoTrabajo>
            {
                for $equipoTrabajo in $FinEnviarGasto/ns1:EquipoTrabajo/ns3:equipoTrabajo
                return 
                <ns3:equipoTrabajo>
