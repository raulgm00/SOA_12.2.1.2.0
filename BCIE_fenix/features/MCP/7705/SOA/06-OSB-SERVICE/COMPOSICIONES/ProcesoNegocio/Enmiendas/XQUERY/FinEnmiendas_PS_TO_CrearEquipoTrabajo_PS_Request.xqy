...
declare function local:func($FinEnmiendas as element() (:: schema-element(ns1:FinEnmiendas) ::)) as element() (:: schema-element(ns2:requestCrearEquipoTrabajoMessage) ::) {
    <ns2:requestCrearEquipoTrabajoMessage>
        <ns2:idOperacion>{fn:data($FinEnmiendas/ns1:Header/ns4:Operacion/ns5:CodigoOperacion)}</ns2:idOperacion>
        <ns2:listadoEquipoTrabajo>
            {
                for $equipoTrabajo in $FinEnmiendas/ns1:EquipoTrabajo/ns3:equipoTrabajo
