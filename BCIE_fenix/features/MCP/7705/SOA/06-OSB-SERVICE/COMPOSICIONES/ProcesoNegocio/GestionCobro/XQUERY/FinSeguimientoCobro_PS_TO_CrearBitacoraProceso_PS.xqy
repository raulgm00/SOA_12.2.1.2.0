...
declare variable $FinSeguimientoCobro as element() (:: schema-element(ns1:FinSeguimientoCobro) ::) external;

declare function local:func($FinSeguimientoCobro as element() (:: schema-element(ns1:FinSeguimientoCobro) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoClienteMessage) ::) {
    <ns2:requestCrearBitacoraProcesoClienteMessage>
        <ns2:BitacoraInput>
            <cre:id></cre:id>
            <cre:idCliente>{fn:data($FinSeguimientoCobro/ns1:Header/ns3:Cliente/ns4:IdCliente)}</cre:idCliente>
            <cre:razonSocial>{fn:data($FinSeguimientoCobro/ns1:Header/ns3:Cliente/ns4:RazonSocial)}</cre:razonSocial>
            <cre:idProceso>32</cre:idProceso>
            <cre:nombreProceso>PC07</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinSeguimientoCobro/ns1:Header/ns3:Proceso/ns5:InstanciaProceso)}</cre:instanciaProceso>
            ...
            <cre:usuario>{fn:data($FinSeguimientoCobro/ns1:Header/ns3:Cliente/ns4:ResponsableCliente)}</cre:usuario>
...
local:func($FinSeguimientoCobro)
