...
declare function local:func($FinComisiones as element() (:: schema-element(ns1:FinComisiones) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            <cre:idOperacion>{fn:data($FinComisiones/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($FinComisiones/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            <cre:idProceso>8</cre:idProceso>
            <cre:nombreProceso>PA02</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinComisiones/ns1:Header/ns3:Proceso/ns5:InstanciaProceso)}</cre:instanciaProceso>
            ...
            <cre:usuario>{fn:data($FinComisiones/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
