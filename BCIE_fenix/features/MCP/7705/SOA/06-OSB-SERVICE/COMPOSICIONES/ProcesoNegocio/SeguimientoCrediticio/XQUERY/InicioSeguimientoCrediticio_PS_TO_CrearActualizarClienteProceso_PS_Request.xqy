...
declare function local:func($InicioSeguimientoCrediticio as element() (:: schema-element(ns1:InicioSeguimientoCrediticio) ::)) as element() (:: schema-element(ns2:CrearActualizarClienteProcesoRequest) ::) {
