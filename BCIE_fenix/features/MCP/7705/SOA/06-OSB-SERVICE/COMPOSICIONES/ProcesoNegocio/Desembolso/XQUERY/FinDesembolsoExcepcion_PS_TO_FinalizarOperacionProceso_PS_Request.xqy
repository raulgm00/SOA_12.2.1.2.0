...
declare function local:func($FinDesembolsoExcepcion as element() (:: schema-element(ns1:FinDesembolsoExcepcion) ::)) as element() (:: schema-element(ns2:requestFinalizarOperacionProcesoMessage) ::) {
    <ns2:requestFinalizarOperacionProcesoMessage>
        <ns2:BitacoraInput>
            <fin:idOperacion>{fn:data($FinDesembolsoExcepcion/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</fin:idOperacion>
