...
declare function local:func($AnalisisRequest as element() (:: schema-element(ns1:InicioAnalisis) ::)) as element() (:: schema-element(ns2:requestCrearOperacionProcesoMessage) ::) {
    <ns2:requestCrearOperacionProcesoMessage>
        <ns2:OperacionProcesoInput>
            <cre:idOperacion>{fn:data($AnalisisRequest/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
