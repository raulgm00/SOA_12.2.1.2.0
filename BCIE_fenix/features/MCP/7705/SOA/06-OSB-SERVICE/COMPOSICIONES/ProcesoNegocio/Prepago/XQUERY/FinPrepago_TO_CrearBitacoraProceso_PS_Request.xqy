...
declare function local:func($FinPrepago as element() (:: schema-element(ns2:FinPrepago) ::)) as element() (:: schema-element(ns1:requestCrearBitacoraProcesoMessage) ::) {
    <ns1:requestCrearBitacoraProcesoMessage>
        <ns1:BitacoraInput>
            <cre:id></cre:id>
            <cre:idOperacion>{fn:data($FinPrepago/ns2:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($FinPrepago/ns2:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            <cre:idProceso>26</cre:idProceso>
            <cre:nombreProceso>PA12</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinPrepago/ns2:Header/ns3:Proceso/ns5:InstanciaProceso)}</cre:instanciaProceso>
            ...
            <cre:usuario>{fn:data($FinPrepago/ns2:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
