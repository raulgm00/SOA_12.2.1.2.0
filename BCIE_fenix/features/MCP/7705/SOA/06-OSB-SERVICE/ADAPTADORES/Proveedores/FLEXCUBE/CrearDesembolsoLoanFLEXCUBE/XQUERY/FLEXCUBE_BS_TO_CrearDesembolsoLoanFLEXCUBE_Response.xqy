...
declare function local:func($crearLoanResponse as element() (:: element(m:crearLoanResponse) ::),$referencia as xs:string) as element() (:: schema-element(ns2:CrearDesembolsoLoanFLEXCUBEResponse) ::) {
    <ns2:CrearDesembolsoLoanFLEXCUBEResponse>
        <ns2:ContratoDesembolso>
            <des:idDesembolso></des:idDesembolso>
            <des:idFacturador>{fn:data($crearLoanResponse/codigoContrato_out)}</des:idFacturador>
            <des:producto>
        ...
        <ns2:Resultado>
            ...
            else (fn:data($crearLoanResponse/mensaje_out))
            }</res:message>
        </ns2:Resultado>
    </ns2:CrearDesembolsoLoanFLEXCUBEResponse>
};

local:func($crearLoanResponse,$referencia)
