...
declare variable $planAmortizacionXml as element() external;
...
declare function local:func($planAmortizacionXml as element(), 
    ...
    <ns2:generarReporte>
        ...
        <contenidoXML>{fn-bea:serialize($planAmortizacionXml)}</contenidoXML>
        {
            let $formato := "pdf"
            return 
...
local:func($planAmortizacionXml, $plantilla, $configuracion)
