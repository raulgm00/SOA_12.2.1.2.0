...
declare function local:func($ReporteMessage as element() (:: schema-element(rep:Reporte) ::)) as element() (:: schema-element(ns2:CrearReciboPagoResponse) ::) {
    <ns2:CrearReciboPagoResponse>
        <ns2:Resultado>
            <res:result>
        {
