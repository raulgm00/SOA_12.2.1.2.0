...
declare namespace ns2="http://www.bicie.org/ConsultarUsuarioTareasMO";
...
declare function local:func($responseMapeoErrorMessage as element() (:: schema-element(ns1:responseMapeoErrorMessage) ::), 
                            ...
                            as element() (:: schema-element(ns2:ConsultarUsuarioTareasResponse) ::) {
    <ns2:ConsultarUsuarioTareasResponse>
        <ns2:Resultado>
