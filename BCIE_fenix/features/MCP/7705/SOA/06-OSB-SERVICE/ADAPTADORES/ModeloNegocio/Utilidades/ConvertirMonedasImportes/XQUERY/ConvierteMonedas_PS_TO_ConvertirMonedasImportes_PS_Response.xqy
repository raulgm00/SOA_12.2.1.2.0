...
declare variable $ConversorMonedasResponse as element() (:: schema-element(ns1:ConversorMonedasResponse) ::) external;
...
declare function local:func($ConversorMonedasRequest as element() (:: schema-element(ns1:ConversorMonedasRequest) ::), 
                            $ConversorMonedasResponse as element() (:: schema-element(ns1:ConversorMonedasResponse) ::),$counter as xs:int) 
    ...
    <ns1:ConvertirMonedasImportesResponse>
        <ns1:ConvierteMonedasImporte>
            ...
            <con:montoConvertido>{fn:data($ConversorMonedasResponse/ns1:montoConvertido)}</con:montoConvertido>
        </ns1:ConvierteMonedasImporte>
    </ns1:ConvertirMonedasImportesResponse>
};

local:func($ConversorMonedasRequest, $ConversorMonedasResponse,$counter)
