...
declare function local:func($responseMapeoErrorMessage as element() (:: schema-element(ns1:responseMapeoErrorMessage) ::)) as element() (:: schema-element(ns2:ConsultarParametrosAvisoCobroResponse) ::) {
    <ns2:ConsultarParametrosAvisoCobroResponse>
        <ns2:Resultado>
