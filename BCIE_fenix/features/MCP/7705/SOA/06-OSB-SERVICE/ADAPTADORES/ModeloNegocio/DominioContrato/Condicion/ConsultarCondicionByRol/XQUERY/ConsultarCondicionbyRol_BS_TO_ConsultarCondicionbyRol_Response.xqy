...
declare namespace ns21="http://xmlns.oracle.com/pcbpel/adapter/db/ConsultarObservacionCondicion";
...
declare variable $ConsultarObservacionCondicionOutputCollection as element() (:: schema-element(ns21:ConsultarObservacionCondicionOutputCollection) ::) external;
...
declare function local:func($consultarCondicionByRolOutputCollection as element() (:: schema-element(ns1:consultarCondicionByRolOutputCollection) ::), 
                            ...
                            $ConsultarValidadoresbyCategoriaOutputCollection as element() (:: schema-element(ns6:ConsultarValidadoresbyCategoriaOutputCollection) ::), 
                                                       ...
                                                       $ConsultarObservacionCondicionOutputCollection as element() (:: schema-element(ns21:ConsultarObservacionCondicionOutputCollection) ::)) 
    ...
    <ns8:ConsultarCondicionByRolResponse>
        {
            ...
            <ns8:Condicion>
                ...
                <con:subEstadoTCC>
                    <atr:id>{fn:data($consultarCondicionByRolOutput/ns1:ID_TCA_SUB_ESTADO_TCC)}</atr:id>
                    <atr:descripcion>{fn:data($consultarCondicionByRolOutput/ns1:DESCRIPCION_SUB)}</atr:descripcion>
                    <atr:descripcionCorta>{fn:data($consultarCondicionByRolOutput/ns1:DESCRIPCION_SUB)}</atr:descripcionCorta>
                ...
                <con:fechaEnmienda>{fn:data($consultarCondicionByRolOutput/ns1:FECHA_ENMIENDA)}</con:fechaEnmienda>
                {
                    ...
                    <con:configAtributo>
                       ...
                       if( fn:data($ConsultarAtributoByCondicionOutput/ns3:SOLO_LECTURA)=1)then  true() else false()
                        ...
                        {
                            for $Row in $valoresOutputParameters/ns7:RECORDSET/ns7:Row
                            where  fn:data($Row/ns7:Column[@name="COLUMNA"])=fn:data($ConsultarAtributoByCondicionOutput/ns3:COLUMNA)
                ...
                {
                    for $ConsultarObservacionCondicionOutput in $ConsultarObservacionCondicionOutputCollection/ns21:ConsultarObservacionCondicionOutput
                    where fn:data($consultarCondicionByRolOutput/ns1:ID)=fn:data($ConsultarObservacionCondicionOutput/ns21:ID_CONDICION)
                    return 
                    <con:observaciones>
                        <con:id>{fn:data($ConsultarObservacionCondicionOutput/ns21:ID)}</con:id>
                        <con:observacion>{fn:data($ConsultarObservacionCondicionOutput/ns21:OBSERVACION)}</con:observacion>
                        <con:loginUsuario>{fn:data($ConsultarObservacionCondicionOutput/ns21:LOGIN_USUARIO)}</con:loginUsuario>
                        <con:nombreUsuario>{fn:data($ConsultarObservacionCondicionOutput/ns21:NOMBRE_USUARIO)}</con:nombreUsuario>
                        <con:fechaRegistro>{fn:data($ConsultarObservacionCondicionOutput/ns21:FECHA_REGISTRO)}</con:fechaRegistro>
                        <con:estatus>{fn:data($ConsultarObservacionCondicionOutput/ns21:BAN_ESTATUS)}</con:estatus>
                        <con:esPrincipal>{fn:data($ConsultarObservacionCondicionOutput/ns21:ES_PRINCIPAL)}</con:esPrincipal>
                        <con:tareaBPM>
                            <cat:Id>{fn:data($ConsultarObservacionCondicionOutput/ns21:ID_TCA_TAREA_BPM)}</cat:Id>
                            
                        </con:tareaBPM></con:observaciones>
                }
                {
                ...
                <con:fechaVigencia>{fn:data($consultarCondicionByRolOutput/ns1:FECHA_VIGENCIA)}</con:fechaVigencia></ns8:Condicion>
        }
        <ns8:Resultado>
            <res:result>OK</res:result>
           
         {
            if (count($consultarCondicionByRolOutputCollection/ns1:consultarCondicionByRolOutput/ns1:ID)=0) then
