...
declare function local:func($ConsultarVotacionUsuarioResponse as element() (:: schema-element(ns1:ConsultarVotacionUsuarioResponse) ::)) as element() (:: schema-element(ns2:ConsultarSeguimientoCrediticioByIdClienteRequest) ::) {
    <ns2:ConsultarSeguimientoCrediticioByIdClienteRequest>
