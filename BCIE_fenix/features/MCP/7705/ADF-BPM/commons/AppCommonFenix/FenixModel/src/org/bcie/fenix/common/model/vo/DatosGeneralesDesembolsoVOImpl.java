...
public class DatosGeneralesDesembolsoVOImpl extends ViewObjectImpl implements DatosGeneralesDesembolsoVO {
    ...
    public void validarProgramaOperacion(Boolean esIntermediario) {
        ...
        if (!esIntermediario) {
            ...
            Long producto =
                (currentFilaDatosGen.getAttribute("IdProducto") == null) ? null :
                new Long((Integer) currentFilaDatosGen.getAttribute("IdProducto"));

            Long revolvencia =
                (currentFilaDatosGen.getAttribute("RevolvenciaLineaCred") == null) ? null :
            ...
            Long sector =
                (currentFilaDatosGen.getAttribute("IdSectorInstitucional") == null) ? null :
