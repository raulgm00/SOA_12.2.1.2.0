...
public class AdministradorLineaCreditoActionsBean {
     ...
     */
    boolean AceptarConfirmarPropagarLineasCredito = false;
    ...
    public void lineaCreditoSelectionListener(SelectionEvent selectionEvent) {
        ...
        Long idLineaCredito = (Long) JSFUtils.resolveExpression(
                "#{bindings.Id.inputValue}");
    ...
    private void consultarLineaCredito(Long idLineaCredito) {
        ...
        AdministradorLineaCreditoBean administradorLineaCreditoBean = (AdministradorLineaCreditoBean) JSFUtils.resolveExpression(
                "#{pageFlowScope.AdministradorLineaCreditoMB}");
        ...
        if (JSFUtils.resolveExpression("#{pageFlowScope.pIdProducto}") != null) {
            idProducto = (Integer) JSFUtils.resolveExpression(
                    "#{pageFlowScope.pIdProducto}");
        }

        //Operacion que consulta la linea de credito desde la base de datos
        OperationBinding operationBinding = ADFUtils.findOperation(
                "consultarLineaCreditoByIdDesdeBaseDatos");
        ...
        if (getFormDatosLineaCreditoUIC() != null) {
            ...
            AdfFacesContext.getCurrentInstance()
                           .addPartialTarget(getFormDatosLineaCreditoUIC());
        }
    }
    ...
    public void esRevolventeValueChangeListener(
    ...
    public void tiposComisionValueChangeListener(
        ValueChangeEvent valueChangeEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside tiposComisionValueChangeListener: " +
        ...
        valueChangeEvent.getComponent()
                        .processUpdates(FacesContext.getCurrentInstance()); // Actualiza valor seleccionado en combo
        tipoComision = (String) JSFUtils.resolveExpression(
                "#{bindings.Descripcion.inputValue}");
        codigoComision = (String) JSFUtils.resolveExpression(
                "#{bindings.Codigo.inputValue}");

        // Asignamos en current row de AgregarComisionVO los valores de TipoComision y CodigoComision
        voAgregarComision = ADFUtils.getDCBindingContainer()
                                    .findIteratorBinding("AgregarComisionVOIterator");
        voAgregarComision.getRowAtRangeIndex(0)
                         .setAttribute("TipoComision", tipoComision);
        voAgregarComision.getRowAtRangeIndex(0)
                         .setAttribute("CodigoComision", codigoComision);
    }

    public void agregarModificarVencimientoPlazoActionListener(
        ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside agregarModificarVencimientoPlazoActionListener: " +
        ...
        opAdjuntarModificar = (String) JSFUtils.resolveExpression(
                "#{viewScope.opAdjuntarModificar}");

        // Creamos row de captura
        operationBinding = bindings.getOperationBinding(
                "crearRowVencimientoPlazo");
        operationBinding.execute();
        ...
        if ((opAdjuntarModificar != null) &&
                (opAdjuntarModificar.equalsIgnoreCase("modificar"))) {
            // Asignación de variables para modificar row
            voAgregarVencimientoPlazo = ADFUtils.getDCBindingContainer()
                                                .findIteratorBinding("AgregarVencimientoPlazoVOIterator");
            voVencimientoPlazo = ADFUtils.getDCBindingContainer()
                                         .findIteratorBinding("VencimientoPlazoVOIterator");
            rowAgregarVencimiento = voAgregarVencimientoPlazo.getRowAtRangeIndex(0);
            rowVencimiento = voVencimientoPlazo.getCurrentRow();

            rowAgregarVencimiento.setAttribute("FechaInicio",
                rowVencimiento.getAttribute("FechaInicio"));
            rowAgregarVencimiento.setAttribute("FechaVencimiento",
                rowVencimiento.getAttribute("FechaVencimiento"));
            rowAgregarVencimiento.setAttribute("IdPlazo",
                rowVencimiento.getAttribute("IdPlazo"));
            rowAgregarVencimiento.setAttribute("IdTipoDeFecha",
                rowVencimiento.getAttribute("IdTipoDeFecha"));
            rowAgregarVencimiento.setAttribute("IdTipoDeVencimiento",
                rowVencimiento.getAttribute("IdTipoDeVencimiento"));
            rowAgregarVencimiento.setAttribute("TipoPlazo",
                rowVencimiento.getAttribute("TipoPlazo"));
            rowAgregarVencimiento.setAttribute("Plazo",
                rowVencimiento.getAttribute("Plazo"));
            rowAgregarVencimiento.setAttribute("TipoDeFecha",
                rowVencimiento.getAttribute("TipoDeFecha"));
            rowAgregarVencimiento.setAttribute("TipoDeVencimiento",
                rowVencimiento.getAttribute("TipoDeVencimiento"));
        }
    ...
    public void agregarModificarComisionActionListener(ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside agregarModificarComisionActionListener: " +
            actionEvent.getComponent().getId());
        ...
        opAdjuntarModificar = (String) JSFUtils.resolveExpression(
                "#{viewScope.opAdjuntarModificar}");
        codProducto = (String) JSFUtils.resolveExpression(
                "#{bindings.Id1.inputValue}");
        ...
        voTiposComision = ADFUtils.getDCBindingContainer()
                                  .findIteratorBinding("TiposComisionLOVIterator");
        ...
        if (voTiposComision.getCurrentRow() != null) {
            rowAgregarComision.setAttribute("CodigoComision",
        ...
        if ((opAdjuntarModificar != null) &&
                (opAdjuntarModificar.equalsIgnoreCase("modificar"))) {
            // Asignación de variables para modificar row
            voComision = ADFUtils.getDCBindingContainer()
                                 .findIteratorBinding("ComisionVOIterator");
            rowComision = voComision.getCurrentRow();

            rowAgregarComision.setAttribute("BaseCalculo",
                rowComision.getAttribute("BaseCalculo"));
            rowAgregarComision.setAttribute("TipoFrecuencia",
                rowComision.getAttribute("TipoFrecuencia"));
            rowAgregarComision.setAttribute("Frecuencia",
                rowComision.getAttribute("Frecuencia"));
            rowAgregarComision.setAttribute("CodigoComision",
                rowComision.getAttribute("CodigoComision"));
            rowAgregarComision.setAttribute("IdBaseCalculo",
                rowComision.getAttribute("IdBaseCalculo"));
            rowAgregarComision.setAttribute("IdFrecuencia",
                rowComision.getAttribute("IdFrecuencia"));
            rowAgregarComision.setAttribute("IdTipoComision",
                rowComision.getAttribute("IdTipoComision"));
            rowAgregarComision.setAttribute("Porcentaje",
                rowComision.getAttribute("Porcentaje"));
            rowAgregarComision.setAttribute("TipoComision",
                rowComision.getAttribute("TipoComision"));

            // Asignamos valor en combo Tipos de Comisión
            rowTiposComision = voTiposComision.getViewObject()
                                              .getFilteredRows("Codigo",
                    rowComision.getAttribute("CodigoComision"));

            if (rowTiposComision.length > 0) {
                voTiposComision.getViewObject()
                               .setCurrentRow(rowTiposComision[0]);
            }
        }
    ...
    public void aceptarAgregarModificarVencimientoPlazoActionListener(
        ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
        ...
        if (opAdjuntarModificar.equalsIgnoreCase("agregar")) {
            //--------------------------------------------------------------------------------------------------------------
            try {
                String vIdTipoDeVencimiento = rowAgregarVencimiento.getAttribute(
                        "IdTipoDeVencimiento").toString();
                int vExisteIdTipoDeVencimiento = 0;
                logger.log(ADFLogger.WARNING,
                    " Inicia validacion de IdTipoDeVencimiento = " +
                ...
                while (hasNext) {
                    ...
                    if (r == null) {
                        ...
                        if (r.getAttribute("IdTipoDeVencimiento") != null) {
                            String idTipoVencimiento = r.getAttribute(
                                    "IdTipoDeVencimiento").toString();
                            logger.log(ADFLogger.WARNING,
                            ...
                            if (idTipoVencimiento.equals(vIdTipoDeVencimiento)) {
                                ...
                                logger.log(ADFLogger.WARNING,
                                    "true idTipoVencimiento: " +
                                    idTipoVencimiento +
                                    "  == vIdTipoDeVencimiento: " +
                                    vIdTipoDeVencimiento);
                            } else {
                                logger.log(ADFLogger.WARNING,
                                    "false idTipoVencimiento: " +
                                    idTipoVencimiento +
                                    "  == vIdTipoDeVencimiento: " +
                                    vIdTipoDeVencimiento);
                            }
                            ...
                            if (vExisteIdTipoDeVencimiento >= 1) {
                                ...
                                JSFUtils.addFacesErrorMessage(
                                    "El Tipo De Vencimiento seleccionado ya existe.");

                                return;
                            } else {
                                logger.log(ADFLogger.WARNING,
                                    " Existen " + vExisteIdTipoDeVencimiento +
                                    " para el idTipoVencimiento " +
                                    vIdTipoDeVencimiento);
                            }
                        } else {
                            logger.log(ADFLogger.WARNING,
                                " IdTipoDeVencimiento es nulo  ");
                        }
                    }
                }

                logger.log(ADFLogger.WARNING,
                    " Termino validacion de IdTipoDeVencimiento = " +
                    vIdTipoDeVencimiento);

                Object vFechaInicio = rowAgregarVencimiento.getAttribute(
                        "FechaInicio");
                Object vFechaVencimiento = rowAgregarVencimiento.getAttribute(
                        "FechaVencimiento");
                ...
                logger.log(ADFLogger.WARNING,
                    " Error al verificar si existia el tipo de vencimiento: " +
                    exp.getMessage());
            }
            ...
            operationBinding.getParamsMap()
                            .put("id",
                voVencimientoPlazo.getCurrentRow().getAttribute("Id"));
            operationBinding.getParamsMap()
                            .put("idVencimiento",
        ...
        operationBinding.getParamsMap()
                        .put("idTipoDeVencimiento",
            rowAgregarVencimiento.getAttribute("IdTipoDeVencimiento"));
        operationBinding.getParamsMap()
                        .put("idTipoDeFecha",
            rowAgregarVencimiento.getAttribute("IdTipoDeFecha"));
        operationBinding.getParamsMap()
                        .put("idPlazo",
            rowAgregarVencimiento.getAttribute("IdPlazo"));
        operationBinding.getParamsMap()
                        .put("tipoDeVencimiento",
            rowAgregarVencimiento.getAttribute("TipoDeVencimiento"));
        operationBinding.getParamsMap()
                        .put("tipoDeFecha",
            rowAgregarVencimiento.getAttribute("TipoDeFecha"));
        operationBinding.getParamsMap()
                        .put("tipoPlazo",
            rowAgregarVencimiento.getAttribute("TipoPlazo"));
        operationBinding.getParamsMap()
                        .put("plazo",
            rowAgregarVencimiento.getAttribute("Plazo"));
        operationBinding.getParamsMap()
                        .put("fechaInicio",
            rowAgregarVencimiento.getAttribute("FechaInicio"));
        operationBinding.getParamsMap()
                        .put("fechaVencimiento",
            rowAgregarVencimiento.getAttribute("FechaVencimiento"));
    ...
    public void aceptarAgregarModificarComisionActionListener(
        ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside aceptarAgregarModificarComisionActionListener: " +
            actionEvent.getComponent().getId());
        ...
        if (opAdjuntarModificar.equalsIgnoreCase("agregar")) {
                ...
                while (hasNext) {
                    ...
                    if (r == null) {
                        ...
                        if (r.getAttribute("TipoComision") != null) {
                            String idTipoComision = r.getAttribute(
                                    "TipoComision").toString().toUpperCase();
                            logger.log(ADFLogger.WARNING,
                            ...
                            if (idTipoComision.contains(vIdTipoComision)) //.equals(vIdTipoComision))
                             {
                                ...
                                logger.log(ADFLogger.WARNING,
                                    "true idTipoComision: " + idTipoComision +
                                    "  contains vIdTipoComision: " +
                                    vIdTipoComision);
                            } else {
                                logger.log(ADFLogger.WARNING,
                                    "false idTipoComision: " + idTipoComision +
                                    "  contains vIdTipoComision: " +
                                    vIdTipoComision);
                            }
                            ...
                            if (vExisteIdTipoComision >= 1) {
                                logger.log(ADFLogger.WARNING,
                                    "Duplicado, Existen " +
                                    vExisteIdTipoComision +
                                    " para el idTipoComision " +
                                    vIdTipoComision);
                                hasNext = false;
                                //JSFUtils.addFacesErrorMessage("El Tipo de Comision " + idTipoComision + " ya existe.");
                                JSFUtils.addFacesErrorMessage(
                                    "El Tipo de Comision seleccionado ya existe.");

                                return;
                            } else {
                                logger.log(ADFLogger.WARNING,
                                    " Existen " + vExisteIdTipoComision +
                                    " para el idTipoVencimiento " +
                                    vIdTipoComision);
                            }
                        } else {
                            logger.log(ADFLogger.WARNING,
                                " IdTipoComision es nulo  ");
                        }
                    }
                }

                logger.log(ADFLogger.WARNING,
                    " Termino validacion de IdTipoComision = " +
                    vIdTipoComision);
            } catch (Exception exp) {
                logger.log(ADFLogger.WARNING,
                    " Error al verificar si existia el tipo comision: " +
                    exp.getMessage());
            }
            ...
            operationBinding.getParamsMap()
                            .put("id",
                voComision.getCurrentRow().getAttribute("Id"));
            operationBinding.getParamsMap()
                            .put("idComision",
                voComision.getCurrentRow().getAttribute("IdComision"));
        }

        // Mapeo de datos de popup
        operationBinding.getParamsMap()
                        .put("idBaseCalculo",
            rowAgregarComision.getAttribute("IdBaseCalculo"));
        operationBinding.getParamsMap()
                        .put("idFrecuencia",
            rowAgregarComision.getAttribute("IdFrecuencia"));
        operationBinding.getParamsMap()
                        .put("baseCalculo",
            rowAgregarComision.getAttribute("BaseCalculo"));
        operationBinding.getParamsMap()
                        .put("tipoFrecuencia",
            rowAgregarComision.getAttribute("TipoFrecuencia"));
        operationBinding.getParamsMap()
                        .put("frecuencia",
            rowAgregarComision.getAttribute("Frecuencia"));
        operationBinding.getParamsMap()
                        .put("porcentaje",
            rowAgregarComision.getAttribute("Porcentaje"));

        if (voTiposComision.getCurrentRow() != null) {
            operationBinding.getParamsMap()
                            .put("idTipoComision",
                voTiposComision.getCurrentRow().getAttribute("Id"));
            operationBinding.getParamsMap()
                            .put("tipoComision",
                voTiposComision.getCurrentRow().getAttribute("Descripcion"));
            operationBinding.getParamsMap()
            ...
            operationBinding.getParamsMap()
                            .put("idTipoComision",
                rowAgregarComision.getAttribute("IdTipoComision"));
            operationBinding.getParamsMap()
                            .put("codigoComision",
                rowAgregarComision.getAttribute("CodigoComision"));
            operationBinding.getParamsMap()
                            .put("tipoComision",
                rowAgregarComision.getAttribute("TipoComision"));
        }
    ...
    public void cancelarAgregarVencimientoPlazoActionListener(
        ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside cancelarAgregarVencimientoPlazoActionListener: " +
            actionEvent.getComponent().getId());
    ...
    public void eliminarVencimientoComisionActionListener(
        ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside eliminarVencimientoComisionActionListener: " +
            actionEvent.getComponent().getId());
    ...
    public void aceptarEliminarVencimientoComisionActionListener(
        ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside aceptarEliminarVencimientoComisionActionListener: " +
            actionEvent.getComponent().getId());
        ...
        // Asignación de variables
        opEliminarOrigen = (String) JSFUtils.resolveExpression(
                "#{viewScope.opEliminarOrigen}");

        if ((opEliminarOrigen != null) &&
                (opEliminarOrigen.equalsIgnoreCase("vencimiento"))) {
            voVencimientoPlazo = ADFUtils.getDCBindingContainer()
                                         .findIteratorBinding("VencimientoPlazoVOIterator");
            rowVencimiento = voVencimientoPlazo.getCurrentRow();
            ...
            operationBinding = bindings.getOperationBinding(
                    "eliminarVencimiento");
            operationBinding.getParamsMap()
                            .put("id", rowVencimiento.getAttribute("Id"));
        } else {
            voComision = ADFUtils.getDCBindingContainer()
                                 .findIteratorBinding("ComisionVOIterator");
            rowComision = voComision.getCurrentRow();
            ...
            operationBinding.getParamsMap()
                            .put("id", rowComision.getAttribute("Id"));
        }
    ...
    public void cancelarEliminarVencimientoComisionActionListener(
        ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside cancelarEliminarVencimientoComisionActionListener: " +
            actionEvent.getComponent().getId());
    ...
    public void guardarDatosLineaCreditoActionListener(ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside guardarDatosLineaCreditoActionListener");
        ...
        voDatosLineaCredito = ADFUtils.getDCBindingContainer()
                                      .findIteratorBinding("DatosLineaCreditoVOIterator");

        int actualIndex = voDatosLineaCredito.getCurrentRowIndexInRange();
        String numLineaCreditoSeleccionada = (String) voDatosLineaCredito.getCurrentRow()
                                                                         .getAttribute("NumeroLineaCredito");

        if (validarDatosLineaCredito()) {
            //Crear instancia de AdministradorLineaCreditoBean
            administradorLineaCreditoBean = (AdministradorLineaCreditoBean) JSFUtils.resolveExpression(
                    "#{pageFlowScope.AdministradorLineaCreditoMB}");

            // Insertamos al VO los Vencimientos eliminados
            if (administradorLineaCreditoBean.getIdsVencimientosEliminados()
                                                 .size() > 0) {
                operationBinding = bindings.getOperationBinding(
                        "agregarVencimientosEliminados");
                operationBinding.getParamsMap()
                                .put("idsVencimientosEliminados",
                    administradorLineaCreditoBean.getIdsVencimientosEliminados());
                operationBinding.execute();
                ...
                if (!operationBinding.getErrors().isEmpty()) {
                    ...
                    JSFUtils.addFacesErrorMessage(operationBinding.getErrors()
                                                                  .toString());
                }
            }
            ...
            if (administradorLineaCreditoBean.getIdsComisionesEliminadas().size() > 0) {
                operationBinding = bindings.getOperationBinding(
                        "agregarComisionesEliminadas");
                operationBinding.getParamsMap()
                                .put("idsComisionesEliminadas",
                    administradorLineaCreditoBean.getIdsComisionesEliminadas());
            ...
            if (operationBinding.getErrors().size() < 1) {
                ...
                Boolean desobligacion = JSFUtils.resolveExpressionAsBoolean(
                        "#{pageFlowScope.desobligacion}");
                ...
                if (desobligacion) {
                    ...
                    if (idLineaCredito == null) {
                        logger.warning(
                            "ID linea crédito evaluó a nulo, no se puede actualizar monto a desobligar en el mapa en memoria");
                    }

                    Map mapMontosDesobligar = (Map) ADFContext.getCurrent()
                                                              .getPageFlowScope()
                                                              .get("montosDesobligar");
                    Map mapDesobligacionFin = (Map) ADFContext.getCurrent()
                                                              .getPageFlowScope()
                                                              .get("desobligacionFin");

                    if ((mapMontosDesobligar != null) &&
                            (idLineaCredito != null)) {
                        //no usar getMontoDeobligar() ya que eso puede traer el dato que estaba en el payload
                        mapMontosDesobligar.put(idLineaCredito,
                            this.montoDesobligar);

                        if (this.desobligacionFin != null) {
                            mapDesobligacionFin.put("DESOBLIGACION_FIN",
                                this.desobligacionFin.toString());
                        } else {
                            mapDesobligacionFin.put("DESOBLIGACION_FIN", "false");
                        }
                    }
                    ...
                    logger.log(ADFLogger.WARNING,
                        "Se agrega launchDesobligacionFinEvent");
                    launchDesobligacionFinEvent(actionEvent);
                }
                ...
                administradorLineaCreditoBean.getIdsVencimientosEliminados()
                                             .clear(); //Limpia lista de vencimientos
                administradorLineaCreditoBean.getIdsComisionesEliminadas()
                                             .clear(); //Limpia lista de comisiones

                // Limpiamos RegistrarDatosLineaCreditoVO
                operationBinding = bindings.getOperationBinding(
                        "inicializarRegistrarDatosLineaCredito");
                operationBinding.execute();
                ...
                voDatosLineaCreditoVO = ADFUtils.getDCBindingContainer()
                                                .findIteratorBinding("DatosLineaCreditoVOIterator");
                ...
                if (null != JSFUtils.resolveExpression(
                            "#{pageFlowScope.solicitudContratacion}")) {
                    solicitudContratacion = (Boolean) JSFUtils.resolveExpression(
                            "#{pageFlowScope.solicitudContratacion}");
                }
                ...
                operationBinding.getParamsMap()
                    ...
                    JSFUtils.resolveExpression(
                        "#{pageFlowScope.pInstanciaProceso}"));
                operationBinding.getParamsMap()
                                .put("idProducto",
                    JSFUtils.resolveExpression("#{pageFlowScope.pIdProducto}"));
                operationBinding.getParamsMap()
                                .put("solicitudContratacion",
                ...
                Row[] filteredArray = voDatosLineaCreditoVO.getViewObject()
                                                           .getFilteredRows("NumeroLineaCredito",
                        numLineaCreditoSeleccionada);
    ...
    private Boolean validarDatosLineaCredito() {
        ...
        Integer value = (Integer) ADFUtils.findIterator(
                "TcaTipoRedondeoVO1Iterator").getCurrentRow().getAttribute("Id");

        if ((value != null) && (value != 0)) {
            if (JSFUtils.resolveExpression(
                        "#{bindings.CantidadDecimales.inputValue}") != null) {
                String candidadDecimalesStr = JSFUtils.resolveExpression(
                        "#{bindings.CantidadDecimales.inputValue}").toString();
                ...
                if ((cantidadDeciInt < 2) || (cantidadDeciInt > 4)) {
                    ...
                    JSFUtils.addFacesErrorMessage(ADFUtils.getStringFromBundle(
                            "CANTIDAD_DECIMALES_MENSAJE", BUNDLE));
                }
            }
        }
        ...
        if ((JSFUtils.resolveExpression(
                    "#{bindings.FechaValorContrato.inputValue}") == null) ||
                (JSFUtils.resolveExpression(
                    "#{bindings.FechaValorContrato.inputValue}").toString()
                             .trim().length() < 1)) {
            esDatosCorrectos = Boolean.FALSE;
            JSFUtils.addFacesErrorMessage(ADFUtils.getStringFromBundle(
                    "CAMPO_FECHA_VALOR_ES_REQUERIDO", BUNDLE));
        }

        // Número de línea es obligatorio
        Object numeroLineaCredito = JSFUtils.resolveExpression(
                "#{bindings.NumeroLineaCredito.inputValue}");
        String textoLinea = (numeroLineaCredito != null)
            ? (" Línea: " + numeroLineaCredito) : "";

        if ((numeroLineaCredito == null) ||
                (numeroLineaCredito.toString().trim().length() < 1)) {
            esDatosCorrectos = Boolean.FALSE;
            JSFUtils.addFacesErrorMessage(
                "El campo Número de línea es requerido.");
        }

        // Fondo contable es obligatorio
        if ((JSFUtils.resolveExpression(
                    "#{bindings.CatFondoContableVO.attributeValue}") == null) ||
                (JSFUtils.resolveExpression(
                    "#{bindings.CatFondoContableVO.attributeValue}").toString()
                             .trim().length() < 1)) {
            esDatosCorrectos = Boolean.FALSE;
            JSFUtils.addFacesErrorMessage(
                "El campo Fondo contable es requerido." + textoLinea);
        }

        // Es revolvente es obligatorio
        if ((JSFUtils.resolveExpression(
                    "#{bindings.EsRevolvente.attributeValue}") == null) ||
                (JSFUtils.resolveExpression(
                    "#{bindings.EsRevolvente.attributeValue}").toString().trim()
                             .length() < 1)) {
            esDatosCorrectos = Boolean.FALSE;
            JSFUtils.addFacesErrorMessage(
                "El campo Es revolvente es requerido." + textoLinea);
        }

        // Aplican recursos ordinarios es obligatorio
        if ((JSFUtils.resolveExpression(
                    "#{bindings.EsRecursosExternos.attributeValue}") == null) ||
                (JSFUtils.resolveExpression(
                    "#{bindings.EsRecursosExternos.attributeValue}").toString()
                             .trim().length() < 1)) {
            esDatosCorrectos = Boolean.FALSE;
            JSFUtils.addFacesErrorMessage(
                "El campo Aplican recursos ordinarios es requerido." +
                textoLinea);
        }

        // Producto es obligatorio
        if ((JSFUtils.resolveExpression(
                    "#{bindings.CatProductoFlexcubeLOV.attributeValue}") == null) ||
                (JSFUtils.resolveExpression(
                    "#{bindings.CatProductoFlexcubeLOV.attributeValue}")
        ...
        if ((JSFUtils.resolveExpression("#{bindings.FechaValor.inputValue}") == null) ||
                (JSFUtils.resolveExpression("#{bindings.FechaValor.inputValue}")
                             .toString().trim().length() < 1)) {
            esDatosCorrectos = Boolean.FALSE;
            JSFUtils.addFacesErrorMessage(
                "El campo Fecha de apertura es requerido." + textoLinea);
        }

        // Plazo de financiamiento es obligatorio
        if ((JSFUtils.resolveExpression(
                    "#{bindings.PlazoFinanciamiento.inputValue}") == null) ||
                (JSFUtils.resolveExpression(
                    "#{bindings.PlazoFinanciamiento.inputValue}").toString()
                             .trim().length() < 1) ||
                (JSFUtils.resolveExpression(
                    "#{bindings.CatPlazoFinanciamientoLOV.attributeValue}") == null) ||
                (JSFUtils.resolveExpression(
                    "#{bindings.CatPlazoFinanciamientoLOV.attributeValue}")
                             .toString().trim().length() < 1)) {
            esDatosCorrectos = Boolean.FALSE;
            JSFUtils.addFacesErrorMessage(
                "El campo Plazo de financiamiento es requerido." + textoLinea);
        } else {
            // Plazo de financiamiento debe ser mayor a cero
            plazoFinanciamiento = Integer.valueOf(JSFUtils.resolveExpression(
                        "#{bindings.PlazoFinanciamiento.inputValue}").toString());

            if (plazoFinanciamiento.intValue() < 1) {
                esDatosCorrectos = Boolean.FALSE;
                JSFUtils.addFacesErrorMessage(
                    "El Plazo de financiamiento debe ser mayor a cero." +
                    textoLinea);
            }
        }
        ...
        if ((JSFUtils.resolveExpression("#{bindings.MontoLinea.inputValue}") == null) ||
                (JSFUtils.resolveExpression("#{bindings.MontoLinea.inputValue}")
                             .toString().trim().length() < 1)) {
            esDatosCorrectos = Boolean.FALSE;
            JSFUtils.addFacesErrorMessage(
                "El campo Monto de la línea es requerido." + textoLinea);
        }
        ...
        java.sql.Timestamp fechaVencimientoLineaCredito = (java.sql.Timestamp) JSFUtils.resolveExpression(
                "#{bindings.FechaVencimiento.inputValue}");
        ...
        while (hasNext) {
            ...
            if (r == null) {
                ...
                if (r.getAttribute("IdTipoDeVencimiento") != null) {
                    Integer idTipoVencimiento = Integer.parseInt(r.getAttribute(
                                "IdTipoDeVencimiento").toString());
                    ...
                    case 2: //Validar si posee el tipo de vencimiento 2, PoseeInicioDesembolso
                        ...
                        logger.warning("fechaVencimientoInicioDesembolsos: " +
                            fechaVencimientoInicioDesembolsos);
                    ...
                    case 3: //Validar si posee el tipo de vencimiento 3, DesembolsoTotalidadRecursos
                        ...
                        logger.warning("fechaVencimientoTotalidadRecursos: " +
                            fechaVencimientoTotalidadRecursos);
        ...
        if (!poseeDesembolsoTotalidadRecursos) {
            JSFUtils.addFacesErrorMessage(
                "Debe agregar un vencimiento de plazo del tipo \"Desembolso de la totalidad de los recursos\"." +
                textoLinea);
            vVerfiicar = false;
        } else {
            if (!poseeDesembolsoTotalidadRecursosVencimiento) {
                JSFUtils.addFacesErrorMessage(
                    "Debe agregar la fecha de vencimiento para el plazo del tipo \"Desembolso de la totalidad de los recursos\"." +
                    textoLinea);
                vVerfiicar = false;
            }
        }
        ...
        if (!poseeInicioDesembolso) {
            JSFUtils.addFacesErrorMessage(
                "Debe agregar un vencimiento de plazo del tipo \"Inicio de Desembolso\"." +
                textoLinea);
            vVerfiicar = false;
        } else {
            if (!poseeInicioDesembolsoVencimiento) {
                JSFUtils.addFacesErrorMessage(
                    "Debe agregar la fecha de vencimiento para el plazo del tipo \"Inicio de Desembolso\"." +
                    textoLinea);
                vVerfiicar = false;
            }
        }
        ...
        if (!vVerfiicar) {
            esDatosCorrectos = Boolean.FALSE;
            logger.log(ADFLogger.WARNING,
                "esDatosCorrectos : " + esDatosCorrectos.toString());
        }
        ...
        /*
        if ((fechaVencimientoLineaCredito != null) &&
                (fechaVencimientoTotalidadRecursos != null) &&
                (fechaVencimientoLineaCredito.compareTo(
                    fechaVencimientoTotalidadRecursos) < 0)) {
            esDatosCorrectos = Boolean.FALSE;
            JSFUtils.addFacesErrorMessage(
                "La Fecha de vencimiento en datos de la Línea de crédito es menor a la " +
        ...
        */
        ...
        if ((fechaVencimientoInicioDesembolsos != null) &&
                (fechaVencimientoTotalidadRecursos != null) &&
                (fechaVencimientoInicioDesembolsos.compareTo(
                    fechaVencimientoTotalidadRecursos) > 0)) {
            esDatosCorrectos = Boolean.FALSE;
            JSFUtils.addFacesErrorMessage(
                "La Fecha vencimiento de Inicio de Desembolsos debe ser menor o igual a la " +
                "Fecha máxima para desembolsar la totalidad de los recursos.");
        }

        logger.warning(
            "Finaliza validarDatosLineaCredito con esDatosCorrectos en: " +
            esDatosCorrectos);
    ...
    public void agregarLineaCreditoActionListener(ActionEvent actionEvent) {
        ...
        operationBinding = bindings.getOperationBinding(
                "crearUnicoRowAgregarLineaCredito");
        operationBinding.execute();
    ...
    public void cancelarAgregarLineaCreditoActionListener(
        ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside cancelarAgregarLineaCreditoActionListener");
        ...
        if (operationBinding != null) {
            ...
            if (!operationBinding.getErrors().isEmpty()) {
                logger.severe(
                    "Error al eliminar el Row temporal de Linea de Credito");
            }
        }

        //Refresca tabla de Lineas de credito.
        AdfFacesContext.getCurrentInstance()
                       .addPartialTarget(getTablaDatosLineaCredUIC());
    }

    public void aceptarAgregarLineaCreditoActionListener(
        ActionEvent actionEvent) {
        ...
        if (null != JSFUtils.resolveExpression(
                    "#{bindings.IdContrato1.inputValue}")) {
            Integer idContratoLong = (Integer) JSFUtils.resolveExpression(
                    "#{bindings.IdContrato1.inputValue}");
        ...
        if (null != JSFUtils.resolveExpression(
                    "#{bindings.NumeroLineaCredito1.inputValue}")) {
            numeroLineaCredito = (String) JSFUtils.resolveExpression(
                    "#{bindings.NumeroLineaCredito1.inputValue}");
        }

        if (null != JSFUtils.resolveExpression(
                    "#{bindings.DescripcionLinea.inputValue}")) {
            descripcionLinea = (String) JSFUtils.resolveExpression(
                    "#{bindings.DescripcionLinea.inputValue}");
        }
        ...
        try {
            sMontoLinea = (String) JSFUtils.resolveExpression(
                    "#{bindings.MontoLinea1.inputValue}");
        } catch (Exception e) {
            logger.log(ADFLogger.WARNING,
                "Error no se puede castear el valor MontoLinea1");
        }

        try {
            if (null == sMontoLinea) {
                BigDecimal bcMontoLinea = (BigDecimal) JSFUtils.resolveExpression(
                        "#{bindings.MontoLinea1.inputValue}");
        ...
        if (null != sMontoLinea) {
            try {
                logger.warning("+++++++++++++ sMontoLineaCredito: " +
                    sMontoLinea);
                montoLinea = NumbersUtil.stringToBigDecimal(Constants.FORMATO_MONTO_LINEA,
                        sMontoLinea);
            } catch (ParseException e) {
                // Manejo de errores
                JSFUtils.addFacesErrorMessage("No es posible convertir el monto de l\u00EDnea".concat(
        ...
        try {
            idOperacion = (String) JSFUtils.resolveExpression(
        ...
        operationBinding.getParamsMap()
                        .put("numeroLineaCredito", numeroLineaCredito);
        ...
        if (!operationBinding.getErrors().isEmpty()) {
            ...
            //JSFUtils.addFacesErrorMessage(operationBinding.getErrors().toString());
            logger.severe(
                "Muestra mensaje de error al crear la linea de credito");
            JSFUtils.addFacesErrorMessage(getStringFromBundle(
                    "ERROR_CREAR_LINEA_CREDITO"));
        } else {
            ...
            if ((result != null) && result) {
                ...
                logger.warning(
                    "Muestra mensaje de exito al crear la linea de credito");
                JSFUtils.addFacesInformationMessage(getStringFromBundle(
                        "EXITO_CREAR_LINEA_CREDITO"));
            } else {
                logger.severe(
                    "Muestra mensaje de error al crear la linea de credito");
                JSFUtils.addFacesErrorMessage(getStringFromBundle(
    ...
    public void modificarLineaCreditoActionListener(ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside modificarLineaCreditoActionListener");
        ...
        if(sMontoLineaCredito != null) {
            try {
                logger.warning("+++++++++++++ sMontoLineaCredito: " + sMontoLineaCredito);
        ...
        */
        ...
        if (getFormAgregarEditarLineaUIC() != null) {
            ...
            AdfFacesContext.getCurrentInstance()
                           .addPartialTarget(getFormAgregarEditarLineaUIC());
        }

        if (getPopupModificarLineaCredito() != null) {
            logger.warning("Refresca Popup");
            AdfFacesContext.getCurrentInstance()
                           .addPartialTarget(getPopupModificarLineaCredito());
        }
    }

    public void cancelarModificarLineaCreditoActionListener(
        ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside cancelarModificarLineaCreditoActionListener");
    ...
    public void mappingModificarLineaCredito() {
        ...
        operationBinding = bindings.getOperationBinding(
                "CreateInsertAgregarLineaCredito");
        ...
        if (operationBinding != null) {
            ...
            if (ADFUtils.getBoundAttributeValue("Id3") != null) {
                try {
                    idLinea = Long.valueOf(ADFUtils.getBoundAttributeValue(
                                "Id3").toString());
                } catch (Exception e) {
                    logger.severe(
                        "Error al obtener el Id de la Linea de Credito");
                }
            }
            ...
            if (ADFUtils.getBoundAttributeValue("NumeroLineaCredito2") != null) {
                strNumLinea = ADFUtils.getBoundAttributeValue(
                        "NumeroLineaCredito2").toString();
            }

            String strDesc = null;

            if (ADFUtils.getBoundAttributeValue("Descripcion1") != null) {
                strDesc = ADFUtils.getBoundAttributeValue("Descripcion1")
                                  .toString();
            }
            ...
            if (ADFUtils.getBoundAttributeValue("MontoLinea2") != null) {
                String strNumber = ADFUtils.getBoundAttributeValue(
                        "MontoLinea2").toString();
                logger.warning("Monto obtenido de la linea: " + strNumber);

                try {
                    //bigMonto = (BigDecimal)ADFUtils.getBoundAttributeValue("MontoLinea2");
                    bigMonto = BigDecimal.valueOf(NumberFormat.getInstance()
                                                              .parse(strNumber)
                                                              .doubleValue());
                    logger.warning("Monto obtenido de la conversion: " +
                        bigMonto);
                } catch (Exception e) {
                    logger.severe(
                        "Error al obtener y convertir monto de la linea de credito");
                }
            }
            ...
            if (!operationBinding.getErrors().isEmpty()) {
                ...
                ADFUtils.setBoundAttributeValue("NumeroLineaCredito1",
                    strNumLinea);
                ...
                logger.warning(
                    "Creacion y asignacion del Row para Editar la linea concluida con exito");
            }
        }
    }

    public void aceptarModificarLineaCreditoActionListener(
        ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside aceptarModificarLineaCreditoActionListener");
        ...
        if (null != JSFUtils.resolveExpression("#{bindings.Id2.inputValue}")) {
            idLineaCredito = (Long) JSFUtils.resolveExpression(
                    "#{bindings.Id2.inputValue}");
        }
        ...
        if (null != JSFUtils.resolveExpression(
                    "#{bindings.DescripcionLinea.inputValue}")) {
            descripcionLineaCredito = (String) JSFUtils.resolveExpression(
                    "#{bindings.DescripcionLinea.inputValue}");
        }
        ...
        if (null != JSFUtils.resolveExpression(
            ...
            try {
                dbNumber = NumberFormat.getInstance().parse(strNumber)
                                       .doubleValue();
        ...
        if (ADFUtils.getBoundAttributeValue("IdContrato1") != null) {
            try {
                idContrato = new Long(ADFUtils.getBoundAttributeValue(
                            "IdContrato1").toString());
            } catch (Exception e) {
        ...
        if (ADFUtils.getBoundAttributeValue("LineaGlobalIfi") != null) {
            try {
                lineaGlobalIfi = (Boolean) ADFUtils.getBoundAttributeValue(
                        "LineaGlobalIfi");
            } catch (Exception e) {
        ...
        if ((null != lineaGlobalIfi) && lineaGlobalIfi.equals(Boolean.FALSE)) {
            operationBinding = bindings.getOperationBinding(
                    "modificarLineaCreditoPorContrato");
            ...
            operationBinding.getParamsMap()
                            .put("numeroLineaCredito", numeroLineaCredito);
            operationBinding.getParamsMap()
                            .put("descripcionLineaCredito",
                descripcionLineaCredito);
            operationBinding.getParamsMap()
                            .put("montoLineaCredito", montoLineaCredito);
            operationBinding.execute();
        } else {
            operationBinding = bindings.getOperationBinding(
                    "modificarLineaCreditoPorIdLineaCredito");
            //Se envian los parametros del metodo modificarLineaCredito
            operationBinding.getParamsMap().put("idLineaCredito", idLineaCredito);
            operationBinding.getParamsMap()
                            .put("numeroLineaCredito", numeroLineaCredito);
    ...
    public void eliminarLineaCreditoActionListener(ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside eliminarLineaCreditoActionListener");
    ...
    public void cancelarEliminarLineaCreditoActionListener(
        ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside cancelarEliminarLineaCreditoActionListener");
    ...
    public void aceptarEliminarLineaCreditoActionListener(
        ActionEvent actionEvent) {
        logger.log(ADFLogger.WARNING,
            "Inside aceptarEliminarLineaCreditoActionListener");
    ...
    public void actualizarLineaCredito() {
        ...
        operationBinding.getParamsMap()
            ...
            JSFUtils.resolveExpression("#{pageFlowScope.pIdProducto}"));
        operationBinding.getParamsMap()
                        .put("solicitudContratacion", solicitudContratacion);
        logger.warning("instanciaProcesoR2: " +
            JSFUtils.resolveExpression("#{pageFlowScope.pInstanciaProceso}"));
    ...
    public void setPopupModificarLineaCredito(
        RichPopup popupModificarLineaCredito) {
    ...
    public void setPopupEliminarLineaCredito(
        RichPopup popupEliminarLineaCredito) {
    ...
    public void obtenerFechaInicio(ValueChangeEvent valueChangeEvent) {
        if (null != valueChangeEvent) {
            logger.warning("valor de tipo fecha de inicio: " +
                valueChangeEvent.getNewValue());

            Integer tipofechaInicio = null;
            Long idOperacion = new Long(JSFUtils.resolveExpression(
                        "#{pageFlowScope.pIdOperacion}").toString());
            ...
            if (null != valueChangeEvent.getNewValue()) {
                ...
                */
                ...
                try {
                    lngIdTipoFechaInicio = (Long) ADFUtils.getBoundAttributeValue(
                            "IdTipoDeFecha");
                    ...
                    logger.severe(
                        "No se pudo obtener el Id de Fecha Inicio de Vencimiento Plazo");
                }

                if ((null != tipofechaInicio) && (null != idOperacion)) {
                    BindingContainer bindings = ADFUtils.getBindingContainer();
                    OperationBinding operationBinding = bindings.getOperationBinding(
                            "obtenerTipoFechaInicio");
                    operationBinding.getParamsMap()
                                    .put("idFechaInicio", tipofechaInicio);
                    operationBinding.getParamsMap()
                    ...
                    if (!operationBinding.getErrors().isEmpty()) {
                        ...
                        fechaInicioBinding = ADFUtils.findControlBinding(
                                "FechaInicio");

                        if (null != operationBinding.getResult()) {
                            Timestamp fechaInicio = Timestamp.valueOf(operationBinding.getResult()
                                                                                      .toString());
                            logger.warning("Fecha obtenida del modelo: " +
                                fechaInicio);
                        ...
                        AdfFacesContext.getCurrentInstance()
                                       .addPartialTarget(getFechaInicioUIC());
                    }
                }
            }
        }
    ...
    public void tipoFrecuenciaChangeListener(ValueChangeEvent valueChangeEvent) {
        ...
        try {
            strFrecuencia = (String) ADFUtils.getBoundAttributeValue(
                    "Frecuencia");
        } catch (Exception e) {
            logger.warning("Error al obtener el valor de Frecuencia");
        }

        if ((value != null) && strAlVenciValue.equals(value) &&
                !"".equals(strFrecuencia)) {
            ADFUtils.setBoundAttributeValue("Frecuencia", "1");
            AdfFacesContext.getCurrentInstance()
                           .addPartialTarget(comisionFrecuenciaUIC);
        }
    }

    public void setFormAgregarEditarLineaUIC(
        RichPanelFormLayout formAgregarEditarLineaUIC) {
    ...
    public void setBtnActualizarInformacionUIC(
        RichButton btnActualizarInformacionUIC) {
        this.btnActualizarInformacionUIC = btnActualizarInformacionUIC;
    }

    public RichButton getBtnActualizarInformacionUIC() {
        return btnActualizarInformacionUIC;
    }

    public void setFormDatosLineaCreditoUIC(
        RichPanelGroupLayout formDatosLineaCreditoUIC) {
    ...
    public Boolean seleccionaOpcionMora(ValueChangeEvent valueChangeEvent) {
        ...
        bindingCodigoTasaReferencia = ADFUtils.findControlBinding(
        ...
        valueChangeEvent.getComponent()
                        .processUpdates(FacesContext.getCurrentInstance());
        opcionMora = JSFUtils.resolveExpression(
                "#{bindings.TcaTipoMoraVO1.inputValue}").toString();
    ...
    public BigDecimal calcularTasaTotal(BigDecimal tasaReferencia,
        BigDecimal valorSpread) {
        logger.warning("Inside calcularTasaTotal.");

        BigDecimal tasaTotal = null;
        tasaReferencia = (tasaReferencia == null) ? BigDecimal.ZERO
                                                  : tasaReferencia;
    ...
    public void tasaReferenciaValueChange(ValueChangeEvent valueChangeEvent) {
        ...
        logger.warning("valueNewCodigoTasaReferencia: " +
            valueChangeEvent.getNewValue());
        ...
        BigDecimal spreadTasa = (BigDecimal) ADFUtils.getBoundAttributeValue(
                "SpreadTasa");
        BigDecimal valorTasaReferenciaSpread = (BigDecimal) ADFUtils.getBoundAttributeValue(
        ...
        if ((descripcionTasa == null) || descripcionTasa.equals("")) {
            BigDecimal valorTasaSpread = (null == ADFUtils.getBoundAttributeValue(
                    "SpreadTasa")) ? null
                                   : (BigDecimal) ADFUtils.getBoundAttributeValue(
                    "SpreadTasa");
            ...
            logger.warning("Saneando numeracion a la cadena: " +
                descripcionTasa);
            descripcionTasa = descripcionTasa.substring(descripcionTasa.indexOf(
                        " ") + 1);
            logger.warning("Cadena saneada: " + descripcionTasa);
        }

        operationBinding = bindings.getOperationBinding(
                "obtenerValorTasaReferencia");
        ...
        if (valorTasaReferenciaSpread != null) {
            if ((valorActual != null) && (valorTasaReferenciaSpread != null)) {
                bindingTasaTotal.setInputValue(calcularTasaTotal(valorActual,
                        valorTasaReferenciaSpread));
            }
        } else {
    ...
    public List onSuggest(String string) {
        ...
        OperationBinding setVariable = (OperationBinding) bindings.get(
                "setbuscadescripcionTasa");
        setVariable.getParamsMap().put("value", string);
        setVariable.execute();
        System.out.println("valor asignado");

        JUCtrlHierBinding hierBinding = (JUCtrlHierBinding) bindings.get(
    ...
    public BigDecimal getMontoDesobligar() {
        if (this.montoDesobligar == null) {
            logger.warning("Leyendo Monto a Desobligar desde mapa en memoria.");
            ...
            if (idLineaCredito == null) {
                logger.warning(
                    "ID linea crédito evaluó a nulo, no se puede obtener monto a desobligar desde el mapa en memoria");
            }
    ...
    public void setDesobligacionFin(Boolean finalizo) {
        logger.warning("Inicia setDesobligacionFin");
        this.desobligacionFin = finalizo;
        logger.warning("this.desobligacionFin: " + this.desobligacionFin);
    }
     ...
     * @return Monto a desobligar para la línea.
     */
    public Boolean getDesobligacionFin() {
        logger.warning("Inicia getDesobligacionFin");

        try {
            logger.warning("Leyendo Desobliga desde mapa en memoria." +
                this.desobligacionFin);
            ...
            if (this.desobligacionFin == null) {
                ...
                Map mapDesobligacionFin = (Map) ADFContext.getCurrent()
                                                          .getPageFlowScope()
                                                          .get("desobligacionFin");
                logger.warning("mapDesobligacionFin " + mapDesobligacionFin);

                if (mapDesobligacionFin != null) {
                    logger.warning("mapDesobligacionFin no es null");

                    String vDesobligacionFin = mapDesobligacionFin.get(
                            "DESOBLIGACION_FIN").toString();
                    logger.warning("vDesobligacionFin: " + vDesobligacionFin);

                    if (vDesobligacionFin.toLowerCase().equals("true")) {
                        this.desobligacionFin = Boolean.TRUE;
                    } else {
                        this.desobligacionFin = Boolean.FALSE;
                    }
                }
            }
        } catch (Exception exp) {
            logger.warning(" getDesobligacionFin error: " + exp);
        }

        return this.desobligacionFin;
    }
    ...
    private void launchUpdateLCEvent(ActionEvent evt) {
        logger.warning("Inside launchEventActionListener");

        JUEventBinding eventBinding = (JUEventBinding) ADFUtils.getBindingContainer()
                                                               .get("updatLCEventBinding");

        if (eventBinding == null) {
            logger.warning("ContextEvent not found!!!");
        } else {
            logger.warning("Lanzando evento");
    ...
    /**
     * Lanza un context event como resultado de la desobligacion finalizda para que la página padre de este taskflow pueda
     * actualizar el payload de la tarea.
     */
    private void launchDesobligacionFinEvent(ActionEvent evt) {
        logger.warning("Inside launchDesobligacionFinEvent");

        JUEventBinding eventBinding = (JUEventBinding) ADFUtils.getBindingContainer()
                                                               .get("desobligacionFinEventBinding");
    ...
    public void confirmarPropagarLineasCredito(ActionEvent evt) {
        logger.warning("Inside confirmarPropagarLineasCredito");
        this.setDesobligacionFin(Boolean.TRUE);
        ...
        if (desobligacion) {
            ...
            Map<Long, BigDecimal> mapMontosDesobligar = (Map) ADFContext.getCurrent()
                                                                        .getPageFlowScope()
                                                                        .get("montosDesobligar");

            if ((mapMontosDesobligar == null) ||
                    (mapMontosDesobligar.size() == 0)) {
                logger.warning("No se encontraron líneas para desobligar. Mapa de montos a desobligar {0}",
                    mapMontosDesobligar);
                JSFUtils.addFacesErrorMessage(
                    "No se encontraron líneas de crédito con montos por desobligar.");

                return;
            }

            logger.warning("{0} Líneas de crédito para desobligar encontradas",
                mapMontosDesobligar.size());
            ...
            for (Map.Entry<Long, BigDecimal> entry : mapMontosDesobligar.entrySet()) {
                ...
                logger.warning("Línea {0} => MontoDesobligar {1}",
                    new Object[] { idLinea, montoDesobligarLC });

                if (montoDesobligarLC == null) {
                    //esto no debería de suceder, pero en caso de que suceda, no se procesará la línea
                    logger.warning(
                        "Línea con monto por desobligar nulo no será procesada");
                ...
                if (!validarDesobligacion()) {
                    ...
                    logger.warning("Falló la validación de la desobligación para la línea {0}",
                        idLinea);
                ...
                logger.warning(
                    "Validación de la desobligación exitosa. Calculando y actualizando montos");

                BigDecimal oldMontoLinea = (BigDecimal) JSFUtils.resolveExpression(
                        "#{bindings.MontoLinea.inputValue}");
                BigDecimal newMontoLinea = calcularNuevoMontoLinea(oldMontoLinea,
                        montoDesobligarLC);

                //Actualizar monto linea actual
                JSFUtils.setExpressionValue("#{bindings.MontoLinea.inputValue}",
                    newMontoLinea);

                if (!invocarActualizarLinea()) {
                    propagacionExitosa = false;
                    logger.warning(
                        "Falló actualización de línea de crédito. Solicitando rollback");
                ...
                logger.warning("Se volver a ejecutar consultarLineaCredito");
                consultarLineaCredito(idLinea);
                logger.warning("Actualización de línea de crédito exitosa");
                ...
                if (!invocarPropagarLinea(idLinea)) {
                    propagacionExitosa = false;
                    logger.warning(
                        "Falló la propagación de línea de crédito. Solicitando rollback");
                    rollbackPropagarLineas();
            ...
            if (propagacionExitosa) {
                logger.warning("Propagación exitosa. Lanzando evento");
                this.launchPropagarLCEvent(evt);
                logger.warning("Ejecutar desobligacionFin");
                this.setDesobligacionFin(null);

                Map mapDesobligacionFin = (Map) ADFContext.getCurrent()
                                                          .getPageFlowScope()
                                                          .get("desobligacionFin");
                mapDesobligacionFin.put("DESOBLIGACION_FIN", "true");
                launchDesobligacionFinEvent(evt);

                String msg = ADFUtils.getStringFromBundle("VALIDAR_REGISTRO_ACTUALIZACION_OK",
                        BUNDLE);
                JSFUtils.addFacesInformationMessage(msg);
                logger.warning("Inicia getOtInitForm");
                getOtInitForm();
                logger.warning("Finaliza getOtInitForm");
            } else {
                logger.warning("Fallo Propagación.");
                this.setDesobligacionFin(Boolean.FALSE);
            }
        }

        getPopupConfirmacionPropagar().hide();
        logger.warning("Fin confirmarPropagarLineasCredito");
    }

    public void AceptarConfirmarPropagarLineasCredito(ActionEvent evt) {
        logger.warning("Inside AceptarConfirmarPropagarLineasCredito");
        AceptarConfirmarPropagarLineasCredito = true;
        logger.warning("setDisabled");
        getBtnActualizarInformacionUIC().setDisabled(true);
        logger.warning("Inicio getBtnActualizarInformacionUIC");
        AdfFacesContext.getCurrentInstance()
                       .addPartialTarget(getBtnActualizarInformacionUIC());
        logger.warning("fin getBtnActualizarInformacionUIC");
        cancelarPopupConfirmacionPropagar(evt);
        logger.warning("Fin AceptarConfirmarPropagarLineasCredito");
    }
     ...
     */
    private BigDecimal calcularNuevoMontoLinea(final BigDecimal montoLinea,
        final BigDecimal desobligar) {
        logger.warning("Dentro de calcularNuevoMontoLinea");

        BigDecimal nuevoMontoLinea = montoLinea.subtract(desobligar);

        logger.warning("MontoLinea=>{0}, Desobligar=>{1}, NuevoMontoLinea=>{2}",
            new Object[] { montoLinea, desobligar, nuevoMontoLinea });
     ...
     */
    private void putLineaInUndoMontosMap(final Long idLinea,
        final BigDecimal montoLineaOriginal) {
        logger.warning("Dentro de putLineaInUndoMontosMap");

        Map<String, Object> mapViewScope = ADFContext.getCurrent().getViewScope();

        logger.warning("Almacenando línea {0} al undoMap. Monto original => {1}",
            new Object[] { idLinea, montoLineaOriginal });
    ...
    private boolean invocarActualizarLinea() {
        logger.warning("Dentro de invocarActualizarLinea");
        ...
        logger.warning("Ejecutando actualizarLineaCredito");
        operationBinding.execute();
    ...
    private boolean invocarPropagarLinea(final Long idLinea) {
        logger.warning("Dentro de invocarPropagarLinea");

        boolean exito = true;

        //Notese el uso de attibuteValue en vez de inutValue. Esto porque inputValue retorna la fecha formateada a String...
        Timestamp fechaValor = (Timestamp) JSFUtils.resolveExpression(
                "#{bindings.FechaValorContrato.attributeValue}");
        logger.warning("idLinea=>{0}, fechaValor=>{1}",
            new Object[] { idLinea, fechaValor });

        // Ejecuta el metodo actualizarLineaCredito
        OperationBinding operationBinding = ADFUtils.findOperation(
                "propagarLineaCredito");
        operationBinding.getParamsMap().put("idLinea", idLinea);
        operationBinding.getParamsMap().put("fechaValor", fechaValor);

        logger.warning("Ejecutando propagarLineaCredito");

        String resultadoPropagacion = (String) operationBinding.execute();
        logger.warning("resultadoPropagacion=>{0}", resultadoPropagacion);
    ...
    private boolean validarDesobligacion() {
        logger.warning("Dentro de validarDesobligacion");
        ...
        if (!desobligacion) {
            logger.warning(
                "No se trata de una desobligación. No se continúa la validación");
        ...
        logger.warning("Validando línea {0}", numeroLineaCredito);

        BigDecimal montoDisponible = (BigDecimal) JSFUtils.resolveExpression(
                "#{bindings.MontoDisponible.inputValue}");
        logger.warning("montoDisponible = {0}", montoDisponible);

        if (montoDisponible == null) {
            exito = false;
            logger.warning(
                "MontoDisponible es nulo. No se puede validar monto a desobligar sin este valor");
            JSFUtils.addFacesErrorMessage(
                "El monto Monto Disponible no pudo ser leido. No se puede validar la linea." +
                textoLinea);
        } else {
            logger.warning("montoDesobligar = {0}", this.montoDesobligar);
            ...
            if (this.montoDesobligar != null) {
                ...
                if ((this.montoDesobligar.compareTo(BigDecimal.ZERO) <= 0) ||
                    ...
                    logger.warning(
                        "Monto a Desobligar debe ser mayor a cero y menor o igual a Monto Disponible de la línea");
                    JSFUtils.addFacesErrorMessage(
                        "El monto a desobligar debe ser un valor mayor a 0 y menor o igual a " +
                        montoDisponible.toString() + "." + textoLinea);
                }
            }
        }

        BigDecimal montoLinea = (BigDecimal) JSFUtils.resolveExpression(
                "#{bindings.MontoLinea.inputValue}");
        logger.warning("montoLinea = {0}", montoLinea);

        if (montoLinea == null) {
            exito = false;
            logger.warning(
                "MontoLinea es nulo. No se puede validar monto a desobligar sin este valor");
            JSFUtils.addFacesErrorMessage(
                "El monto Monto de la línea no pudo ser leido. No se puede validar la linea." +
                textoLinea);
        } else {
            logger.warning("montoDesobligar = {0}", this.montoDesobligar);
            ...
            if (this.montoDesobligar != null) {
                if (montoLinea.compareTo(montoDesobligar) < 0) {
                    exito = false;
                    logger.warning(
                        "MontoDesobligar es mayor al monto de la línea");
                    JSFUtils.addFacesErrorMessage(
                        "El valor del nuevo Monto para la Línea sería negativo y no se puede continuar con la actualización." +
                        textoLinea);
                }
            }
        }
    ...
    private void rollbackPropagarLineas() {
        logger.warning("Dentro de rollbackPropagarLineas");

        Map<Long, BigDecimal> mapUndoMontosLineas = (Map) ADFContext.getCurrent()
                                                                    .getViewScope()
                                                                    .get("undoMontosLineas");

        if (mapUndoMontosLineas != null) {
            logger.warning("Iniciando rollback de {0} líneas",
                mapUndoMontosLineas.size());

            for (Map.Entry<Long, BigDecimal> entry : mapUndoMontosLineas.entrySet()) {
                Long idLinea = entry.getKey();
                BigDecimal montoLineaOriginal = entry.getValue();
                logger.warning("Línea=>{0}, MontoLineaOriginal=>{1}",
                    new Object[] { idLinea, montoLineaOriginal });

                if (montoLineaOriginal == null) {
                    //esto no debería de suceder, pero en caso de que suceda, no se procesará la línea
                    logger.warning(
                        "Línea con monto original nulo no será procesada");
                ...
                if (invocarActualizarLinea()) {
                    logger.warning("Rollback de la Linea {0} exitoso", idLinea);
                    //elimina la línea del rollback
                    mapUndoMontosLineas.remove(idLinea);
                } else {
                    logger.warning("Rollback de la Linea {0} fallido", idLinea);
                }
            }
        } else {
            logger.warning("No se encontraron lineas para rollback");
        }
    }
    ...
    public void cancelarPopupConfirmacionPropagar(ActionEvent actionEvent) {
        if (AceptarConfirmarPropagarLineasCredito) {
            logger.warning("Acepto popup de confirmacion.");
            confirmarPropagarLineasCredito(actionEvent);
            logger.warning("Finalizo Acepto popup de confirmacion.");
        } else {
            logger.warning("Cancela popup de confirmacion.");
            getPopupConfirmacionPropagar().hide();
        }
    }
