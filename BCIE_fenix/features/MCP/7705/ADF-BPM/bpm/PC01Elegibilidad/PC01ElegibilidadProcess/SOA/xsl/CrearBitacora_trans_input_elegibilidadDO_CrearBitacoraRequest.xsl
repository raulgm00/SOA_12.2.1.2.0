...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [MON AUG 21 20:06:23 CDT 2017].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <tns:CrearBitacoraRequest>
      <tns:BitacoraInput>
        ...
        <regBitBO:idProceso>1</regBitBO:idProceso>
        <regBitBO:nombreProceso>PC01</regBitBO:nombreProceso>
        <regBitBO:instanciaProceso>
          <xsl:value-of select="/ns0:ElegibilidadPayload/ns0:Header/header:Proceso/ns3:InstanciaProceso"/>
        </regBitBO:instanciaProceso>
        <regBitBO:esProceso>true</regBitBO:esProceso>
        <regBitBO:usuario>
          <xsl:value-of select="/ns0:ElegibilidadPayload/ns0:Header/header:Operacion/ns2:ResponsableOperacion"/>
        </regBitBO:usuario>
