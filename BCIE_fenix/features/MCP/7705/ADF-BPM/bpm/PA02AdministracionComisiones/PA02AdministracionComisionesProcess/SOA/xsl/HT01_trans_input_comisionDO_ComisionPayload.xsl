...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [FRI MAY 19 12:47:45 CDT 2017].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:ComisionPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns5:CodigoTarea>67</ns5:CodigoTarea>
          <ns5:NombreTarea>Gestionar Comision</ns5:NombreTarea>
          <ns5:CodigoRol>1</ns5:CodigoRol>
          <ns5:NombreRol>Responsable Operacion</ns5:NombreRol>
          <ns5:CodigoProceso>8</ns5:CodigoProceso>
          <ns5:NombreProceso>Administración Comisiones</ns5:NombreProceso>
        </header:Tarea>
        <header:Proceso>
          <ns3:IdProceso>
