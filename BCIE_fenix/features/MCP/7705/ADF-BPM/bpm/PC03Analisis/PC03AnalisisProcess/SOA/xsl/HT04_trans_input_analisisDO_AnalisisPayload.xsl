...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [THU SEP 17 14:53:35 CDT 2015].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:AnalisisPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns2:CodigoTarea>28</ns2:CodigoTarea>
          <ns2:NombreTarea>Elaborar Dictamen y Proyecto de Resolución</ns2:NombreTarea>
          <ns2:CodigoRol>15</ns2:CodigoRol>
          <ns2:NombreRol>Ejecutivo Área Técnica</ns2:NombreRol>
      ...
      <ns0:Configuration>
        ...
        <xsl:choose>
          <xsl:when test="/ns0:AnalisisPayload/ns0:Configuration/ns0:tieneRiesgoCredito">
            <ns0:tieneRiesgoCredito>
              <xsl:value-of select="/ns0:AnalisisPayload/ns0:Configuration/ns0:tieneRiesgoCredito"/>
            </ns0:tieneRiesgoCredito>
          </xsl:when>
          <xsl:otherwise>
            <ns0:tieneRiesgoCredito>false</ns0:tieneRiesgoCredito>
          </xsl:otherwise>
        </xsl:choose>
        <xsl:choose>
          <xsl:when test="/ns0:AnalisisPayload/ns0:Configuration/ns0:requireOpinionJuridica">
            <ns0:requireOpinionJuridica>
              <xsl:value-of select="/ns0:AnalisisPayload/ns0:Configuration/ns0:requireOpinionJuridica"/>
            </ns0:requireOpinionJuridica>
          </xsl:when>
          <xsl:otherwise>
            <ns0:requireOpinionJuridica>false</ns0:requireOpinionJuridica>
          </xsl:otherwise>
        </xsl:choose>
        <xsl:choose>
          <xsl:when test="/ns0:AnalisisPayload/ns0:Configuration/ns0:requireSCR">
            <ns0:requireSCR>
              <xsl:value-of select="/ns0:AnalisisPayload/ns0:Configuration/ns0:requireSCR"/>
            </ns0:requireSCR>
          </xsl:when>
          <xsl:otherwise>
            <ns0:requireSCR>false</ns0:requireSCR>
          </xsl:otherwise>
        </xsl:choose>
        <xsl:choose>
          <xsl:when test="/ns0:AnalisisPayload/ns0:Configuration/ns0:esInstitucionFinanciera">
            <ns0:esInstitucionFinanciera>
              <xsl:value-of select="/ns0:AnalisisPayload/ns0:Configuration/ns0:esInstitucionFinanciera"/>
            </ns0:esInstitucionFinanciera>
          </xsl:when>
          <xsl:otherwise>
            <ns0:esInstitucionFinanciera>false</ns0:esInstitucionFinanciera>
          </xsl:otherwise>
        </xsl:choose>
