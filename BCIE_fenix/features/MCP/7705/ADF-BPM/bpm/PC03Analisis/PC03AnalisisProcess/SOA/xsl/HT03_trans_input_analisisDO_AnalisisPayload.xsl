...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [THU SEP 17 11:32:31 CDT 2015].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:AnalisisPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns2:CodigoTarea>19</ns2:CodigoTarea>
          <ns2:NombreTarea>Elaborar Opinión Jurídica</ns2:NombreTarea>
