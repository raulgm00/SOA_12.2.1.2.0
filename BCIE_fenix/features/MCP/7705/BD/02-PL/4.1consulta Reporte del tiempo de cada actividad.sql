/* Formatted on 09/08/2017 03:47:52 p.m. (QP5 v5.136.908.31019) */
  ...
  INICIO.ID_OPERACION AS ID_OPERACION,
    ...
    FROM (SELECT TPO.ID,
           ...
           WHERE BAN_ES_PROCESO = 0 AND BAN_ES_FIN_ACTIVIDAD = 0) INICIO
