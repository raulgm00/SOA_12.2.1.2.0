...
declare namespace car = "http://www.bcie.org/CargoTramiteBO";
...
declare variable $responseMapeorError as element() (:: schema-element(ns1:responseMapeoErrorMessage) ::) external;
...
declare function local:func($message as xs:normalizedString, 
                            ...
                            as element() (:: schema-element(ns2:CrearComisionFLEXCUBEResponse) ::) {
    <ns2:CrearCargoTramiteFLEXCUBEResponse>
        <ns2:Resultado>
