...
declare variable $ConsultarDesembolsosByIdResponse as element() (:: schema-element(ns1:ConsultarDesembolsosByIdV2Response) ::) external;
...
declare function local:func($ConsultarDesembolsosByIdResponse as element() (:: schema-element(ns1:ConsultarDesembolsosByIdV2Response) ::), 
                            $ConvertirMonedasImportesResponse as element() (:: schema-element(ns2:ConvertirMonedasImportesResponse) ::)) 
                            as element() (:: schema-element(ns1:ConsultarDesembolsosByIdV2Response) ::) {
    <ns1:ConsultarDesembolsosByIdV2Response>
    {               
