...
declare function local:func($message as xs:string,$responseMapeoErrorMessage as element() (:: schema-element(ns1:responseMapeoErrorMessage) ::)) as element() (:: schema-element(ns2:ConsultarLineaCreditoByIdLineaCreditoResponse) ::) {
