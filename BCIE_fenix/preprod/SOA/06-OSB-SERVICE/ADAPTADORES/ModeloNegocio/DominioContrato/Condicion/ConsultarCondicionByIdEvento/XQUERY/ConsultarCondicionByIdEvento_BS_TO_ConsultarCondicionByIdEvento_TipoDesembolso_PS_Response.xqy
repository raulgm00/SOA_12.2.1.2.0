...
declare variable $ConsultarCondicionByIdEventoRequest as element() (:: schema-element(ns3:ConsultarCondicionByIdEventoRequest) ::) external;
...
declare function local:func($consultarCondicionByRolOutputCollection as element() (:: schema-element(ns2:consultarCondicionByRolOutputCollection) ::), 
                            ...
                            $ConsultarCondicionByIdEventoRequest as element() (:: schema-element(ns3:ConsultarCondicionByIdEventoRequest) ::)) 
                            as element() (:: schema-element(ns3:ConsultarCondicionByIdEventoResponse) ::) {
    <ns3:ConsultarCondicionByIdEventoResponse>
        {for $condicion in $consultarCondicionByRolOutputCollection/ns2:consultarCondicionByRolOutput[ns2:ID_TCA_TIPO_DESEMBOLSO = $ConsultarCondicionByIdEventoRequest/ns3:idTipoDesembolso]
        return
        <ns3:Condicion>
...
local:func($consultarCondicionByRolOutputCollection, $ConsultarEventoCondicionOutputCollection, $ConsultarCondicionByIdEventoRequest)
