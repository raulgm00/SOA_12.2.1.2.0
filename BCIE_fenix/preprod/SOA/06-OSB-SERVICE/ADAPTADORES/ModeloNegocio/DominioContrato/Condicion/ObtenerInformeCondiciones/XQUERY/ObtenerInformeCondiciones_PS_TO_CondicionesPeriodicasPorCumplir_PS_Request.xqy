...
declare function local:func($ObtenerInformeCondicionesRequest as element() (:: schema-element(ns1:ObtenerInformeCondicionesRequest) ::)) as element() (:: schema-element(ns1:CondicionesPeriodicasPorCumplirRequest) ::) {
    <ns1:CondicionesPeriodicasPorCumplirRequest>
