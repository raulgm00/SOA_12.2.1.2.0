...
declare namespace ns2="http://www.bcie.org/ValidarClienteEnProcesoMO";
...
declare function local:func($responseMapeoErrorMessage as element() (:: schema-element(ns1:responseMapeoErrorMessage) ::), 
                            ...
                            as element() (:: schema-element(ns2:ValidarClienteEnProcesoResponse) ::) {
    <ns2:ValidarClienteEnProcesoResponse>
        <ns2:Resultado>
