...
declare function local:func($FinAprobacionCliente as element() (:: schema-element(ns1:FinAprobacionCliente) ::)) as element() (:: schema-element(ns2:CrearEquipoTrabajoClienteRequest) ::) {
    <ns2:CrearEquipoTrabajoClienteRequest>
        <ns2:idCliente>{fn:data($FinAprobacionCliente/ns1:Header/ns4:Cliente/ns5:IdCliente)}</ns2:idCliente>
        <ns2:listadoEquipoTrabajo>
            {
                for $equipoTrabajo in $FinAprobacionCliente/ns1:equipoTrabajo/ns3:equipoTrabajo
                return 
                <ns3:equipoTrabajo>
