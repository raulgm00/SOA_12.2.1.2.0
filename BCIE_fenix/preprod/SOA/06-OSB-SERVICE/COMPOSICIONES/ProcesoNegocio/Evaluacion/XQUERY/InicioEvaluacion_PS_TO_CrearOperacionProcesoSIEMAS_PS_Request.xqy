...
declare function local:func($InicioEvaluacion as element() (:: schema-element(ns1:InicioEvaluacion) ::)) as element() (:: schema-element(ns2:requestCrearOperacionProcesoMessage) ::) {
