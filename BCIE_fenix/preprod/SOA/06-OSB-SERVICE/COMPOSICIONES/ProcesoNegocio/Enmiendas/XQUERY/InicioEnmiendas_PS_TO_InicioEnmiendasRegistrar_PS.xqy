...
declare function local:func($InicioEnmiendas as element() (:: schema-element(ns1:InicioEnmiendas) ::), $CrearEnmiendaTCCResponse as element() (:: schema-element(ns11:CrearEnmiendaTCCResponse) ::)) as element() (:: schema-element(ns1:InicioEnmiendasRegistrar) ::) {
    <ns1:InicioEnmiendasRegistrar>
        <ns1:Header>
            <ns2:Operacion>
            ...
            {
                if ($InicioEnmiendas/ns1:Header/ns2:Tarea)
                then 
                    <ns2:Tarea>
