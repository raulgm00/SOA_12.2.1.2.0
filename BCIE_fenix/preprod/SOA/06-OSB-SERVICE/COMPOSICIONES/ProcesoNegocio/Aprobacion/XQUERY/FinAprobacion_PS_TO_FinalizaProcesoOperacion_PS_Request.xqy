...
declare variable $AnalisisRequest as element() (:: schema-element(ns1:FinAprobacion) ::) external;

declare function local:func($AnalisisRequest as element() (:: schema-element(ns1:FinAprobacion) ::)) as element() (:: schema-element(ns2:requestFinalizarOperacionProcesoMessage) ::) {
