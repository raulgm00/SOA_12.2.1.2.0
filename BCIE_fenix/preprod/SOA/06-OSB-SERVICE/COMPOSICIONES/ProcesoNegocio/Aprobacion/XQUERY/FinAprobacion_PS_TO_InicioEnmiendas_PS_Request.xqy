...
declare namespace ns2="http://xmlns.oracle.com/bpmn/bpmnProcess/EnmiendasProcess";
...
declare function local:func($FinAprobacion as element() (:: schema-element(ns1:FinAprobacion) ::)) as element() (:: schema-element(ns2:InicioEnmiendas) ::) {
    <ns2:InicioEnmiendas>
        <ns2:Header>
            <ns3:Operacion>
            ...
            <ns3:Tarea>
                ...
                {
                    if ($FinAprobacion/ns1:Header/ns3:Tarea/ns5:CodigoProceso)
                    then <ns5:CodigoProceso>{fn:data($FinAprobacion/ns1:Header/ns3:Tarea/ns5:CodigoProceso)}</ns5:CodigoProceso>
                    else ()
                }
                {
                    if ($FinAprobacion/ns1:Header/ns3:Tarea/ns5:NombreProceso)
                    then <ns5:NombreProceso>{fn:data($FinAprobacion/ns1:Header/ns3:Tarea/ns5:NombreProceso)}</ns5:NombreProceso>
                    else ()
                }
            </ns3:Tarea>
            {
