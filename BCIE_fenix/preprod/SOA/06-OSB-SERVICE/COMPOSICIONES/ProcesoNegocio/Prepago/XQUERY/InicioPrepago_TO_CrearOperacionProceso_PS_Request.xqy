...
declare function local:func($InicioPrepago as element() (:: schema-element(ns1:InicioPrepago) ::)) as element() (:: schema-element(ns2:requestCrearOperacionProcesoMessage) ::) {
