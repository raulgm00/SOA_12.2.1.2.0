...
declare variable $FinPrepago as element() (:: schema-element(ns1:FinPrepago) ::) external;

declare function local:func($FinPrepago as element() (:: schema-element(ns1:FinPrepago) ::)) as element() (:: schema-element(ns2:requestCrearEquipoTrabajoMessage) ::) {
    <ns2:requestCrearEquipoTrabajoMessage>
        <ns2:idOperacion>{fn:data($FinPrepago/ns1:Header/ns4:Operacion/ns5:CodigoOperacion)}</ns2:idOperacion>
        <ns2:listadoEquipoTrabajo>
            {for $equipoTrabajo in $FinPrepago/ns1:equipoTrabajo/ns3:equipoTrabajo
            where $equipoTrabajo/ns3:usuario != ''
            return
            <ns3:equipoTrabajo>
