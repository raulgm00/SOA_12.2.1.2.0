...
declare function local:func($FinElegibilidad as element() (:: schema-element(ns1:FinElegibilidad) ::)) as element() (:: schema-element(ns2:requestCrearBitacoraProcesoMessage) ::) {
    <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            <cre:idOperacion>{fn:data($FinElegibilidad/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</cre:idOperacion>
            <cre:nombreOperacion>{fn:data($FinElegibilidad/ns1:Header/ns3:Operacion/ns4:NombreOperacion)}</cre:nombreOperacion>
            <cre:idProceso>1</cre:idProceso>
            <cre:nombreProceso>PC01</cre:nombreProceso>
            <cre:instanciaProceso>{fn:data($FinElegibilidad/ns1:Header/ns3:Proceso/ns6:InstanciaProceso)}</cre:instanciaProceso>
            <cre:idProcesoSiguiente></cre:idProcesoSiguiente>
            <cre:esProceso>{true()}</cre:esProceso>
            <cre:idTarea>{fn:data($FinElegibilidad/ns1:Header/ns3:Tarea/ns5:CodigoTarea)}</cre:idTarea>
            <cre:nombreTarea></cre:nombreTarea>
            <cre:instanciaTarea></cre:instanciaTarea>
            <cre:usuario>{fn:data($FinElegibilidad/ns1:Header/ns3:Operacion/ns4:ResponsableOperacion)}</cre:usuario>
