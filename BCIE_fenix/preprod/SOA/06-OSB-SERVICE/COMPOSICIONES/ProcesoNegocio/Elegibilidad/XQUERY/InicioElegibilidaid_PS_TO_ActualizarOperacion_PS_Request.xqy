...
declare function local:func($InicioElegibilidad as element() (:: schema-element(ns1:InicioElegibilidad) ::)) as element() (:: schema-element(ns2:ActualizarOperacionRequest) ::) {
    <ns2:ActualizarOperacionRequest>
        <ns2:Operacion>
            <ope:idOperacion>{fn:data($InicioElegibilidad/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</ope:idOperacion>
            <ope:etapa>1</ope:etapa>
        </ns2:Operacion>
    </ns2:ActualizarOperacionRequest>
};
