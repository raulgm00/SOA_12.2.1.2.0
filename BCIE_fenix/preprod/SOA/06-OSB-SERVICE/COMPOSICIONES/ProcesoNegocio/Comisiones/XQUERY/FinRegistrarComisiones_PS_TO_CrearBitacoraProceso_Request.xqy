...
declare variable $inCrearBitacora as element() (:: schema-element(ns1:FinRegistrarComisiones) ::) external;

declare function local:func($inCrearBitacora as element() (:: schema-element(ns1:FinRegistrarComisiones) ::)) as element() (:: element(*, ns2:CrearBitacoraProcesoRequest) ::) {
       <ns2:requestCrearBitacoraProcesoMessage>
        <ns2:BitacoraInput>
            ...
            <cre:instanciaProceso>{fn:data($inCrearBitacora/ns1:Header/ns3:Proceso/ns5:InstanciaProceso)}</cre:instanciaProceso>
