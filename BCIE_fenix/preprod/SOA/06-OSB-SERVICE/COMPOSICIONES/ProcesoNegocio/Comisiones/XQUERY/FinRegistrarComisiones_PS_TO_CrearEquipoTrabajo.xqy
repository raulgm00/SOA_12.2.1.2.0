...
declare variable $inCrearEquipoTrabajo as element() (:: schema-element(ns1:FinRegistrarComisiones) ::) external;

declare function local:func($inCrearEquipoTrabajo as element() (:: schema-element(ns1:FinRegistrarComisiones) ::)) as element() (:: element(*, ns2:CrearEquipoTrabajoRequest) ::) {
    <ns2:requestCrearEquipoTrabajoMessage>
         <ns2:idOperacion>{fn:data($inCrearEquipoTrabajo/ns1:Header/ns4:Operacion/ns5:CodigoOperacion)}</ns2:idOperacion>
        <ns2:listadoEquipoTrabajo>
            {
                for $equipoTrabajo in $inCrearEquipoTrabajo/ns1:equipoTrabajo/ns3:equipoTrabajo
...
local:func($inCrearEquipoTrabajo)
