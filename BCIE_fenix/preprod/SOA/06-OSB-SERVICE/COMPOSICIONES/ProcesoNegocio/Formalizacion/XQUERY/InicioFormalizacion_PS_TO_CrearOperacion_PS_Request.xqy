...
declare function local:func($inInicioFormalizacion as element() (:: schema-element(ns1:InicioFormalizacion) ::)) as element() (:: schema-element(ns2:requestCrearOperacionProcesoMessage) ::) {
