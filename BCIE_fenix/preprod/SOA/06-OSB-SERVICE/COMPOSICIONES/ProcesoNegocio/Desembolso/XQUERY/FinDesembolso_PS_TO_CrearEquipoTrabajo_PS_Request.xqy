...
declare function local:func($FinDesembolso as element() (:: schema-element(ns1:FinDesembolso) ::)) as element() (:: schema-element(ns2:requestCrearEquipoTrabajoMessage) ::) {
    <ns2:requestCrearEquipoTrabajoMessage>
        <ns2:idOperacion>{fn:data($FinDesembolso/ns1:Header/ns3:Operacion/ns4:CodigoOperacion)}</ns2:idOperacion>
        
        
        <ns2:listadoEquipoTrabajo>
        
        {
                for $equipoTrabajo in $FinDesembolso/ns1:equipoTrabajo/ns5:equipoTrabajo
