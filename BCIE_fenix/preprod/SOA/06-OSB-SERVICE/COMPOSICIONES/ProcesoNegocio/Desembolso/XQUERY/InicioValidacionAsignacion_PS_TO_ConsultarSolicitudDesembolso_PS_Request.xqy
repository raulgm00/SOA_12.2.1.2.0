...
declare function local:func($InicioValidacionAsignacion as element() (:: schema-element(ns1:InicioValidacionAsignacion) ::)) as element() (:: schema-element(ns2:ConsultarSolicitudDesembolsoRequest) ::) {
    <ns2:ConsultarSolicitudDesembolsoRequest>
        <ns2:idSolicitud>{fn:data($InicioValidacionAsignacion/ns1:Header/ns3:ParameterType[ns3:parameterName='ID_SOLICITUD']/ns3:parameterValue)}</ns2:idSolicitud>
    </ns2:ConsultarSolicitudDesembolsoRequest>
};
