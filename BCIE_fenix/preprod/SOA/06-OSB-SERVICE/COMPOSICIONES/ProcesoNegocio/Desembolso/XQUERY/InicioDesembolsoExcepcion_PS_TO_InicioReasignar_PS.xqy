...
declare variable $request as element() (:: schema-element(ns1:InicioDesembolsoExcepcion) ::) external;

declare function local:func($request as element() (:: schema-element(ns1:InicioDesembolsoExcepcion) ::)) as element() (:: schema-element(ns1:InicioReasignarRO) ::) {
