...
declare function local:funcConsultarcondicionsolicitudprimerdesembolso_to_consultarcumplimientocondiciones_request($outConsultarCondicionesSolicitud1erD.response as element() (:: schema-element(con:ConsultarCondicionByIdEventoResponse) ::)) as element() (:: schema-element(des:ConsultarCumplimientoCondicionesRequest) ::) {
...
local:funcConsultarcondicionsolicitudprimerdesembolso_to_consultarcumplimientocondiciones_request($outConsultarCondicionesSolicitud1erD.response)
