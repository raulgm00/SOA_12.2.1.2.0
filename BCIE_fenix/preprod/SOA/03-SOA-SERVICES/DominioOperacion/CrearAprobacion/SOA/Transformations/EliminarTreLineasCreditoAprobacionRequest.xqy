...
declare function local:funcEliminartrelineascreditoaprobacionrequest($inputVariable.CrearAprobacionRequest as element() (:: schema-element(apr:CrearAprobacionRequest) ::)) as element() (:: schema-element(lin:EliminarTreLineaCreditoAprobacionByIdLineaRequest) ::) {
    <lin:EliminarTreLineaCreditoAprobacionByIdLineaRequest>
    {
...
local:funcEliminartrelineascreditoaprobacionrequest($inputVariable.CrearAprobacionRequest)
