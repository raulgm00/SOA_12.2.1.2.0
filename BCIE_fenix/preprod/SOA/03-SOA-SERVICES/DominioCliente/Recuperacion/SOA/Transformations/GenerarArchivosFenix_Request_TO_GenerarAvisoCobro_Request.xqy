...
declare function local:funcGenerararchivosfenix_request_to_generaravisocobro_request($inputVariable.GenerarArchivosFenixRequest as element() (:: schema-element(ges:GenerarArchivosFenixRequest) ::)) as element() (:: schema-element(ges:GeneraReporteAvisoCobroRequest) ::) {
                ...
                <ges1:avisoOperacion>
                    ...
                    <ges1:informacionPago>
                        ...
                        <ges1:detallePago>
                            ...
                            {
                            for $monto in $detallePago/lin:Monto
                            return
                            <lin:Monto>
                                <com:tipo>
...
local:funcGenerararchivosfenix_request_to_generaravisocobro_request($inputVariable.GenerarArchivosFenixRequest)
