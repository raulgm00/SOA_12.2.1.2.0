...
declare function local:funcEnviarcorreoelectronico_to_consultaratributosusuariocc($inputVariable.EnviarCorreoElectronicoRequest as element() (:: schema-element(cor:EnviarCorreoElectronicoBPELRequest) ::)) as element() (:: schema-element(usu:ConsultarAtributosUsuarioRequest) ::) {
    <usu:ConsultarAtributosUsuarioRequest>
        <usu:listaNombres>
            {
                for $usuario in $inputVariable.EnviarCorreoElectronicoRequest/cor:correoElectronico/cor1:cc/cor1:usuario
                return 
...
local:funcEnviarcorreoelectronico_to_consultaratributosusuariocc($inputVariable.EnviarCorreoElectronicoRequest)
