                                    ...
                                    $.ajax({
                                       ...
                                       if (navigator.appName.match(/explorer/gi) || navigator.userAgent.match(/trident/gi)) {
                                             //console.log("Se ha detectado IE para la descarga del Documento "+o.detalleOperacion.listadoDocumentos[i].nombreDocumento);
                                                ...
                                                if (nom_doc.indexOf('.doc') !== -1) {
                                                    window.navigator.msSaveOrOpenBlob(blob, nom_doc);                                    
                                                } else {
                                            ...
                                            link.remove(); */
                                            if (nom_doc.indexOf('.doc') !== -1) {
                                                ($("#downloadFilePDF").attr("href",data).attr("download", nom_doc), $("#modalDocumento").modal("show"))
                                            } else {
                                     ...
                                     $.ajax({
                                        ...
                                        cache: !1
                                         ...
                                         if (navigator.appName.match(/explorer/gi) || navigator.userAgent.match(/trident/gi)) {
                                            ...
                                            if (o.detalleOperacion.listadoDocumentos[i].nombreDocumento.indexOf('.doc') !== -1) {
                                                ($("#downloadFilePDF").attr("href", "data:"+mime_type+";base64," + e.codigo).attr("download", o.detalleOperacion.listadoDocumentos[i].nombreDocumento), $("#modalDocumento").modal("show"))
                                            } else {
