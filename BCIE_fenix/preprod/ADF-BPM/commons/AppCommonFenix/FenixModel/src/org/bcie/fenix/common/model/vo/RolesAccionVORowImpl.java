...
// ---------------------------------------------------------------------
public class RolesAccionVORowImpl extends ViewRowImpl {
    /**
    ...
    public static final int IDTCAACCIONROLBPM = AttributesEnum.IdTcaAccionRolBpm.index();
    public static final int DESCRIPCIONCORTA = AttributesEnum.DescripcionCorta.index();

    /**
     * This is the default constructor (do not remove).
     */
    public RolesAccionVORowImpl() {
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute IdTcaAccionRolBpm.
     * @return the IdTcaAccionRolBpm
     */
    public Integer getIdTcaAccionRolBpm() {
        return (Integer) getAttributeInternal(IDTCAACCIONROLBPM);
    }
