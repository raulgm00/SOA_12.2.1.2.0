    ...
    public Boolean agregarEvidenciaPorId(Long id, Long idDocumento) {
        ...
        if (null != row) {
            ...
            try {
                ...
                logger.warning("Error al realizar el commit. Realizando ROLLBACK.",
                    e);
    ...
    public Row obtenerPreguntaPorId(Long id) {
        ...
        try {
            criteria = this.getViewCriteriaManager()
                           .getViewCriteria("preguntaPorIdVOCriteria");
            criteria.ensureVariableManager()
                    .setVariableValue("varIdPregunta", id);
            this.applyViewCriteria(criteria);
            this.executeQuery();
            logger.warning("cantidad de registros :" +
            ...
            getViewCriteriaManager()
                .removeApplyViewCriteriaName("preguntaPorIdVOCriteria");
        }
