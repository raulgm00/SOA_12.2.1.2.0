...
public class TcaTareaConBtnDinVOImpl extends ViewObjectImpl implements TcaTareaConBtnDinVO {
    ...
    public Map<String, TablaDinamicaVOBean> obtenerDatos(String p_nombreTabla, Integer p_idTareaBpm) {
    ...
    public Map<String, TablaDinamicaVOBean> desempaquetarColecion(RowSetIterator iter) {
        ...
        while (iter.hasNext()) {
            ...
            if (contador == 4) {
                contador = 1;
                beanLocal =
                    new TablaDinamicaVOBean(Integer.parseInt(r.getAttribute("Id").toString()),
                                            r.getAttribute("Componente").toString(),
                                            Integer.parseInt(r.getAttribute("IdTareaBpm").toString()),
                                            Integer.parseInt(r.getAttribute("IdPrpoducto").toString()),
                                            ...
                                            tablaVerdad,
                                            r.getAttribute("TiposProductosConfigurados").toString());
    ...
    public void imprimirRow(Row fila) {
        ...
        System.out.println("IdPrpoducto = " + fila.getAttribute("IdPrpoducto"));
