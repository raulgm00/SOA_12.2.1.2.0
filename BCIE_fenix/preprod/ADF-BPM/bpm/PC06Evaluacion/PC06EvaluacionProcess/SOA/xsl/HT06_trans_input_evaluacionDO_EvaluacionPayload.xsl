...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [FRI SEP 18 10:29:33 CDT 2015].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:EvaluacionPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns2:CodigoTarea>38</ns2:CodigoTarea>
          <ns2:NombreTarea>Revisar Informes</ns2:NombreTarea>
          <ns2:CodigoRol>1</ns2:CodigoRol>
          <ns2:NombreRol>Responsable Operación</ns2:NombreRol>
