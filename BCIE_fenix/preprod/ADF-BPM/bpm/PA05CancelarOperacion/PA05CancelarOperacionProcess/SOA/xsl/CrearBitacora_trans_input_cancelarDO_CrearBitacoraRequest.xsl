...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [THU DEC 21 00:16:31 CST 2017].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <tns:CrearBitacoraRequest>
      <tns:BitacoraInput>
        ...
        <regBitBO:idProceso>11</regBitBO:idProceso>
        <regBitBO:nombreProceso>PA05</regBitBO:nombreProceso>
