...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [FRI SEP 09 17:42:13 CDT 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:CondicionPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns5:CodigoTarea>186</ns5:CodigoTarea>
          <ns5:NombreTarea>Validar Condiciones Ambiental y Social</ns5:NombreTarea>
          <ns5:CodigoRol>50</ns5:CodigoRol>
          <ns5:NombreRol>Especialista Ambiental</ns5:NombreRol>
          <ns5:CodigoProceso>9</ns5:CodigoProceso>
          <ns5:NombreProceso>Administración de Condiciones</ns5:NombreProceso>
        </header:Tarea>
        <header:Proceso>
          <ns3:IdProceso>
      ...
      <ns0:Configuration>
        ...
        <ns0:requiereMasInfoASJUR>
          <xsl:value-of select="/ns0:CondicionPayload/ns0:Configuration/ns0:requiereMasInfoASJUR"/>
        </ns0:requiereMasInfoASJUR>
