...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [MON SEP 21 17:15:23 CDT 2015].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:AnalisisPayload>
      ...
      <ns0:Configuration>
        ...
        <xsl:if test="/ns0:AnalisisPayload/ns0:Configuration/ns0:quienSolicitoAjustes/text()">
          <ns0:quienSolicitoAjustes>
            <xsl:value-of select="/ns0:AnalisisPayload/ns0:Configuration/ns0:quienSolicitoAjustes"/>
          </ns0:quienSolicitoAjustes>
        </xsl:if>
        <xsl:if test="/ns0:AnalisisPayload/ns0:Configuration/ns0:solicitaMasInfoAnalistaCredito/text()">
        ...
        <xsl:if test="/ns0:AnalisisPayload/ns0:Configuration/ns0:solicitaMasInfoAbogado/text()">
          <ns0:solicitaMasInfoAbogado>
            <xsl:value-of select="/ns0:AnalisisPayload/ns0:Configuration/ns0:solicitaMasInfoAbogado"/>
          </ns0:solicitaMasInfoAbogado>
        </xsl:if>
        <xsl:if test="/ns0:AnalisisPayload/ns0:Configuration/ns0:solicitaMasInfoEjecutivoAreaTecnica/text()">
        ...
        <xsl:if test="/ns0:AnalisisPayload/ns0:Configuration/ns0:quienSolicitoRevisarProyecto/text()">
        ...
        <xsl:if test="/ns0:AnalisisPayload/ns0:Configuration/ns0:requiereAjustesDeEjecutivoTecnico/text()">
