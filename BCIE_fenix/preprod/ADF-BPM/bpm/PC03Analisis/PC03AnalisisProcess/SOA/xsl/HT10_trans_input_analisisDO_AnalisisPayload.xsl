...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [THU SEP 17 14:56:51 CDT 2015].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:AnalisisPayload>
      <ns0:Header>
        ...
        <header:Tarea>
          <ns2:CodigoTarea>32</ns2:CodigoTarea>
          <ns2:NombreTarea>Validar Resultado de Análisis</ns2:NombreTarea>
          <ns2:CodigoRol>12</ns2:CodigoRol>
          <ns2:NombreRol>Jefe de Área Técnica</ns2:NombreRol>
