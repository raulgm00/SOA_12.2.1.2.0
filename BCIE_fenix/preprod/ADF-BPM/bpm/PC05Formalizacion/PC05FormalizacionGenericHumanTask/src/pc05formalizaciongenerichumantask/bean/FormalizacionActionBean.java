...
public class FormalizacionActionBean extends FenixActionBean implements Serializable {
   ...
   private List<String> listaAdvertencias = new ArrayList<String>(); 
    ...
    /**@Overview: US: 2012; Se agrega método de validación d elogica para la ejecución de finalzar la tarea en retorpectiva de la acci?n
    ...
    private Boolean validarTccElaborarBorradorContrato(Long idOperacion) {
        ...
        if (!operationBinding.getErrors().isEmpty()) {
            ...
            JSFUtils.addFacesErrorMessage("Uno o mÃ¡s sub-estados de TCC son invÃ¡lidos, favor de revisar."); // getResult() es null o false
            ...
            if ((noObjecion != null) && (noObjecion.trim().equalsIgnoreCase("SI")) ||
                ...
                if (validarCondicionesFormalizacion != null) {
                    ...
                    if (!esCondicionesFormalizar)
                        JSFUtils.addFacesErrorMessage("Para finalizar la tarea, las condiciones a formalizar de la operaciÃ³n deben cumplirse.");
                ...
                JSFUtils.addFacesErrorMessage("Para finalizar la tarea la operaciÃ³n debe de contar con una â€œNo ObjeciÃ³nâ€? vigente.");
            }
        }
    ...
    public String aceptarFinalizarTareaElaboraCoreTyCAction() {
        ...
        //}
        //else {
        //    JSFUtils.addFacesErrorMessage("Debe adjuntar el documento de tÃ©rminos y condiciones.");
    ...
    public String aceptarFinalizarTareaContratoFirmadoAction() {
        ...
        if (condicionesValidas) {
            ...
            if (condicionesValidas) {
                // RN1: La fecha de la firma no debe ser posterior al plazo máximo para formalizar, incluido en los términos y condiciones de la operacion.
    ...
    public String aceptarFinalizarTareaCustodiarContrato() {
        ...
        if (numeroCustodia != null) {
            ...
            JSFUtils.addFacesErrorMessage("Debe completar la informaciÃ³n  requerida.");
            //cerramos popup de Confirmar Finalizar Tarea
            getPopupConfirmarFinalizarTarea().hide();
        }
        return returnAction;
    ...
    public String aceptarFinalizarTareaFechaVigenciaAction() {
        ...
        if ((fechaFirma != null) && (fechaVigencia != null) && (fechaVigencia.compareTo(fechaFirma) >= 0)) {
            ...
            JSFUtils.addFacesErrorMessage("La fecha de Vigencia deberÃ¡ ser mayor Ã³ igual a la fecha de firma del contrato.");
    ...
    /*** END Pantalla Registrar datos de la lï¿½nea de crï¿½dito ***/
     ...
     /*** START Pantalla Validar datos de l?nea de cr?dito ***/
    ...
    public String aceptarSolicitarAjustesValidarLineaCreditoAction() {
        ...
        if (validateComentario(Long.valueOf(formalizacionBean.getIdOperacion()), formalizacionBean.getIdTarea(),
            ...
            //EX01
            //MSG01
            JSFUtils.addFacesErrorMessage("Debe ingresar la informaciÃ³n requerida.");
    ...
    private Boolean validarNoFuentesLineasCredito() {
        ...
        try {
            ...
            JSFUtils.addFacesErrorMessage("No se pudo validar el nÃºmero de fuentes de las lÃ­neas de crÃ©dito.");
            logger.warning(e);
        }
        return result;
    }
    ...
    private Boolean validarNumeroLineasCredito() {
        ...
        if (JSFUtils.resolveExpression("#{bindings.LineaCreditoVO.estimatedRowCount}") != null) {
            ...
            if (numLineasCredito < 1) {
                esDatosCorrectos = Boolean.FALSE;
                JSFUtils.addFacesErrorMessage("Debe registrar al menos una lÃ­nea de crÃ©dito.");
            }
        }
    ...
    private Boolean propagarFuente() {
        ...
        if (!operationBinding.getErrors().isEmpty()) {
            ...
            if ((response.getResultado().getResult() != null) &&
                ...
                JSFUtils.addFacesErrorMessage("No se puede realizar la asignaciÃ³n de la lÃ­nea en ARE.");
...
//jenamorado 15/07/2021
    ...
    private Map validarCondicionesFormalizacion(Long idOperacion) {
        ...
        if (!operationBinding.getErrors().isEmpty()) {
            ...
            if ((response.getResultado().getResult() != null) &&
                ...
                JSFUtils.addFacesErrorMessage("Error al validar Condiciones de FormalizaciÃ³n: " + mensajeError);
                logger.log(ADFLogger.ERROR, "Error al validar Condiciones de FormalizaciÃ³n: " + mensajeError);
            }
        } else {
    ...
    private Boolean montoTotalValido() {
        ...
        if (stMontoEscriturado == null || stMontoEscriturado == "") {
            ...
            if ((montoEscriturado == null) || (montoTotal == null) ||
                ...
                esDatosCorrectos = Boolean.FALSE;
                JSFUtils.addFacesErrorMessage("El monto total de las lÃ­neas registradas supera el monto escriturado.");
                //JSFUtils.addFacesErrorMessage("La suma total del monto de cada LÃ­nea debe corresponder al monto escriturado.");
            }
    ...
    public List obtenerRecursosPorNombre(String nombreRecurso) {
        ...
        try {
            ...
            operationBinding.execute();
            if (operationBinding.getErrors().isEmpty()) {
                // AsignaciÃ³n para Monto aprobado
    ...
    private String finalizarAsignarRecursos() {
        String returnAction = null;
        // Propagamos fuentes de las lÃ­neas de crÃ©dito
        if (propagarFuente()) {
            // Invocar mÃ©todo para cargar documentos en onBase
            cargarDocumentosOnBase();
            // Invocar aprovacion del humman task
            returnAction = approveHumanTask();
        }
    ...
    public void adjuntarContratoMasInformacionAction() {
        ...
        if (validateComentario(Long.valueOf(formalizacionBean.getIdOperacion()), formalizacionBean.getIdTarea(),
                               getInstanciaTarea())) {
            // Abre popup de confirmar mÃ¡s informacion en todas las pantallas
            RichPopup.PopupHints popupHints = new RichPopup.PopupHints();
            getPopupConfirmarMasInformacion().show(popupHints);
        } else {
            // Se notifica que se debe ingresar un comentario
    ...
    /**
     * MÃ©todo para validar la TCC 101 - Fecha de vencimiento
     * @author Jonathan Ruiz
    ...
    /**
     * MÃ©todo para recuperar la fecha de vencimiento por binding
     * @author Jonathan Ruiz
     * @return true en caso de ser verdadero
     */
    @SuppressWarnings("unchecked")
    ...
    public void finalizarTareaFormalizacion(ActionEvent actionEvent) {
        ...
        if (val != null){
            ...
            logger.log(ADFLogger.WARNING, "FinalizarTarea >>> CambiolineasCreditos Val: No Nulo");
        }else{
            cambioLineasCredito = "N";
            logger.log(ADFLogger.WARNING, "FinalizarTarea >>> CambiolineasCreditos Val: Nulo");
        }
