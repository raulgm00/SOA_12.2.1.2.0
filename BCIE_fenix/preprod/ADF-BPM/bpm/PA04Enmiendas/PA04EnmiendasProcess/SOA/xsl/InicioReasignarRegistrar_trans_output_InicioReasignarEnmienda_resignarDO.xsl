  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="InicioReasignarEnmiendasRegistrar"
                                       namespace="http://xmlns.oracle.com/bpmn/bpmnProcess/EnmiendasProcess"/>
        <oracle-xsl-mapper:param name="inicioReasignarEnmiendasRegistrar"/>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.1(XSLT Build 150816.0404) AT [TUE MAR 22 12:39:42 CST 2016].-->
  </oracle-xsl-mapper:schema>
      ...
      <tns:Header>
        <tns6:Operacion>
          <ns1:ResponsableOperacion>
            <xsl:value-of select="/ns0:InicioReasignarEnmiendasRegistrar/ns0:Header/tns6:Operacion/ns1:ResponsableOperacion"/>
          </ns1:ResponsableOperacion>
        </tns6:Operacion>
      </tns:Header>
    </tns:EnmiendaPayload>
